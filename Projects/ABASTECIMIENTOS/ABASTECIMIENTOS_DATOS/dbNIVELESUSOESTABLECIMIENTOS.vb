...
''' Class	 : DL.dbNIVELESUSOESTABLECIMIENTOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla NIVELESUSOESTABLECIMIENTOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbNIVELESUSOESTABLECIMIENTOS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As NIVELESUSOESTABLECIMIENTOS
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_CAT_NIVELESUSOESTABLECIMIENTOS ")
        ...
        strSQL.Append(" AND IDNIVELUSO = @IDNIVELUSO ")
        ...
        args(6) = New SqlParameter("@IDNIVELUSO", SqlDbType.TinyInt)
        args(6).Value = lEntidad.IDNIVELUSO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_NIVELESUSOESTABLECIMIENTOS ")
        ...
        args(1).Value = lEntidad.IDNIVELUSO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_NIVELESUSOESTABLECIMIENTOS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDNIVELUSO = @IDNIVELUSO ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDNIVELUSO As Byte) As listaNIVELESUSOESTABLECIMIENTOS
        ...
        Dim lista As New listaNIVELESUSOESTABLECIMIENTOS

        Try
            Do While dr.Read()
                Dim mEntidad As New NIVELESUSOESTABLECIMIENTOS
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDNIVELUSO As Byte, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("NIVELESUSOESTABLECIMIENTOS")
