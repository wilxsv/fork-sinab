...
''' Class	 : DL.dbETIQUETASCAMPOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ETIQUETASCAMPOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbETIQUETASCAMPOS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ETIQUETASCAMPOS
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_CAT_ETIQUETASCAMPOS ")
        ...
        args(6) = New SqlParameter("@TABLA", SqlDbType.VarChar)
        args(6).Value = IIf(lEntidad.TABLA = Nothing, DBNull.Value, lEntidad.TABLA)
        args(7) = New SqlParameter("@CAMPO", SqlDbType.VarChar)
        args(7).Value = IIf(lEntidad.CAMPO = Nothing, DBNull.Value, lEntidad.CAMPO)
        args(8) = New SqlParameter("@ETIQUETA", SqlDbType.VarChar)
        args(8).Value = IIf(lEntidad.ETIQUETA = Nothing, DBNull.Value, lEntidad.ETIQUETA)
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ETIQUETASCAMPOS ")
        strSQL.Append(" ( TABLA, ")
        strSQL.Append(" CAMPO, ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ETIQUETASCAMPOS ")
        strSQL.Append(" WHERE TABLA = @TABLA ")
        strSQL.Append(" AND CAMPO = @CAMPO ")
        strSQL.Append(" AND ETIQUETA = @ETIQUETA ")
    ...
    Public Function ObtenerListaPorID() As listaETIQUETASCAMPOS
        ...
        Dim lista As New listaETIQUETASCAMPOS

        Try
            Do While dr.Read()
                Dim mEntidad As New ETIQUETASCAMPOS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ETIQUETASCAMPOS")
