...
''' Class	 : DL.dbPLANTILLASMULTAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla SAB_UACI_PLANTILLASMULTAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbPLANTILLASMULTAS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As PLANTILLASMULTAS
        lEntidad = aEntidad
        ...
        args(2) = New SqlParameter("@TIPOPLANTILLA", SqlDbType.Int)
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        args(3) = New SqlParameter("@CONTENIDO", SqlDbType.VarChar)
        args(3).Value = IIf(lEntidad.CONTENIDO = Nothing, DBNull.Value, lEntidad.CONTENIDO)
        args(4) = New SqlParameter("@TIPOPLANTILLA", SqlDbType.Int)
        args(4).Value = lEntidad.TIPOPLANTILLA
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_PLANTILLASMULTAS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPLANTILLA = @IDPLANTILLA ")
    ...
    Public Function ObtenerListaPorID() As listaPLANTILLASMULTAS
        ...
        Try
            Do While dr.Read()
                Dim mEntidad As New PLANTILLASMULTAS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("PLANTILLASMULTAS")
