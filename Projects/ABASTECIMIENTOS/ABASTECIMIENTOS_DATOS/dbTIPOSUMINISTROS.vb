...
Public Class dbTIPOSUMINISTROS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOSUMINISTROS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPOSUMINISTRO = 0 _
            Or lEntidad.IDTIPOSUMINISTRO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPOSUMINISTRO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOSUMINISTROS ")
        ...
        args(6) = New SqlParameter("@IDTIPOSUMINISTRO", SqlDbType.Int)
        args(6).Value = lEntidad.IDTIPOSUMINISTRO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOSUMINISTROS ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOSUMINISTROS ")
        strSQL.Append(" WHERE IDTIPOSUMINISTRO = @IDTIPOSUMINISTRO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOSUMINISTRO),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPOSUMINISTROS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPOSUMINISTROS
        ...
        Dim lista As New listaTIPOSUMINISTROS

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPOSUMINISTROS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOSUMINISTROS")
