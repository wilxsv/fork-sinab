...
''' Update y Delete) de la tabla SAB_CAT_ZONAS
''' </summary>
''' <remarks>
''' Generado con GenApp V1.6.2.0, Carías y Asociados, (info@cariasyasociados.com)
''' </remarks>
''' <history>
''' 	[GenApp]	08/03/2007	Created
''' </history>
''' -----------------------------------------------------------------------------
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lID As Long
        If lEntidad.IDZONA = 0 _
            Or lEntidad.IDZONA = Nothing Then
        ...
        strSQL.Append("UPDATE SAB_CAT_ZONAS ")
        ...
        strSQL.Append(" WHERE IDZONA = @IDZONA ")
        ...
        args(6) = New SqlParameter("@IDZONA", SqlDbType.Int)
        args(6).Value = lEntidad.IDZONA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ZONAS ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ZONAS ")
        strSQL.Append(" WHERE IDZONA = @IDZONA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDZONA),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_ZONAS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaZONAS
