...
''' Class	 : DL.dbMODIFICATIVASCONTRATO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla MODIFICATIVASCONTRATO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbMODIFICATIVASCONTRATO
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As MODIFICATIVASCONTRATO
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDMODIFICATIVA = 0 _
            Or lEntidad.IDMODIFICATIVA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDMODIFICATIVA = lID
        ...
        strSQL.Append("UPDATE SAB_UACI_MODIFICATIVASCONTRATO ")
        strSQL.Append(" SET NUMEROMODIFICATIVA = @NUMEROMODIFICATIVA, ")
        strSQL.Append(" FECHAMODIFICATIVA = @FECHAMODIFICATIVA, ")
        ...
        args(0) = New SqlParameter("@NUMEROMODIFICATIVA", SqlDbType.VarChar)
        args(0).Value = lEntidad.NUMEROMODIFICATIVA
        args(1) = New SqlParameter("@FECHAMODIFICATIVA", SqlDbType.DateTime)
        args(1).Value = lEntidad.FECHAMODIFICATIVA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_MODIFICATIVASCONTRATO ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDPROVEEDOR, ")
        strSQL.Append(" IDCONTRATO, ")
        strSQL.Append(" IDMODIFICATIVA, ")
        strSQL.Append(" NUMEROMODIFICATIVA, ")
        strSQL.Append(" FECHAMODIFICATIVA, ")
        ...
        args(4) = New SqlParameter("@NUMEROMODIFICATIVA", SqlDbType.VarChar)
        args(4).Value = lEntidad.NUMEROMODIFICATIVA
        args(5) = New SqlParameter("@FECHAMODIFICATIVA", SqlDbType.DateTime)
        args(5).Value = lEntidad.FECHAMODIFICATIVA
        ...
        If SqlHelper.ExecuteNonQuery(Me.cnnStr, CommandType.Text, strSQL.ToString(), args) = 1 Then
            Return lEntidad.IDMODIFICATIVA
        Else
            Return 0
        End If
    End Function
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_MODIFICATIVASCONTRATO ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPROVEEDOR = @IDPROVEEDOR ")
        strSQL.Append(" AND IDCONTRATO = @IDCONTRATO ")
        strSQL.Append(" AND IDMODIFICATIVA = @IDMODIFICATIVA ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.NUMEROMODIFICATIVA = IIf(.Item("NUMEROMODIFICATIVA") Is DBNull.Value, Nothing, .Item("NUMEROMODIFICATIVA"))
                lEntidad.FECHAMODIFICATIVA = IIf(.Item("FECHAMODIFICATIVA") Is DBNull.Value, Nothing, .Item("FECHAMODIFICATIVA"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDMODIFICATIVA),0) + 1 ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROVEEDOR As Int32, ByVal IDCONTRATO As Int64) As listaMODIFICATIVASCONTRATO
        ...
        Dim lista As New listaMODIFICATIVASCONTRATO

        Try
            Do While dr.Read()
                Dim mEntidad As New MODIFICATIVASCONTRATO
                ...
                mEntidad.NUMEROMODIFICATIVA = IIf(dr("NUMEROMODIFICATIVA") Is DBNull.Value, Nothing, dr("NUMEROMODIFICATIVA"))
                mEntidad.FECHAMODIFICATIVA = IIf(dr("FECHAMODIFICATIVA") Is DBNull.Value, Nothing, dr("FECHAMODIFICATIVA"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROVEEDOR As Int32, ByVal IDCONTRATO As Int64, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("MODIFICATIVASCONTRATO")
