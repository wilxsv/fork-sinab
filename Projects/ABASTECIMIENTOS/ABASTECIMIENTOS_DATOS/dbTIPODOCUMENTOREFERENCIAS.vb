...
Public Class dbTIPODOCUMENTOREFERENCIAS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPODOCUMENTOREFERENCIAS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPODOCREF = 0 _
            Or lEntidad.IDTIPODOCREF = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPODOCREF = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPODOCUMENTOREFERENCIAS ")
        ...
        strSQL.Append(" WHERE IDTIPODOCREF = @IDTIPODOCREF ")
        ...
        args(6) = New SqlParameter("@IDTIPODOCREF", SqlDbType.Int)
        args(6).Value = lEntidad.IDTIPODOCREF
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPODOCUMENTOREFERENCIAS ")
        ...
        args(0).Value = lEntidad.IDTIPODOCREF
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPODOCUMENTOREFERENCIAS ")
        strSQL.Append(" WHERE IDTIPODOCREF = @IDTIPODOCREF ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPODOCREF),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaTIPODOCUMENTOREFERENCIAS
        ...
        Dim lista As New listaTIPODOCUMENTOREFERENCIAS

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPODOCUMENTOREFERENCIAS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPODOCUMENTOREFERENCIAS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPODOCREF, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
