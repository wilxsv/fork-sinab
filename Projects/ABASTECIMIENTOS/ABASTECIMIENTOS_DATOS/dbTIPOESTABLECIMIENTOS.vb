...
Public Class dbTIPOESTABLECIMIENTOS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOESTABLECIMIENTOS
        lEntidad = aEntidad

        Dim lID As String
        If lEntidad.IDTIPOESTABLECIMIENTO = "0" _
            Or lEntidad.IDTIPOESTABLECIMIENTO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = "" Then Return -1

            lEntidad.IDTIPOESTABLECIMIENTO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOESTABLECIMIENTOS ")
        ...
        strSQL.Append(" WHERE IDTIPOESTABLECIMIENTO = @IDTIPOESTABLECIMIENTO ")

        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@NOMBRECORTO", SqlDbType.VarChar)
        args(0).Value = IIf(lEntidad.NOMBRECORTO = Nothing, DBNull.Value, lEntidad.NOMBRECORTO)
        ...
        args(7) = New SqlParameter("@IDTIPOESTABLECIMIENTO", SqlDbType.VarChar)
        args(7).Value = lEntidad.IDTIPOESTABLECIMIENTO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOESTABLECIMIENTOS ")
        ...
        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@IDTIPOESTABLECIMIENTO", SqlDbType.VarChar)
        args(0).Value = lEntidad.IDTIPOESTABLECIMIENTO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOESTABLECIMIENTOS ")
        strSQL.Append(" WHERE IDTIPOESTABLECIMIENTO = @IDTIPOESTABLECIMIENTO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOESTABLECIMIENTO),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaTIPOESTABLECIMIENTOS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOESTABLECIMIENTOS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPOESTABLECIMIENTO, ")
        strSQL.Append(" NOMBRECORTO, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
