...
''' Class	 : DL.dbDEPARTAMENTOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla DEPARTAMENTOS
''' </summary>
''' <remarks>
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As DEPARTAMENTOS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDDEPARTAMENTO = 0 _
            Or lEntidad.IDDEPARTAMENTO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDDEPARTAMENTO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_DEPARTAMENTOS ")
        strSQL.Append(" SET CODIGODEPARTAMENTO = @CODIGODEPARTAMENTO, ")
        ...
        strSQL.Append(" WHERE IDDEPARTAMENTO = @IDDEPARTAMENTO ")

        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@CODIGODEPARTAMENTO", SqlDbType.VarChar)
        args(0).Value = lEntidad.CODIGODEPARTAMENTO
        ...
        args(7) = New SqlParameter("@IDDEPARTAMENTO", SqlDbType.SmallInt)
        args(7).Value = lEntidad.IDDEPARTAMENTO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_DEPARTAMENTOS ")
        strSQL.Append(" ( IDDEPARTAMENTO, ")
        strSQL.Append(" CODIGODEPARTAMENTO, ")
        ...
        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@IDDEPARTAMENTO", SqlDbType.SmallInt)
        args(0).Value = lEntidad.IDDEPARTAMENTO
        args(1) = New SqlParameter("@CODIGODEPARTAMENTO", SqlDbType.VarChar)
        args(1).Value = lEntidad.CODIGODEPARTAMENTO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_DEPARTAMENTOS ")
        strSQL.Append(" WHERE IDDEPARTAMENTO = @IDDEPARTAMENTO ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.CODIGODEPARTAMENTO = IIf(.Item("CODIGODEPARTAMENTO") Is DBNull.Value, Nothing, .Item("CODIGODEPARTAMENTO"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDDEPARTAMENTO),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaDEPARTAMENTOS
        ...
        Dim lista As New listaDEPARTAMENTOS

        Try
            Do While dr.Read()
                Dim mEntidad As New DEPARTAMENTOS
                mEntidad.IDDEPARTAMENTO = IIf(dr("IDDEPARTAMENTO") Is DBNull.Value, Nothing, dr("IDDEPARTAMENTO"))
                mEntidad.CODIGODEPARTAMENTO = IIf(dr("CODIGODEPARTAMENTO") Is DBNull.Value, Nothing, dr("CODIGODEPARTAMENTO"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("DEPARTAMENTOS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDDEPARTAMENTO, ")
        strSQL.Append(" CODIGODEPARTAMENTO, ")
        strSQL.Append(" NOMBRE, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
