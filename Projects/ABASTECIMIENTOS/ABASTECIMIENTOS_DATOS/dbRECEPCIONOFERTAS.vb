...
''' Class	 : DL.dbRECEPCIONOFERTAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla RECEPCIONOFERTAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbRECEPCIONOFERTAS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As RECEPCIONOFERTAS
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_RECEPCIONOFERTAS ")
        strSQL.Append(" SET ORDENLLEGADA = @ORDENLLEGADA, ")
        strSQL.Append(" FECHAENTREGA = @FECHAENTREGA, ")
        strSQL.Append(" PERSONAENTREGA = @PERSONAENTREGA, ")
        ...
        args(0) = New SqlParameter("@ORDENLLEGADA", SqlDbType.Int)
        args(0).Value = lEntidad.ORDENLLEGADA
        args(1) = New SqlParameter("@FECHAENTREGA", SqlDbType.DateTime)
        args(1).Value = lEntidad.FECHAENTREGA
        args(2) = New SqlParameter("@PERSONAENTREGA", SqlDbType.VarChar)
        args(2).Value = IIf(lEntidad.PERSONAENTREGA = Nothing, DBNull.Value, lEntidad.PERSONAENTREGA)
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_RECEPCIONOFERTAS ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDPROCESOCOMPRA, ")
        strSQL.Append(" IDPROVEEDOR, ")
        strSQL.Append(" ORDENLLEGADA, ")
        strSQL.Append(" FECHAENTREGA, ")
        strSQL.Append(" PERSONAENTREGA, ")
        ...
        args(3) = New SqlParameter("@ORDENLLEGADA", SqlDbType.Int)
        args(3).Value = lEntidad.ORDENLLEGADA
        args(4) = New SqlParameter("@FECHAENTREGA", SqlDbType.DateTime)
        args(4).Value = lEntidad.FECHAENTREGA
        args(5) = New SqlParameter("@PERSONAENTREGA", SqlDbType.VarChar)
        args(5).Value = IIf(lEntidad.PERSONAENTREGA = Nothing, DBNull.Value, lEntidad.PERSONAENTREGA)
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_RECEPCIONOFERTAS ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.ORDENLLEGADA = IIf(.Item("ORDENLLEGADA") Is DBNull.Value, Nothing, .Item("ORDENLLEGADA"))
                lEntidad.FECHAENTREGA = IIf(.Item("FECHAENTREGA") Is DBNull.Value, Nothing, .Item("FECHAENTREGA"))
                lEntidad.PERSONAENTREGA = IIf(.Item("PERSONAENTREGA") Is DBNull.Value, Nothing, .Item("PERSONAENTREGA"))
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32) As listaRECEPCIONOFERTAS
        ...
        Dim lista As New listaRECEPCIONOFERTAS

        Try
            Do While dr.Read()
                Dim mEntidad As New RECEPCIONOFERTAS
                mEntidad.IDESTABLECIMIENTO = IDESTABLECIMIENTO
                mEntidad.IDPROCESOCOMPRA = IDPROCESOCOMPRA
                mEntidad.IDPROVEEDOR = IDPROVEEDOR
                mEntidad.ORDENLLEGADA = IIf(dr("ORDENLLEGADA") Is DBNull.Value, Nothing, dr("ORDENLLEGADA"))
                mEntidad.FECHAENTREGA = IIf(dr("FECHAENTREGA") Is DBNull.Value, Nothing, dr("FECHAENTREGA"))
                mEntidad.PERSONAENTREGA = IIf(dr("PERSONAENTREGA") Is DBNull.Value, Nothing, dr("PERSONAENTREGA"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("RECEPCIONOFERTAS")
