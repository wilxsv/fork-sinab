...
''' Class	 : DL.dbTIPODOCUMENTOCONTRATO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla SAB_CAT_TIPODOCUMENTOCONTRATO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbTIPODOCUMENTOCONTRATO
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPODOCUMENTOCONTRATO
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPODOCUMENTOCONTRATO ")
        strSQL.Append(" SET DESCRIPCION = @DESCRIPCION, ")
        strSQL.Append(" APLICASOLOALMACEN = @APLICASOLOALMACEN, ")
        ...
        args(1) = New SqlParameter("@APLICASOLOALMACEN", SqlDbType.TinyInt)
        args(1).Value = lEntidad.APLICASOLOALMACEN
        ...
        args(7) = New SqlParameter("@IDTIPODOCUMENTO", SqlDbType.SmallInt)
        args(7).Value = lEntidad.IDTIPODOCUMENTO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPODOCUMENTOCONTRATO ")
        strSQL.Append(" ( IDTIPODOCUMENTO, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" APLICASOLOALMACEN, ")
        ...
        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@IDTIPODOCUMENTO", SqlDbType.SmallInt)
        ...
        args(2) = New SqlParameter("@APLICASOLOALMACEN", SqlDbType.TinyInt)
        args(2).Value = lEntidad.APLICASOLOALMACEN
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPODOCUMENTOCONTRATO ")
        strSQL.Append(" WHERE IDTIPODOCUMENTO = @IDTIPODOCUMENTO ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                ...
                lEntidad.APLICASOLOALMACEN = IIf(.Item("APLICASOLOALMACEN") Is DBNull.Value, Nothing, .Item("APLICASOLOALMACEN"))
    ...
    Public Function ObtenerListaPorID() As listaTIPODOCUMENTOCONTRATO
        ...
        Dim lista As New listaTIPODOCUMENTOCONTRATO

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPODOCUMENTOCONTRATO
                ...
                mEntidad.APLICASOLOALMACEN = IIf(dr("APLICASOLOALMACEN") Is DBNull.Value, Nothing, dr("APLICASOLOALMACEN"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPODOCUMENTOCONTRATO")
