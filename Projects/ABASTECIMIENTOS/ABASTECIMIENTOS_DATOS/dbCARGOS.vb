...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As CARGOS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDCARGO = 0 _
            Or lEntidad.IDCARGO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDCARGO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_CARGOS ")
        ...
        args(6) = New SqlParameter("@IDCARGO", SqlDbType.Int)
        args(6).Value = lEntidad.IDCARGO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_CARGOS ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_CARGOS ")
        strSQL.Append(" WHERE IDCARGO = @IDCARGO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDCARGO),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_CARGOS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaCARGOS
