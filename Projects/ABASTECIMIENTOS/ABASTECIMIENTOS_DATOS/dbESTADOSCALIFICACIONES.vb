...
''' Class	 : DL.dbESTADOSCALIFICACIONES
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ESTADOSCALIFICACIONES
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbESTADOSCALIFICACIONES
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ESTADOSCALIFICACIONES
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_CAT_ESTADOSCALIFICACIONES ")
        ...
        args(6) = New SqlParameter("@IDESTADO", SqlDbType.TinyInt)
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ESTADOSCALIFICACIONES ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDESTADO", SqlDbType.TinyInt)
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ESTADOSCALIFICACIONES ")
        strSQL.Append(" WHERE IDESTADO = @IDESTADO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        strSQL.Append(" FROM SAB_CAT_ESTADOSCALIFICACIONES ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaESTADOSCALIFICACIONES
        ...
        Dim lista As New listaESTADOSCALIFICACIONES

        Try
            Do While dr.Read()
                Dim mEntidad As New ESTADOSCALIFICACIONES
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ESTADOSCALIFICACIONES")
