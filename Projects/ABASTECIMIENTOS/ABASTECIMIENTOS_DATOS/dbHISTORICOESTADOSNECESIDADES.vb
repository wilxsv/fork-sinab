...
''' Class	 : DL.dbHISTORICOESTADOSNECESIDADES
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla HISTORICOESTADOSNECESIDADES
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbHISTORICOESTADOSNECESIDADES
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As HISTORICOESTADOSNECESIDADES
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_EST_HISTORICOESTADOSNECESIDADES ")
        strSQL.Append(" SET IDNECESIDAD = @IDNECESIDAD, ")
        strSQL.Append(" IDESTADONECESIDAD = @IDESTADONECESIDAD, ")
        ...
        args(0).Value = lEntidad.IDNECESIDAD
        args(1) = New SqlParameter("@IDESTADONECESIDAD", SqlDbType.Int)
        args(1).Value = lEntidad.IDESTADONECESIDAD
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_EST_HISTORICOESTADOSNECESIDADES ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDDETALLE, ")
        strSQL.Append(" IDNECESIDAD, ")
        strSQL.Append(" IDESTADONECESIDAD, ")
        strSQL.Append(" FECHA, ")
        ...
        args(3) = New SqlParameter("@IDESTADONECESIDAD", SqlDbType.Int)
        args(3).Value = lEntidad.IDESTADONECESIDAD
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_EST_HISTORICOESTADOSNECESIDADES ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.IDNECESIDAD = IIf(.Item("IDNECESIDAD") Is DBNull.Value, Nothing, .Item("IDNECESIDAD"))
                lEntidad.IDESTADONECESIDAD = IIf(.Item("IDESTADONECESIDAD") Is DBNull.Value, Nothing, .Item("IDESTADONECESIDAD"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        strSQL.Append(" FROM SAB_EST_HISTORICOESTADOSNECESIDADES ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32) As listaHISTORICOESTADOSNECESIDADES
        ...
        Dim lista As New listaHISTORICOESTADOSNECESIDADES

        Try
            Do While dr.Read()
                Dim mEntidad As New HISTORICOESTADOSNECESIDADES
                ...
                mEntidad.IDESTADONECESIDAD = IIf(dr("IDESTADONECESIDAD") Is DBNull.Value, Nothing, dr("IDESTADONECESIDAD"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("HISTORICOESTADOSNECESIDADES")
