...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOINFORMES
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPOINFORME = 0 _
            Or lEntidad.IDTIPOINFORME = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPOINFORME = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOINFORMES ")
        ...
        strSQL.Append(" WHERE IDTIPOINFORME = @IDTIPOINFORME ")
        ...
        args(6) = New SqlParameter("@IDTIPOINFORME", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDTIPOINFORME
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOINFORMES ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOINFORMES ")
        strSQL.Append(" WHERE IDTIPOINFORME = @IDTIPOINFORME ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOINFORME),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPOINFORMES ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPOINFORMES
        ...
        Dim lista As New listaTIPOINFORMES

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPOINFORMES
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOINFORMES")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPOINFORME, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
