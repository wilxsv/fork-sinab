...
''' Class	 : DL.dbESTADOSCONTRATOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ESTADOSCONTRATOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbESTADOSCONTRATOS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ESTADOSCONTRATOS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDESTADOCONTRATO = 0 _
            Or lEntidad.IDESTADOCONTRATO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDESTADOCONTRATO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_ESTADOSCONTRATOS ")
        ...
        strSQL.Append(" WHERE IDESTADOCONTRATO = @IDESTADOCONTRATO ")
        ...
        args(6) = New SqlParameter("@IDESTADOCONTRATO", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDESTADOCONTRATO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ESTADOSCONTRATOS ")
        ...
        args(0).Value = lEntidad.IDESTADOCONTRATO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ESTADOSCONTRATOS ")
        strSQL.Append(" WHERE IDESTADOCONTRATO = @IDESTADOCONTRATO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDESTADOCONTRATO),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_ESTADOSCONTRATOS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaESTADOSCONTRATOS
        ...
        Dim lista As New listaESTADOSCONTRATOS

        Try
            Do While dr.Read()
                Dim mEntidad As New ESTADOSCONTRATOS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ESTADOSCONTRATOS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDESTADOCONTRATO, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
