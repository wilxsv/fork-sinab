...
''' Class	 : DL.dbENTREGAPROCESOCOMPRA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ENTREGAPROCESOCOMPRA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbENTREGAPROCESOCOMPRA
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ENTREGAPROCESOCOMPRA
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_UACI_ENTREGAPROCESOCOMPRA ")
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_ENTREGAPROCESOCOMPRA ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_ENTREGAPROCESOCOMPRA ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64) As listaENTREGAPROCESOCOMPRA
        ...
        Dim lista As New listaENTREGAPROCESOCOMPRA

        Try
            Do While dr.Read()
                Dim mEntidad As New ENTREGAPROCESOCOMPRA
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ENTREGAPROCESOCOMPRA")
