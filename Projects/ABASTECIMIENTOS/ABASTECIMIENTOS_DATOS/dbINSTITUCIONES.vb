...
''' Class	 : DL.dbINSTITUCIONES
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla INSTITUCIONES
''' </summary>
''' <remarks>
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As INSTITUCIONES
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDINSTITUCION = 0 _
            Or lEntidad.IDINSTITUCION = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDINSTITUCION = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_INSTITUCIONES ")
        strSQL.Append(" SET NOMBRE = @NOMBRE, ")
        strSQL.Append(" PORCENTAJERESERVA = @PORCENTAJERESERVA, ")
        strSQL.Append(" AUUSUARIOCREACION = @AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION = @AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION = @AUUSUARIOMODIFICACION, ")
        strSQL.Append(" AUFECHAMODIFICACION = @AUFECHAMODIFICACION, ")
        strSQL.Append(" ESTASINCRONIZADA = @ESTASINCRONIZADA ")
        strSQL.Append(" WHERE IDINSTITUCION = @IDINSTITUCION ")

        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@NOMBRE", SqlDbType.VarChar)
        args(0).Value = lEntidad.NOMBRE
        args(1) = New SqlParameter("@PORCENTAJERESERVA", SqlDbType.Decimal)
        args(1).Value = lEntidad.PORCENTAJERESERVA
        ...
        args(7) = New SqlParameter("@IDINSTITUCION", SqlDbType.Int)
        args(7).Value = lEntidad.IDINSTITUCION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_INSTITUCIONES ")
        strSQL.Append(" ( IDINSTITUCION, ")
        strSQL.Append(" NOMBRE, ")
        strSQL.Append(" PORCENTAJERESERVA, ")
        ...
        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@IDINSTITUCION", SqlDbType.Int)
        args(0).Value = lEntidad.IDINSTITUCION
        args(1) = New SqlParameter("@NOMBRE", SqlDbType.VarChar)
        args(1).Value = lEntidad.NOMBRE
        args(2) = New SqlParameter("@PORCENTAJERESERVA", SqlDbType.Decimal)
        args(2).Value = lEntidad.PORCENTAJERESERVA
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_INSTITUCIONES ")
        strSQL.Append(" WHERE IDINSTITUCION = @IDINSTITUCION ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                ...
                lEntidad.PORCENTAJERESERVA = IIf(.Item("PORCENTAJERESERVA") Is DBNull.Value, Nothing, .Item("PORCENTAJERESERVA"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDINSTITUCION),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaINSTITUCIONES
        ...
        Dim lista As New listaINSTITUCIONES

        Try
            Do While dr.Read()
                Dim mEntidad As New INSTITUCIONES
                ...
                mEntidad.PORCENTAJERESERVA = IIf(dr("PORCENTAJERESERVA") Is DBNull.Value, Nothing, dr("PORCENTAJERESERVA"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("INSTITUCIONES")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDINSTITUCION, ")
        strSQL.Append(" NOMBRE, ")
        strSQL.Append(" PORCENTAJERESERVA, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
