...
''' Class	 : DL.dbRESPONSABLEDISTRIBUCIONCONTRATO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla RESPONSABLEDISTRIBUCIONCONTRATO
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbRESPONSABLEDISTRIBUCIONCONTRATO
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As RESPONSABLEDISTRIBUCIONCONTRATO
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_RESPONSABLEDISTRIBUCIONCONTRATO ")
        ...
        strSQL.Append(" AND IDRESPONSABLEDISTRIBUCION = @IDRESPONSABLEDISTRIBUCION ")
        ...
        args(8) = New SqlParameter("@IDRESPONSABLEDISTRIBUCION", SqlDbType.Int)
        args(8).Value = lEntidad.IDRESPONSABLEDISTRIBUCION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_RESPONSABLEDISTRIBUCIONCONTRATO ")
        ...
        args(3).Value = lEntidad.IDRESPONSABLEDISTRIBUCION
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROVEEDOR As Int32, ByVal IDCONTRATO As Int64, ByVal IDRESPONSABLEDISTRIBUCION As Int32) As listaRESPONSABLEDISTRIBUCIONCONTRATO
        ...
        Dim lista As New listaRESPONSABLEDISTRIBUCIONCONTRATO

        Try
            Do While dr.Read()
                Dim mEntidad As New RESPONSABLEDISTRIBUCIONCONTRATO
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROVEEDOR As Int32, ByVal IDCONTRATO As Int64, ByVal IDRESPONSABLEDISTRIBUCION As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("RESPONSABLEDISTRIBUCIONCONTRATO")
