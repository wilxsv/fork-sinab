...
''' Class	 : DL.dbESTADOPROCESOSCOMPRAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ESTADOPROCESOSCOMPRAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbESTADOPROCESOSCOMPRAS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ESTADOPROCESOSCOMPRAS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDESTADOPROCESOCOMPRA = 0 _
            Or lEntidad.IDESTADOPROCESOCOMPRA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDESTADOPROCESOCOMPRA = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_ESTADOPROCESOSCOMPRAS ")
        ...
        strSQL.Append(" WHERE IDESTADOPROCESOCOMPRA = @IDESTADOPROCESOCOMPRA ")
        ...
        args(6) = New SqlParameter("@IDESTADOPROCESOCOMPRA", SqlDbType.Int)
        args(6).Value = lEntidad.IDESTADOPROCESOCOMPRA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ESTADOPROCESOSCOMPRAS ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDESTADOPROCESOCOMPRA", SqlDbType.Int)
        args(0).Value = lEntidad.IDESTADOPROCESOCOMPRA
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ESTADOPROCESOSCOMPRAS ")
        strSQL.Append(" WHERE IDESTADOPROCESOCOMPRA = @IDESTADOPROCESOCOMPRA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDESTADOPROCESOCOMPRA),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_ESTADOPROCESOSCOMPRAS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaESTADOPROCESOSCOMPRAS
        ...
        Dim lista As New listaESTADOPROCESOSCOMPRAS

        Try
            Do While dr.Read()
                Dim mEntidad As New ESTADOPROCESOSCOMPRAS
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ESTADOPROCESOSCOMPRAS")
