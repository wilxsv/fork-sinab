...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As DEPENDENCIAS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDDEPENDENCIA = 0 _
            Or lEntidad.IDDEPENDENCIA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDDEPENDENCIA = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_DEPENDENCIAS ")
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_DEPENDENCIAS ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_DEPENDENCIAS ")
        strSQL.Append(" WHERE IDDEPENDENCIA = @IDDEPENDENCIA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDDEPENDENCIA),0) + 1 ")
    ...
    Public Function ObtenerListaPorID(Optional ByVal ut As Integer = 0) As listaDEPENDENCIAS

        Dim strSQL As New StringBuilder
        SelectTabla(strSQL)
        If ut <> 0 Then
            strSQL.Append(" WHERE AREATECNICA=1 ")
        End If
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("DEPENDENCIAS")
