...
''' Class	 : DL.dbHISTORICOESTADOSPROCESOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla HISTORICOESTADOSPROCESOS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbHISTORICOESTADOSPROCESOS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As HISTORICOESTADOSPROCESOS
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_UACI_HISTORICOESTADOSPROCESOS ")
        strSQL.Append(" SET IDPROCESOCOMPRA = @IDPROCESOCOMPRA, ")
        strSQL.Append(" IDESTADOPROCESO = @IDESTADOPROCESO, ")
        ...
        args(1) = New SqlParameter("@IDESTADOPROCESO", SqlDbType.Int)
        args(1).Value = lEntidad.IDESTADOPROCESO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_HISTORICOESTADOSPROCESOS ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDDETALLE, ")
        strSQL.Append(" IDPROCESOCOMPRA, ")
        strSQL.Append(" IDESTADOPROCESO, ")
        strSQL.Append(" FECHA, ")
        ...
        args(3) = New SqlParameter("@IDESTADOPROCESO", SqlDbType.Int)
        args(3).Value = lEntidad.IDESTADOPROCESO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_HISTORICOESTADOSPROCESOS ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                ...
                lEntidad.IDESTADOPROCESO = IIf(.Item("IDESTADOPROCESO") Is DBNull.Value, Nothing, .Item("IDESTADOPROCESO"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        strSQL.Append(" FROM SAB_UACI_HISTORICOESTADOSPROCESOS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32) As listaHISTORICOESTADOSPROCESOS
        ...
        Dim lista As New listaHISTORICOESTADOSPROCESOS

        Try
            Do While dr.Read()
                Dim mEntidad As New HISTORICOESTADOSPROCESOS
                ...
                mEntidad.IDESTADOPROCESO = IIf(dr("IDESTADOPROCESO") Is DBNull.Value, Nothing, dr("IDESTADOPROCESO"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("HISTORICOESTADOSPROCESOS")
