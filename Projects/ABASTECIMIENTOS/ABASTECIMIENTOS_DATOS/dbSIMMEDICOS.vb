...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As SIMMEDICOS
        lEntidad = aEntidad

        Dim lID As String
        If lEntidad.CODMED = "" _
            Or lEntidad.CODMED = Nothing Then
        ...
        strSQL.Append("UPDATE SAB_EST_SIMMEDICOS ")
        strSQL.Append(" SET NOMMED = @NOMMED, ")
        ...
        strSQL.Append(" AND CODMED = @CODMED ")

        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@NOMMED", SqlDbType.VarChar)
        args(0).Value = lEntidad.NOMMED
        ...
        args(7) = New SqlParameter("@CODMED", SqlDbType.VarChar)
        args(7).Value = lEntidad.CODMED
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_EST_SIMMEDICOS ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" CODMED, ")
        strSQL.Append(" NOMMED, ")
        ...
        args(1) = New SqlParameter("@CODMED", SqlDbType.VarChar)
        args(1).Value = lEntidad.CODMED
        args(2) = New SqlParameter("@NOMMED", SqlDbType.VarChar)
        args(2).Value = lEntidad.NOMMED
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_EST_SIMMEDICOS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND CODMED = @CODMED ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.NOMMED = IIf(.Item("NOMMED") Is DBNull.Value, Nothing, .Item("NOMMED"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(CODMED),0) + 1 ")
        strSQL.Append(" FROM SAB_EST_SIMMEDICOS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32) As listaSIMMEDICOS
        ...
        Dim lista As New listaSIMMEDICOS

        Try
            Do While dr.Read()
                Dim mEntidad As New SIMMEDICOS
                mEntidad.IDESTABLECIMIENTO = IDESTABLECIMIENTO
                mEntidad.CODMED = IIf(dr("CODMED") Is DBNull.Value, Nothing, dr("CODMED"))
                mEntidad.NOMMED = IIf(dr("NOMMED") Is DBNull.Value, Nothing, dr("NOMMED"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("SIMMEDICOS")
