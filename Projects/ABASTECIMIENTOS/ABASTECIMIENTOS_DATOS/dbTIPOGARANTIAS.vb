...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOGARANTIAS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPOGARANTIA = 0 _
            Or lEntidad.IDTIPOGARANTIA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPOGARANTIA = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOGARANTIAS ")
        ...
        args(6) = New SqlParameter("@IDTIPOGARANTIA", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDTIPOGARANTIA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOGARANTIAS ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDTIPOGARANTIA", SqlDbType.SmallInt)
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOGARANTIAS ")
        strSQL.Append(" WHERE IDTIPOGARANTIA = @IDTIPOGARANTIA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOGARANTIA),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPOGARANTIAS ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPOGARANTIAS
        ...
        Dim lista As New listaTIPOGARANTIAS

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPOGARANTIAS
                mEntidad.IDTIPOGARANTIA = IIf(dr("IDTIPOGARANTIA") Is DBNull.Value, Nothing, dr("IDTIPOGARANTIA"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOGARANTIAS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPOGARANTIA, ")
        strSQL.Append(" NOMBRE, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
