...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As SUBGRUPOS
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDSUBGRUPO = 0 _
            Or lEntidad.IDSUBGRUPO = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDSUBGRUPO = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_SUBGRUPOS ")
        ...
        args(0).Value = lEntidad.CORRELATIVO
        ...
        args(8) = New SqlParameter("@IDSUBGRUPO", SqlDbType.Int)
        args(8).Value = lEntidad.IDSUBGRUPO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_SUBGRUPOS ")
        ...
        args(0).Value = lEntidad.IDSUBGRUPO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_SUBGRUPOS ")
        strSQL.Append(" WHERE IDSUBGRUPO = @IDSUBGRUPO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDSUBGRUPO),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaSUBGRUPOS
