...
''' Class	 : DL.dbEXAMENRENGLON
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla EXAMENRENGLON
''' </summary>
''' <remarks>
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As EXAMENRENGLON
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_EXAMENRENGLON ")
        strSQL.Append(" SET ENTREGADO1 = @ENTREGADO1, ")
        strSQL.Append(" ENTREGADO2 = @ENTREGADO2, ")
        ...
        args(0).Value = lEntidad.ENTREGADO1
        args(1) = New SqlParameter("@ENTREGADO2", SqlDbType.TinyInt)
        args(1).Value = lEntidad.ENTREGADO2
        ...
        args(11) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(11).Value = lEntidad.IDDOCUMENTOBASE
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_EXAMENRENGLON ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDPROCESOCOMPRA, ")
        strSQL.Append(" IDPROVEEDOR, ")
        strSQL.Append(" IDDETALLE, ")
        strSQL.Append(" IDDOCUMENTOBASE, ")
        strSQL.Append(" ENTREGADO1, ")
        strSQL.Append(" ENTREGADO2, ")
        ...
        args(4) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(4).Value = lEntidad.IDDOCUMENTOBASE
        args(5) = New SqlParameter("@ENTREGADO1", SqlDbType.TinyInt)
        args(5).Value = lEntidad.ENTREGADO1
        args(6) = New SqlParameter("@ENTREGADO2", SqlDbType.TinyInt)
        args(6).Value = lEntidad.ENTREGADO2
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_EXAMENRENGLON ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.ENTREGADO1 = IIf(.Item("ENTREGADO1") Is DBNull.Value, Nothing, .Item("ENTREGADO1"))
                lEntidad.ENTREGADO2 = IIf(.Item("ENTREGADO2") Is DBNull.Value, Nothing, .Item("ENTREGADO2"))
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32, ByVal IDDETALLE As Int64, ByVal IDDOCUMENTOBASE As Int16) As listaEXAMENRENGLON
        ...
        args(4) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(4).Value = IDDOCUMENTOBASE

        Dim dr As SqlDataReader

        dr = SqlHelper.ExecuteReader(Me.cnnStr, CommandType.Text, strSQL.ToString(), args)

        Dim lista As New listaEXAMENRENGLON

        Try
            Do While dr.Read()
                Dim mEntidad As New EXAMENRENGLON
                ...
                mEntidad.ENTREGADO1 = IIf(dr("ENTREGADO1") Is DBNull.Value, Nothing, dr("ENTREGADO1"))
                mEntidad.ENTREGADO2 = IIf(dr("ENTREGADO2") Is DBNull.Value, Nothing, dr("ENTREGADO2"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32, ByVal IDDETALLE As Int64, ByVal IDDOCUMENTOBASE As Int16, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("EXAMENRENGLON")
