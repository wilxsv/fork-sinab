...
''' Class	 : DL.dbESTADOSNECESIDADES
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ESTADOSNECESIDADES
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbESTADOSNECESIDADES
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ESTADOSNECESIDADES
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDESTADONECESIDAD = 0 _
            Or lEntidad.IDESTADONECESIDAD = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDESTADONECESIDAD = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_ESTADOSNECESIDADES ")
        ...
        strSQL.Append(" WHERE IDESTADONECESIDAD = @IDESTADONECESIDAD ")
        ...
        args(6) = New SqlParameter("@IDESTADONECESIDAD", SqlDbType.Int)
        args(6).Value = lEntidad.IDESTADONECESIDAD
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ESTADOSNECESIDADES ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDESTADONECESIDAD", SqlDbType.Int)
        args(0).Value = lEntidad.IDESTADONECESIDAD
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ESTADOSNECESIDADES ")
        strSQL.Append(" WHERE IDESTADONECESIDAD = @IDESTADONECESIDAD ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDESTADONECESIDAD),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_ESTADOSNECESIDADES ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaESTADOSNECESIDADES
        ...
        Dim lista As New listaESTADOSNECESIDADES

        Try
            Do While dr.Read()
                Dim mEntidad As New ESTADOSNECESIDADES
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ESTADOSNECESIDADES")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDESTADONECESIDAD, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
