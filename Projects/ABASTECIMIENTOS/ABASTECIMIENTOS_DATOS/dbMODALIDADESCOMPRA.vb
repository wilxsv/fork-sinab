...
''' Class	 : DL.dbMODALIDADESCOMPRA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla MODALIDADESCOMPRA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbMODALIDADESCOMPRA
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As MODALIDADESCOMPRA
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDMODALIDADCOMPRA = 0 _
            Or lEntidad.IDMODALIDADCOMPRA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDMODALIDADCOMPRA = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_MODALIDADESCOMPRA ")
        ...
        args(6) = New SqlParameter("@IDMODALIDADCOMPRA", SqlDbType.TinyInt)
        args(6).Value = lEntidad.IDMODALIDADCOMPRA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_MODALIDADESCOMPRA ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_MODALIDADESCOMPRA ")
        strSQL.Append(" WHERE IDMODALIDADCOMPRA = @IDMODALIDADCOMPRA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        strSQL.Append(" FROM SAB_CAT_MODALIDADESCOMPRA ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaMODALIDADESCOMPRA
        ...
        Dim lista As New listaMODALIDADESCOMPRA

        Try
            Do While dr.Read()
                Dim mEntidad As New MODALIDADESCOMPRA
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("MODALIDADESCOMPRA")
