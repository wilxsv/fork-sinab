...
''' Class	 : DL.dbANALISTAPROVEEDORES
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla SAB_UACI_ANALISTAPROVEEDORES
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbANALISTAPROVEEDORES
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ANALISTAPROVEEDORES
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_ANALISTAPROVEEDORES ")
        ...
        strSQL.Append(" AND IDANALISTA = @IDANALISTA ")
        ...
        args(8) = New SqlParameter("@IDANALISTA", SqlDbType.Int)
        args(8).Value = lEntidad.IDANALISTA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_ANALISTAPROVEEDORES ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDPROCESOCOMPRA, ")
        strSQL.Append(" IDPROVEEDOR, ")
        strSQL.Append(" IDANALISTA, ")
        ...
        strSQL.Append(" @AUFECHAMODIFICACION, ")
        strSQL.Append(" @ESTASINCRONIZADA) ")
        'OJO SE MODIFICA PARA VALIDAR IDANALISTA
        Dim args(8) As SqlParameter
        ...
        args(3) = New SqlParameter("@IDANALISTA", SqlDbType.Int)
        args(3).Value = IIf(lEntidad.IDANALISTA = Nothing, DBNull.Value, lEntidad.IDANALISTA)
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_ANALISTAPROVEEDORES ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPROCESOCOMPRA = @IDPROCESOCOMPRA ")
        strSQL.Append(" AND IDPROVEEDOR = @IDPROVEEDOR ")
        strSQL.Append(" AND IDANALISTA = @IDANALISTA ")
        ...
        args(2).Value = lEntidad.IDPROVEEDOR
        args(3) = New SqlParameter("@IDANALISTA", SqlDbType.Int)
        args(3).Value = lEntidad.IDANALISTA
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32, ByVal IDANALISTA As Int32) As listaANALISTAPROVEEDORES
        ...
        args(3) = New SqlParameter("@IDANALISTA", SqlDbType.Int)
        args(3).Value = IDANALISTA

        Dim dr As SqlDataReader

        dr = SqlHelper.ExecuteReader(Me.cnnStr, CommandType.Text, strSQL.ToString(), args)

        Dim lista As New listaANALISTAPROVEEDORES
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDPROVEEDOR As Int32, ByVal IDANALISTA As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ANALISTAPROVEEDORES")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" AUFECHAMODIFICACION, ")
        strSQL.Append(" ESTASINCRONIZADA ")
        strSQL.Append(" FROM SAB_UACI_ANALISTAPROVEEDORES ")
