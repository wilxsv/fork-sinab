...
''' Class	 : DL.dbDOCUMENTOSPROCESOSCOMPRA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla DOCUMENTOSPROCESOSCOMPRA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbDOCUMENTOSPROCESOSCOMPRA
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As DOCUMENTOSPROCESOSCOMPRA
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_DOCUMENTOSPROCESOSCOMPRA ")
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_DOCUMENTOSPROCESOSCOMPRA ")
        ...
        args(2) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(2).Value = lEntidad.IDDOCUMENTOBASE
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_DOCUMENTOSPROCESOSCOMPRA ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPROCESOCOMPRA = @IDPROCESOCOMPRA ")
        strSQL.Append(" AND IDDOCUMENTOBASE = @IDDOCUMENTOBASE ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDDOCUMENTOBASE As Int16) As listaDOCUMENTOSPROCESOSCOMPRA
        ...
        args(2) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(2).Value = IDDOCUMENTOBASE

        Dim dr As SqlDataReader

        dr = SqlHelper.ExecuteReader(Me.cnnStr, CommandType.Text, strSQL.ToString(), args)

        Dim lista As New listaDOCUMENTOSPROCESOSCOMPRA

        Try
            Do While dr.Read()
                Dim mEntidad As New DOCUMENTOSPROCESOSCOMPRA
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByVal IDDOCUMENTOBASE As Int16, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("DOCUMENTOSPROCESOSCOMPRA")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" AUFECHAMODIFICACION, ")
        strSQL.Append(" ESTASINCRONIZADA ")
        strSQL.Append(" FROM SAB_UACI_DOCUMENTOSPROCESOSCOMPRA ")
