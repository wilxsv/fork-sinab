...
''' Class	 : DL.dbMOTIVOSNOACEPTACIONINFORME
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla SAB_LAB_MOTIVOSNOACEPTACIONINFORME
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbMOTIVOSNOACEPTACIONINFORME
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As MOTIVOSNOACEPTACIONINFORME
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_LAB_MOTIVOSNOACEPTACIONINFORME ")
        ...
        strSQL.Append(" AND IDMOTIVONOACEPTACION = @IDMOTIVONOACEPTACION ")
        ...
        args(6) = New SqlParameter("@IDINFORME", SqlDbType.Int)
        args(6).Value = lEntidad.IDINFORME
        args(7) = New SqlParameter("@IDMOTIVONOACEPTACION", SqlDbType.TinyInt)
        args(7).Value = lEntidad.IDMOTIVONOACEPTACION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_LAB_MOTIVOSNOACEPTACIONINFORME ")
        ...
        args(2) = New SqlParameter("@IDMOTIVONOACEPTACION", SqlDbType.TinyInt)
        args(2).Value = lEntidad.IDMOTIVONOACEPTACION
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDINFORME As Int32, ByVal IDMOTIVONOACEPTACION As Byte) As listaMOTIVOSNOACEPTACIONINFORME
        ...
        args(2) = New SqlParameter("@IDMOTIVONOACEPTACION", SqlDbType.TinyInt)
        args(2).Value = IDMOTIVONOACEPTACION
        ...
        Try
            Do While dr.Read()
                Dim mEntidad As New MOTIVOSNOACEPTACIONINFORME
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDINFORME As Int32, ByVal IDMOTIVONOACEPTACION As Byte, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("MOTIVOSNOACEPTACIONINFORME")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" AUFECHAMODIFICACION, ")
        strSQL.Append(" ESTASINCRONIZADA ")
        strSQL.Append(" FROM SAB_LAB_MOTIVOSNOACEPTACIONINFORME ")
