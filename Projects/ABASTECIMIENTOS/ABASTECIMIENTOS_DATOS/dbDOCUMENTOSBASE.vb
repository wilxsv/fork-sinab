...
''' Class	 : DL.dbDOCUMENTOSBASE
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla DOCUMENTOSBASE
''' </summary>
''' <remarks>
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As DOCUMENTOSBASE
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDDOCUMENTOBASE = 0 _
            Or lEntidad.IDDOCUMENTOBASE = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDDOCUMENTOBASE = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_DOCUMENTOSBASE ")
        strSQL.Append(" SET IDTIPODOCUMENTOBASE = @IDTIPODOCUMENTOBASE, ")
        ...
        args(7).Value = lEntidad.IDDOCUMENTOBASE
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_DOCUMENTOSBASE ")
        ...
        Dim args(7) As SqlParameter
        args(0) = New SqlParameter("@IDDOCUMENTOBASE", SqlDbType.SmallInt)
        args(0).Value = lEntidad.IDDOCUMENTOBASE
        args(1) = New SqlParameter("@IDTIPODOCUMENTOBASE", SqlDbType.SmallInt)
        args(1).Value = lEntidad.IDTIPODOCUMENTOBASE
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_DOCUMENTOSBASE ")
        strSQL.Append(" WHERE IDDOCUMENTOBASE = @IDDOCUMENTOBASE ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.IDTIPODOCUMENTOBASE = IIf(.Item("IDTIPODOCUMENTOBASE") Is DBNull.Value, Nothing, .Item("IDTIPODOCUMENTOBASE"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDDOCUMENTOBASE),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaDOCUMENTOSBASE
        ...
        Dim lista As New listaDOCUMENTOSBASE

        Try
            Do While dr.Read()
                Dim mEntidad As New DOCUMENTOSBASE
                mEntidad.IDDOCUMENTOBASE = IIf(dr("IDDOCUMENTOBASE") Is DBNull.Value, Nothing, dr("IDDOCUMENTOBASE"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("DOCUMENTOSBASE")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDDOCUMENTOBASE, ")
        strSQL.Append(" IDTIPODOCUMENTOBASE, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
