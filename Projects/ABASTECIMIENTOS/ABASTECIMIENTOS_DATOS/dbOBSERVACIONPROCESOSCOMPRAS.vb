...
''' Class	 : DL.dbOBSERVACIONPROCESOSCOMPRAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla OBSERVACIONPROCESOSCOMPRAS
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbOBSERVACIONPROCESOSCOMPRAS
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As OBSERVACIONPROCESOSCOMPRAS
        lEntidad = aEntidad

        Dim strSQL As New StringBuilder
        strSQL.Append("UPDATE SAB_UACI_OBSERVACIONPROCESOSCOMPRAS ")
        ...
        strSQL.Append(" WHERE IDPROCESO = @IDPROCESO ")
        ...
        args(7) = New SqlParameter("@IDPROCESO", SqlDbType.BigInt)
        args(7).Value = lEntidad.IDPROCESO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_UACI_OBSERVACIONPROCESOSCOMPRAS ")
        strSQL.Append(" ( IDESTABLECIMIENTO, ")
        strSQL.Append(" IDPROCESO, ")
        ...
        args(1) = New SqlParameter("@IDPROCESO", SqlDbType.BigInt)
        args(1).Value = lEntidad.IDPROCESO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_OBSERVACIONPROCESOSCOMPRAS ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPROCESO = @IDPROCESO ")
        strSQL.Append(" AND IDESTADO = @IDESTADO ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESO As Int64, ByVal IDESTADO As Int32) As listaOBSERVACIONPROCESOSCOMPRAS
        ...
        Dim lista As New listaOBSERVACIONPROCESOSCOMPRAS

        Try
            Do While dr.Read()
                Dim mEntidad As New OBSERVACIONPROCESOSCOMPRAS
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESO As Int64, ByVal IDESTADO As Int32, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("OBSERVACIONPROCESOSCOMPRAS")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" AUFECHAMODIFICACION, ")
        strSQL.Append(" ESTASINCRONIZADA ")
        strSQL.Append(" FROM SAB_UACI_OBSERVACIONPROCESOSCOMPRAS ")
