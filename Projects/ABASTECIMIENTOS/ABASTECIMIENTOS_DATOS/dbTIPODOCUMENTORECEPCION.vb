...
Public Class dbTIPODOCUMENTORECEPCION
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPODOCUMENTORECEPCION
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPODOCUMENTORECEPCION = 0 _
            Or lEntidad.IDTIPODOCUMENTORECEPCION = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPODOCUMENTORECEPCION = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPODOCUMENTORECEPCION ")
        ...
        strSQL.Append(" WHERE IDTIPODOCUMENTORECEPCION = @IDTIPODOCUMENTORECEPCION ")
        ...
        args(6) = New SqlParameter("@IDTIPODOCUMENTORECEPCION", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDTIPODOCUMENTORECEPCION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPODOCUMENTORECEPCION ")
        strSQL.Append(" ( IDTIPODOCUMENTORECEPCION, ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDTIPODOCUMENTORECEPCION", SqlDbType.SmallInt)
        args(0).Value = lEntidad.IDTIPODOCUMENTORECEPCION
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPODOCUMENTORECEPCION ")
        strSQL.Append(" WHERE IDTIPODOCUMENTORECEPCION = @IDTIPODOCUMENTORECEPCION ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPODOCUMENTORECEPCION),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPODOCUMENTORECEPCION ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPODOCUMENTORECEPCION
        ...
        Dim lista As New listaTIPODOCUMENTORECEPCION

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPODOCUMENTORECEPCION
                mEntidad.IDTIPODOCUMENTORECEPCION = IIf(dr("IDTIPODOCUMENTORECEPCION") Is DBNull.Value, Nothing, dr("IDTIPODOCUMENTORECEPCION"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPODOCUMENTORECEPCION")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPODOCUMENTORECEPCION, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
