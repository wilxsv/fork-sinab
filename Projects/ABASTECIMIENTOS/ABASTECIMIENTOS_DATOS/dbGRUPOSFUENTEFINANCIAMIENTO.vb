...
Public Class dbGRUPOSFUENTEFINANCIAMIENTO
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As GRUPOSFUENTEFINANCIAMIENTO
        lEntidad = aEntidad
        ...
        strSQL.Append("UPDATE SAB_CAT_GRUPOSFUENTEFINANCIAMIENTO ")
        ...
        args(6) = New SqlParameter("@IDGRUPO", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDGRUPO
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_GRUPOSFUENTEFINANCIAMIENTO ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDGRUPO", SqlDbType.SmallInt)
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_GRUPOSFUENTEFINANCIAMIENTO ")
        strSQL.Append(" WHERE IDGRUPO = @IDGRUPO ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        strSQL.Append("FROM SAB_CAT_GRUPOSFUENTEFINANCIAMIENTO ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaGRUPOSFUENTEFINANCIAMIENTO
        ...
        Dim lista As New listaGRUPOSFUENTEFINANCIAMIENTO

        Try
            Do While dr.Read()
                Dim mEntidad As New GRUPOSFUENTEFINANCIAMIENTO
                mEntidad.IDGRUPO = dr("IDGRUPO")
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("GRUPOSFUENTEFINANCIAMIENTO")
