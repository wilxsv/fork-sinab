...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOIDENTIFICACION
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPOIDENTIFICACION = 0 _
            Or lEntidad.IDTIPOIDENTIFICACION = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPOIDENTIFICACION = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOIDENTIFICACION ")
        ...
        strSQL.Append(" WHERE IDTIPOIDENTIFICACION = @IDTIPOIDENTIFICACION ")
        ...
        args(6).Value = lEntidad.IDTIPOIDENTIFICACION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOIDENTIFICACION ")
        ...
        Dim args(6) As SqlParameter
        args(0) = New SqlParameter("@IDTIPOIDENTIFICACION", SqlDbType.SmallInt)
        args(0).Value = lEntidad.IDTIPOIDENTIFICACION
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOIDENTIFICACION ")
        strSQL.Append(" WHERE IDTIPOIDENTIFICACION = @IDTIPOIDENTIFICACION ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOIDENTIFICACION),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPOIDENTIFICACION ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPOIDENTIFICACION
        ...
        Dim lista As New listaTIPOIDENTIFICACION

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPOIDENTIFICACION
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOIDENTIFICACION")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPOIDENTIFICACION, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
