...
Public Class dbTIPOTRANSACCIONES
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As TIPOTRANSACCIONES
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDTIPOTRANSACCION = 0 _
            Or lEntidad.IDTIPOTRANSACCION = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDTIPOTRANSACCION = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_TIPOTRANSACCIONES ")
        strSQL.Append(" SET DESCRIPCION = @DESCRIPCION, ")
        strSQL.Append(" AFECTAINVENTARIO = @AFECTAINVENTARIO, ")
        ...
        args(1) = New SqlParameter("@AFECTAINVENTARIO", SqlDbType.SmallInt)
        args(1).Value = lEntidad.AFECTAINVENTARIO
        ...
        args(7) = New SqlParameter("@IDTIPOTRANSACCION", SqlDbType.Int)
        args(7).Value = lEntidad.IDTIPOTRANSACCION
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_TIPOTRANSACCIONES ")
        strSQL.Append(" ( IDTIPOTRANSACCION, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AFECTAINVENTARIO, ")
        ...
        args(2) = New SqlParameter("@AFECTAINVENTARIO", SqlDbType.SmallInt)
        args(2).Value = lEntidad.AFECTAINVENTARIO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_TIPOTRANSACCIONES ")
        strSQL.Append(" WHERE IDTIPOTRANSACCION = @IDTIPOTRANSACCION ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                ...
                lEntidad.AFECTAINVENTARIO = IIf(.Item("AFECTAINVENTARIO") Is DBNull.Value, Nothing, .Item("AFECTAINVENTARIO"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDTIPOTRANSACCION),0) + 1 ")
        strSQL.Append(" FROM SAB_CAT_TIPOTRANSACCIONES ")

        Return SqlHelper.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listaTIPOTRANSACCIONES
        ...
        Dim lista As New listaTIPOTRANSACCIONES

        Try
            Do While dr.Read()
                Dim mEntidad As New TIPOTRANSACCIONES
                mEntidad.IDTIPOTRANSACCION = IIf(dr("IDTIPOTRANSACCION") Is DBNull.Value, Nothing, dr("IDTIPOTRANSACCION"))
                mEntidad.DESCRIPCION = IIf(dr("DESCRIPCION") Is DBNull.Value, Nothing, dr("DESCRIPCION"))
                mEntidad.AFECTAINVENTARIO = IIf(dr("AFECTAINVENTARIO") Is DBNull.Value, Nothing, dr("AFECTAINVENTARIO"))
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("TIPOTRANSACCIONES")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDTIPOTRANSACCION, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AFECTAINVENTARIO, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
...
#Region " Métodos agregados "
    ...
    Public Function RecuperarTransaccionesAfectanInventario() As DataSet
        ...
        Dim strSQL As New StringBuilder
        SelectTabla(strSQL)
        strSQL.Append("WHERE AFECTAINVENTARIO <> 0 ")
        strSQL.Append("ORDER BY IDTIPOTRANSACCION ")
