...
''' Class	 : DL.dbASESORIAPREDEFINIDA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla ASESORIAPREDEFINIDA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbASESORIAPREDEFINIDA
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As ASESORIAPREDEFINIDA
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.IDASESORIA = 0 _
            Or lEntidad.IDASESORIA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.IDASESORIA = lID
        ...
        strSQL.Append("UPDATE SAB_CAT_ASESORIAPREDEFINIDA ")
        ...
        strSQL.Append(" WHERE IDASESORIA = @IDASESORIA ")
        ...
        args(6) = New SqlParameter("@IDASESORIA", SqlDbType.SmallInt)
        args(6).Value = lEntidad.IDASESORIA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO SAB_CAT_ASESORIAPREDEFINIDA ")
        ...
        args(0).Value = lEntidad.IDASESORIA
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_CAT_ASESORIAPREDEFINIDA ")
        strSQL.Append(" WHERE IDASESORIA = @IDASESORIA ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(IDASESORIA),0) + 1 ")
    ...
    Public Function ObtenerListaPorID() As listaASESORIAPREDEFINIDA
        ...
        Dim lista As New listaASESORIAPREDEFINIDA

        Try
            Do While dr.Read()
                Dim mEntidad As New ASESORIAPREDEFINIDA
    ...
    Public Function ObtenerDataSetPorID(ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("ASESORIAPREDEFINIDA")
    ...
    Private Sub SelectTabla(ByRef strSQL As StringBuilder)
        ...
        strSQL.Append(" SELECT IDASESORIA, ")
        strSQL.Append(" DESCRIPCION, ")
        strSQL.Append(" AUUSUARIOCREACION, ")
        strSQL.Append(" AUFECHACREACION, ")
        strSQL.Append(" AUUSUARIOMODIFICACION, ")
