...
''' Class	 : DL.dbDETALLEPLANTILLAPROCESOCOMPRA
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase de Acceso a Datos que contiene las operaciones CRUD(Create, Read,
''' Update y Delete) de la tabla SAB_UACI_DETALLEPLANTILLAPROCESOCOMPRA
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class dbDETALLEPLANTILLAPROCESOCOMPRA
    Inherits dbBase
...
#Region " Metodos Generador "
    ...
    Public Overrides Function Actualizar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim lEntidad As DETALLEPLANTILLAPROCESOCOMPRA
        lEntidad = aEntidad

        Dim lID As Long
        If lEntidad.TIPOPLANTILLA = 0 _
            Or lEntidad.TIPOPLANTILLA = Nothing Then

            lID = Me.ObtenerID(lEntidad)

            If lID = -1 Then Return -1

            lEntidad.TIPOPLANTILLA = lID
        ...
        args(0) = New SqlParameter("@TEXTO", SqlDbType.VarChar)
        args(0).Value = lEntidad.TEXTO
        ...
        args(8).Value = lEntidad.TIPOPLANTILLA
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        args(2).Value = lEntidad.TIPOPLANTILLA
        args(3) = New SqlParameter("@TEXTO", SqlDbType.VarChar)
        args(3).Value = lEntidad.TEXTO
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM SAB_UACI_DETALLEPLANTILLAPROCESOCOMPRA ")
        strSQL.Append(" WHERE IDESTABLECIMIENTO = @IDESTABLECIMIENTO ")
        strSQL.Append(" AND IDPROCESOCOMPRA = @IDPROCESOCOMPRA ")
        strSQL.Append(" AND TIPOPLANTILLA = @TIPOPLANTILLA ")
    ...
    Public Overrides Function Recuperar(ByVal aEntidad As entidadBase) As Integer
        ...
        Try
            With dsDatos.Tables(0).Rows(0)
                lEntidad.TEXTO = IIf(.Item("TEXTO") Is DBNull.Value, Nothing, .Item("TEXTO"))
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As String
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("SELECT isnull(max(TIPOPLANTILLA),0) + 1 ")
    ...
    Public Function ObtenerListaPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64) As listaDETALLEPLANTILLAPROCESOCOMPRA
        ...
        Dim lista As New listaDETALLEPLANTILLAPROCESOCOMPRA

        Try
            Do While dr.Read()
                Dim mEntidad As New DETALLEPLANTILLAPROCESOCOMPRA
                ...
                mEntidad.TEXTO = IIf(dr("TEXTO") Is DBNull.Value, Nothing, dr("TEXTO"))
    ...
    Public Function ObtenerDataSetPorID(ByVal IDESTABLECIMIENTO As Int32, ByVal IDPROCESOCOMPRA As Int64, ByRef ds As DataSet) As Integer
        ...
        tables(0) = New String("DETALLEPLANTILLAPROCESOCOMPRA")
