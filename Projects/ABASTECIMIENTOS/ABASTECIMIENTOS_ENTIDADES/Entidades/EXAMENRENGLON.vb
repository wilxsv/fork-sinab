...
''' Class	 : EL.EXAMENRENGLON
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ABASTECIMIENTOSEXAMENRENGLON en memoria
''' </summary>
''' <remarks>
...
#Region " Propiedades "
    ...
    Private _ENTREGADO1 As Byte
    Public Property ENTREGADO1() As Byte
        Get
            Return _ENTREGADO1
        End Get
    ...
    Private _ENTREGADO2 As Byte
    Public Property ENTREGADO2() As Byte
        Get
            Return _ENTREGADO2
        End Get
        Set(ByVal value As Byte)
