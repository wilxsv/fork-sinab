...
''' Class	 : EL.RECURSOSREVISION
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ABASTECIMIENTOSRECURSOSREVISION en memoria
''' </summary>
''' <remarks>
...
#Region " Propiedades "
    ...
    Private _IDRECURSO As Int32
    Public Property IDRECURSO() As Int32
        Get
            Return _IDRECURSO
        End Get
        Set(ByVal value As Int32)
    ...
    Private _ADMITIDO As Byte
    Public Property ADMITIDO() As Byte
        Get
            Return _ADMITIDO
        End Get
