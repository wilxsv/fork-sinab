...
''' Class	 : EL.ENTREGACONTRATO
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ABASTECIMIENTOSENTREGACONTRATO en memoria
''' </summary>
''' <remarks>
...
#Region " Propiedades "
    ...
    Private _ENTREGA As Byte
    Public Property ENTREGA() As Byte
        Get
            Return _ENTREGA
        End Get
    ...
    Private _ESTAHABILITADA As Byte
    Public Property ESTAHABILITADA() As Byte
        Get
            Return _ESTAHABILITADA
        End Get
        Set(ByVal value As Byte)
            _ESTAHABILITADA = value
        End Set
    End Property
