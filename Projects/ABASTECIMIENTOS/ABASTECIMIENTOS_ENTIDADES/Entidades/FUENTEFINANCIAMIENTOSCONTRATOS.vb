...
''' Class	 : EL.FUENTEFINANCIAMIENTOSCONTRATOS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ABASTECIMIENTOSFUENTEFINANCIAMIENTOSCONTRATOS en memoria
''' </summary>
''' <remarks>
...
''' </history>
''' -----------------------------------------------------------------------------
Public Class FUENTEFINANCIAMIENTOSCONTRATOS
...
#Region " Propiedades "
    ...
    Private _MONTOCONTRATADO As Decimal
    Public Property MONTOCONTRATADO() As Decimal
        Get
            Return _MONTOCONTRATADO
        End Get
        Set(ByVal value As Decimal)
            _MONTOCONTRATADO = value
        End Set
    End Property
