...
''' Class	 : EL.RECEPCIONOFERTAS
''' 
''' -----------------------------------------------------------------------------
''' <summary>
''' Clase que permite tener un registro de la tabla ABASTECIMIENTOSRECEPCIONOFERTAS en memoria
''' </summary>
''' <remarks>
...
#Region " Propiedades "
    ...
    Private _PERSONAENTREGA As String
    Public Property PERSONAENTREGA() As String
        Get
            Return _PERSONAENTREGA
        End Get
        Set(ByVal value As String)
            _PERSONAENTREGA = value
        End Set
    End Property
