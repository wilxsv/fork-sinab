<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="frmGenerarContratosLG.aspx.vb" Inherits="frmGenerarContratosLG" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    <table class="CenteredTable" style="width: 100%">
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="A continuación se presentan una serie de pasos para la generación de órdenes de compra" /></td>
        </tr>
        <tr>
            <td>
            </td>
