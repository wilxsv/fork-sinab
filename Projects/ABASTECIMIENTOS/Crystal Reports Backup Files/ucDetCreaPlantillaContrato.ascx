            ...
            <asp:Panel ID="Panel1" runat="server" Width="100%">
                <table class="CenteredTable" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNombre" runat="server" Width="398px" /></td>
                    </tr>
                    <tr>
                        <td class="LabelCell">
                            <asp:Label ID="Label4" runat="server" Text="Personeria Jurídica:" /></td>
                        <td class="DataCell">
                ...
                <table class="CenteredTable" style="width: 100%">
                    ...
                    <tr>
                        <td colspan="2" style="text-align: right;">
                            ...
                            <asp:LinkButton ID="LinkButton4" runat="server" Visible="False" Text="Siguiente >" /></td>
                    </tr>
                </table>
            </asp:Panel>
        </td>
                ...
                <table class="CenteredTable" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;" valign="top">
                            <cc2:RichTextEditor ID="rteContenido" runat="server" Height="100%" RTEResourcesUrl="../RTE_Resources/" OverrideReturnKey="True" Width="100%" HideAbout="True" HideBackgroundColor="True" HideBold="True" HideBulletedList="True" HideFontSelection="True" HideFontSizeSelection="True" HideHeaderSelection="True" HideInsertDate="True" HideInsertImage="True" HideInsertLink="True" HideInsertTable="True" HideItalic="True" HideOrderedList="True" HideRemoveFormatting="True" HideStyleSheetSelection="True" HideToolBar2="True" HideToolBar3="True" HideViewHtml="True" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2" style="text-align: right;">
                            <asp:LinkButton ID="LinkButton6" runat="server" Text="< Regresar a lista de clausulas" /></td>
                    </tr>
                </table>
            </asp:Panel>
        </td>
