...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
  <table width="100%">
    <tr>
      <td align="left" width="4%" bgcolor="#b5c7de">
    ...
    <tr>
      <td align="left" style="height: 22px" width="2%">
    ...
    <tr>
      <td>
        ...
        <br />
        <asp:Label ID="lblmensaje2" runat="server" Text="Favor elija el consumo a tomar de base" /></td>
    </tr>
    <tr>
