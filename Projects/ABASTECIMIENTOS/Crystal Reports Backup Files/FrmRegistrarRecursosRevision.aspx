  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -> Registrar recursos de revisión</td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td class="CoolLabelCell">
        <asp:Label ID="Label4" runat="server" Text="Fecha de notificación a empresas:" /></td>
      <td class="CoolDataCell">
    ...
    <tr>
      <td class="LabelCell">
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Proveedores adjudicatarios:" /></td>
      <td class="DataCell">
        <asp:Button ID="btnImprimirAdjudicatarios" runat="server" Text="Imprimir adjudicatarios"
          CausesValidation="False" UseSubmitBehavior="False" Width="159px" /></td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td class="LabelCell">
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Recursos de revisión presentados:" /></td>
      <td class="DataCell">
    ...
    <tr>
      <td colspan="2">
        <asp:Button ID="btnAgregar" runat="server" Text="Agregar nuevo recurso" CausesValidation="False" /></td>
    </tr>
    <tr>
      <td colspan="2">
        <asp:Panel ID="Panel1" runat="server" Width="100%">
          <table class="Table">
            <tr>
              <td align="center" class="LabelCell" colspan="2">
                <asp:Button ID="btnProveedoresAfectados" runat="server" Text="Imprimir proveedores afectados"
                  CausesValidation="False" Width="198px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Proveedor:</td>
            ...
            <tr>
              <td class="LabelCell">
                Renglón al que se aplica:</td>
              <td class="DataCell" valign="top">
                <asp:DropDownList ID="ddlRenglon" runat="server" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Descripción del recurso:</td>
              <td class="DataCell" valign="top">
                ...
                <asp:Label ID="lblRecurso" runat="server" ForeColor="Navy" Visible="False" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Se acepta el recurso:</td>
              <td class="DataCell" valign="top">
            ...
            <tr>
              <td class="LabelCell">
                Motivo de aceptación o rechazo:</td>
              <td class="DataCell" valign="top">
