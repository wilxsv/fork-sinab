<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="true" CodeFile="FrmReporteExistenciaTemporalProducto.aspx.vb"
    Inherits="FrmReporteExistenciaTemporalProducto" %>
        ...
        <tr>
            <td class="LinkMenuRuta">
                &nbsp;<asp:LinkButton ID="lnkMenu" runat="server" Text="Menu" />&nbsp;<asp:Label
                    ID="lblRuta" runat="server" Text="Almacenes -> Reportes -> Existencia temporal por producto" />
