<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="True"
  AutoEventWireup="false" CodeFile="FrmAutorizarSolicitudes.aspx.vb" Inherits="FrmAutorizarSolicitudes" %>
  ...
  <table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta">
        ...
        UACI/Establecimientos -> Autorizar solicitudes de compra</td>
    </tr>
    <tr>
      <td>
        &nbsp;</td>
    ...
    <tr>
      <td>
       ...
       <asp:GridView ID="dgLista" runat="server" AllowPaging="True" AutoGenerateColumns="False"
          CellPadding="4" GridLines="None" Width="725px" DataKeyNames="IDSOLICITUD,idestado,tiposolicitud" CssClass="Grid" Font-Size="Smaller">
          ...
          <Columns>
            ...
            <asp:BoundField DataField="suministro" HeaderText="Suministro" Visible="False" >
            ...
            <asp:TemplateField>
              <ItemTemplate>
                <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Imagenes/application_go.png"
                  ToolTip="Enviar una Solicitud de Compra" OnClick="ImageButton5_Click" OnClientClick="return confirm('Esta seguro de autorizar y enviar la siguiente solicitud?');" />
              </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
              <ItemTemplate>
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Imagenes/cerrar.gif" OnClientClick="return confirm('Esta seguro de rechazar la Solicitud?');" OnClick="ImageButton1_Click1" />
              </ItemTemplate>
            </asp:TemplateField>
             </Columns>
    ...
    <tr>
      <td align="left">
        ...
        :: Autorizar y Enviar Solicitud de Compra a UACI<br />
