            ...
            <div class="CenteredTable">
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="Productos">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="DataCell">
                                    ...
                                    <asp:Button ID="btnBuscar" runat="server" Text="Buscar" Width="79px" ValidationGroup="Buscar" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <asp:GridView ID="gvLista" CssClass="Grid" runat="server" AutoGenerateColumns="False"
                        CellPadding="4" GridLines="None" Width="100%" DataKeyNames="IDLOTE,IDDETALLEMOVIMIENTO,IDPRODUCTO,CANTIDAD"
                        ShowFooter="true">
