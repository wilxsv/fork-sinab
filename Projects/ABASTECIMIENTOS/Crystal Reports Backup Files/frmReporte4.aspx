...
<table class="CenteredTable" style="width: 100%" cellpadding="0">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Certificación de Productos &gt; Reportes &gt; Aspectos Próximos a Vencer</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>Aspectos Próximos a Vencer</strong></td>
    </tr>
  <tr>
    <td colspan="2">
    </td>
          ...
          <tr>
            ...
            <td align="left">
              ...
              <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="TextBox2"
                ErrorMessage="* Format Inválido" Operator="DataTypeCheck" Type="Date" ValidationGroup="1" Display="Dynamic"></asp:CompareValidator></td>
          </tr>
            </table>
             </ContentTemplate>
