<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmCatCausas.aspx.vb" Inherits="frmCatCausas" title="Untitled Page" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Registro de Proveedores &gt; Catálogo de Causas</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>CATALOGO DE CAUSAS</strong></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
          BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="idcausa"
          ForeColor="Black" GridLines="Vertical">
          <Columns>
            <asp:BoundField DataField="idcausa" HeaderText="Identificador" />
