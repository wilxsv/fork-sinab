<%@ Page Language="VB" ValidateRequest="false" EnableEventValidation="true" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmAclaraciones.aspx.vb" Inherits="frmAclaraciones" %>
    ...
    <table class="CenteredTable" style="width: 100%">
        <tr>
            <td style="background-color: #b5c7de; text-align: left; height: 18px;">
                ...
                <asp:Label ID="LblRuta" runat="server" Text="UACI -> Adjudicación -> Aclaraciones" /></td>
        </tr>
        <tr>
