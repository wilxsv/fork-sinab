<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="FrmVerInformeMuestras.aspx.vb" Inherits="FrmVerInformeMuestras" %>
        ...
        <asp:Panel ID="pnMan" runat="server" Width="100%" Visible="False">
          <table class="CenteredTable" style="width: 100%;">
            ...
            <tr style="font-size: x-small; font-weight: bold;">
              ...
              <td class="DataCell">
                <asp:Label ID="lblNPC" runat="server" /></td>
            </tr>
            <tr style="font-size: x-small; font-weight: bold;">
              <td class="LabelCell">
            ...
            <tr style="font-size: x-small; font-weight: bold;">
              ...
              <td class="DataCell">
                ...
                <asp:Label ID="Label4" runat="server" Visible="False" /></td>
            </tr>
            <tr>
              <td colspan="2">
              </td>
            ...
            <tr>
              <td colspan="2">
                Lotes con registro de notificación
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4"
                  ...
                  <Columns>
                    ...
                    <asp:HyperLinkField HeaderText="Informes" Target="_blank" DataNavigateUrlFormatString="~/Reportes/FrmRptVerInformeMuestras.aspx?idI={0}"
                      DataNavigateUrlFields="IDINFORME" Text="Ver informe" />
                  </Columns>
                  <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                  <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                  <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                  ...
                  <table class="CenteredTable" style="width: 100%">
                    <tr>
                      <td class="LabelCell">
                        No.Notificación:</td>
                      <td class="DataCell">
                        <asp:TextBox ID="TextBox1" runat="server" Width="57px" /></td>
                    </tr>
                    <tr>
                      <td class="LabelCell">
