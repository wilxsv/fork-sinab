        ...
        <td>
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="ibtnEditarCancelar" CssClass="opCancelar" runat="server" Text="Cancelar"
                            ToolTip="Abandonar sin guardar cambios" CausesValidation="False" />
                    </td>
                    <td>
                        <asp:LinkButton ID="ibtnConsultar" runat="server" CssClass="opConsultar" Text="Consultar"
                            ToolTip="Consultar registros" CausesValidation="False" />
                    </td>
                    <td>
