<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmCatModalidadCompra.aspx.vb" Inherits="frmCatModalidadCompra" title="Untitled Page" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Control de Garantías&gt; Catálogo de Modalidades de Compra</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>CATALOGO DE MODALIDADES DE COMPRA</strong></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
          BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="idmodalidadcompra"
          ForeColor="Black" GridLines="Vertical">
          <Columns>
            <asp:BoundField DataField="idmodalidadcompra" HeaderText="Correlativo" />
            ...
            <ContentTemplate>
              <div align="center">
                <asp:Label ID="lblCustomerDetail" runat="server" BackColor="Black" Font-Bold="True"
                  ForeColor="White" Text="Nuevo Tipo de Modalidad de Compra:" Width="100%"></asp:Label>
                &nbsp;&nbsp;<table>
                  <tr>
