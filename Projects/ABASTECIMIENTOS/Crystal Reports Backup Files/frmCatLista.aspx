<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmCatLista.aspx.vb" Inherits="frmCatLista" title="Untitled Page" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Certificación de Productos &gt; Catálogo de Listas</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>CATALOGO DE LISTAS</strong></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2" style="height: 167px">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
          BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="idlista,idsuministro"
    ...
    <tr>
      <td colspan="2">
        ...
        <ajaxtoolkit:modalpopupextender
          ...
          popupcontrolid="pnlPopup" targetcontrolid="btnShowPopup" DynamicServiceMethod="GetDynamicContent">
          </ajaxtoolkit:modalpopupextender>
