<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmReporte7.aspx.vb" Inherits="UACI_CERTIFICACION_frmReporte7" title="Untitled Page" %>
...
<table class="CenteredTable" style="width: 100%" cellpadding="0">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Certificación de Productos &gt; Reportes &gt; Reportes para comisión</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>Reporte para Comisión</strong></td>
    </tr>
  <tr>
    <td colspan="2">
    </td>
  ...
  <tr>
    <td colspan="2" style="border-right: black thin solid; border-top: black thin solid; border-left: black thin solid; border-bottom: black thin solid">
      ...
      <td align="left">
        ...
        <asp:Label ID="Label3" runat="server" Text="Razón Social:" Visible="False"></asp:Label>
        <asp:DropDownList ID="DropDownList3" runat="server" Visible="False">
        </asp:DropDownList><asp:Label ID="Label1" runat="server" Text="NIT:"></asp:Label><asp:TextBox
          ID="TextBox1" runat="server" MaxLength="14"></asp:TextBox>
    ...
    <td colspan="2">
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
        ...
        <Columns>
          ...
          <asp:TemplateField>
            <ItemTemplate>
              <asp:Button ID="Button2" runat="server" Font-Size="X-Small" Text="Reporte" OnClick="Button2_Click" />
            </ItemTemplate>
          </asp:TemplateField>
        </Columns>
