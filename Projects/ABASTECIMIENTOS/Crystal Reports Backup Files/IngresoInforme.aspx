<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="IngresoInforme.aspx.vb" MaintainScrollPositionOnPostback="True" Inherits="IngresoInforme" %>
  ...
  <table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta">
        ...
        <asp:Label ID="lblRuta" runat="server" Text="URMIM/LCC -> Ingreso de Informes de Inspección" /></td>
    </tr>
    <tr>
      <td>
      </td>
              ...
              <td colspan="2">
                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4"
                  ...
                  <Columns>
                    ...
                    <asp:ButtonField HeaderText="de" Text="Ver " CommandName="b" ButtonType="Image" ImageUrl="~/Imagenes/botones/btnImprimir.jpg">
        ...
        <asp:Panel ID="Panel1" runat="server" GroupingText="Detalle del informe" Visible="False"
          ...
          <table class="CenteredTable" style="width: 100%">
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:Label ID="Label7" runat="server" Font-Bold="False" Font-Size="Small" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Nombre Comercial:</td>
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="TextBox3" runat="server" Width="431px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Suministrante:</td>
              <td class="DataCell">
                <asp:Label ID="Label6" runat="server" Font-Bold="False" Font-Size="Small" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                No.Lote:</td>
            ...
            <tr>
              ...
              <td class="DataCell">
                ...
                <asp:DropDownList ID="DropDownList2" runat="server">
                  ...
                  <asp:CheckBox ID="chbSinFabricacion" runat="server" Text="S/F" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
              ...
              <td class="DataCell">
                <asp:DropDownList ID="DropDownList3" runat="server">
                  ...
                  <asp:CheckBox ID="chbSinVencimiento" runat="server" Text="S/V" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                No. de unidades:</td>
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="TextBox5" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Guía aérea:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox6" runat="server" Width="99px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Comprobante de Crédito Fiscal No:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox7" runat="server" Width="99px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Pago de análisis:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox8" runat="server" Width="99px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                  Nombre Genérico Según Inspeccion del Medicamento, Insumo Médico o Producto Biológico</td>
              <td class="DataCell">
                  <asp:TextBox ID="TxtNombreInspeccion" runat="server" Width="496px"></asp:TextBox></td>
            </tr>
            <tr>
              <td class="LabelCell">
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="TextBox10" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
              </td>
            ...
            <tr>
              <td colspan="2">
                <asp:Panel ID="Panel7" runat="server" GroupingText="Condiciones de almacenamiento"
                  HorizontalAlign="Center" Width="455px">
                  <table class="CenteredTable" style="width: 100%">
                    <tr>
                      <td>
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="TextBox11" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Condiciones de almacenamiento encontradas en el lugar de inspección:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox12" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Descripción del producto:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox13" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Observaciones:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox14" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Criterio:
              ...
              <td class="DataCell">
                ...
                </asp:RadioButtonList><asp:Label ID="lbltipoinforme" runat="server" Visible="False" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
              </td>
            ...
            <tr>
              <td align="center" colspan="2">
                &nbsp;<asp:Button ID="Button1" runat="server" Text="Guardar informe" />
