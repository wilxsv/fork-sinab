<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmConsumoRegionDigitacion.aspx.vb" Inherits="GERENCIA_frmConsumoRegionDigitacion" title="" %>
...
<table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta">
        <asp:HyperLink runat="server" id="lnkSalir">Gerencia</asp:HyperLink>  -> Estado de Digitación por Región (Consumos y Existencias)</td>
    </tr>
    <tr>
      <td>
