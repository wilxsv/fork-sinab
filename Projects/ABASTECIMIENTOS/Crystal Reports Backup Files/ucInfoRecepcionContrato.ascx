<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucInfoRecepcionContrato.ascx.vb" Inherits="Controles_ucInfoRecepcionContrato" %>
...
<table width="100%" cellspacing="2" cellpadding="2" style="background-color: #f5f5f5; " >
  ...
  <tr>  
    <td style="text-align:right; " width="50%">
      No. de Contrato u Orden de Compra:
    </td>
    <td style="text-align:left; " width="50%">
  ...
  <tr>  
    ...
    <td style="text-align:left; " width="50%"><asp:Label ID="lblNoRecibo" runat="server" Font-Bold="True" Font-Size="Small" /><asp:Label
              ID="Label1" runat="server" Font-Bold="True" /></td>
  </tr>
  <tr>  
    <td style="text-align:right; " width="50%">
      Fecha de Recepción:
