<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmReporte6.aspx.vb" Inherits="UACI_CERTIFICACION_frmReporte6" title="Untitled Page" %>
...
<table class="CenteredTable" style="width: 100%" cellpadding="0">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Certificación de Productos &gt; Reportes &gt; Constancia para Participar en
        Gestión de Compra</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>Constancia para Participar en Gestión de Compra</strong></td>
    </tr>
  <tr>
    <td colspan="2">
    </td>
