  ...
  <table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta" colspan="3">
        ...
        Programación de entregas a la fecha por documento</td>
    </tr>
    <tr>
      <td colspan="3">
    ...
    <tr>
      ...
      <td style="text-align: left; height: 46px;">
        <asp:RadioButtonList ID="rblEntregas" runat="server" BorderStyle="Solid" BorderWidth="1px"
    ...
    <tr>
      <td colspan="3">
        Si no se selecciona ningún filtro se presentan todos los documentos.</td>
    </tr>
    <tr>
      <td colspan="3">
    ...
    <tr>
      <td colspan="3">
        <asp:Label ID="lblDetalle" runat="server" Font-Bold="True" Font-Size="Medium" /></td>
    </tr>
    <tr>
      <td colspan="3">
      </td>
    ...
    <tr>
      <td colspan="3">
        <asp:Label ID="lblProgramadas" runat="server" Font-Bold="True" Font-Size="Medium" /></td>
    </tr>
    <tr>
      <td colspan="3">
      </td>
