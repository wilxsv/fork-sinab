<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="True"
  AutoEventWireup="false" CodeFile="frmConsolidarProgramaCompras.aspx.vb" Inherits="frmConsolidarProgramaCompras" %>
  ...
  <table width="100%">
    <tr>
      <td colspan="2" style="text-align: left; width: 100%; background-color: #b5c7de">
        &nbsp;<asp:Label ID="LblRuta" runat="server" Font-Bold="True" Text="UTMIM -> Consolidar programas de compras" /></td>
    </tr>
    <tr>
      <td colspan="2" style="width: 100%; text-align: left">
        <asp:ImageButton ID="ImgbSalir" runat="server" ImageUrl="~/Imagenes/botones/Salir.JPG"
          ToolTip="Salir de la pantalla actual y regresa al menú principal." /></td>
    </tr>
    <tr>
  ...
  <asp:Panel ID="PnlConsolidado" Visible="false" runat="server" Width="100%">
    <asp:DataGrid ID="dgConsolidado" runat="server" Width="100%" AutoGenerateColumns="False"
      ...
      <Columns>
        ...
        <asp:BoundColumn DataField="CORRPRODUCTO" HeaderText="C&#243;digo"></asp:BoundColumn>
        <asp:BoundColumn DataField="DESCLARGO" HeaderText="Nombre"></asp:BoundColumn>
        <asp:BoundColumn DataField="DESCRIPCION" HeaderText="U/M"></asp:BoundColumn>
