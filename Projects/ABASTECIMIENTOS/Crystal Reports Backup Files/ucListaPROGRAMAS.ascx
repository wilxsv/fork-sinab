<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaPROGRAMAS.ascx.vb"
  Inherits="ucListaPROGRAMAS" %>
<%@ Register TagPrefix="nds" Namespace="Cooperator.Framework.Web.Controls" Assembly="Cooperator.Framework.Web" %>
<asp:GridView ID="gvLista" AutoGenerateColumns="False" runat="server" AllowPaging="True"
  CellPadding="4" GridLines="None" DataKeyNames="IDPROGRAMA" Width="100%">
  ...
  <Columns>
    <asp:HyperLinkField HeaderText="Editar / Consultar" Target="_self" DataNavigateUrlFormatString="~/Catalogos/wfDetaMantPROGRAMAS.aspx?id={0}"
      DataNavigateUrlFields="IDPROGRAMA" Text="Seleccionar" />
    <asp:BoundField DataField="CODIGO" HeaderText="C&#243;digo" ItemStyle-HorizontalAlign="Left" />
    <asp:BoundField DataField="NOMBRE" HeaderText="Programa" ItemStyle-HorizontalAlign="Left" />
