  ...
  <table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta">
        ...
        Laboratorio CC -> Certificación de Informes</td>
    </tr>
    <tr>
      <td>
      </td>
          ...
          <asp:Panel ID="Panel2" runat="server" CssClass="ScrollPanel" Height="250px" Width="100%">
            <asp:GridView ID="gvEncabezado" runat="server" AutoGenerateColumns="False" CellPadding="4"
              ...
              <Columns>
                ...
                <asp:ButtonField CommandName="d" Text="Ver informe" />
                ...
                <asp:ButtonField CommandName="e" Text="Ver certificado" />
              </Columns>
          ...
          <table class="CenteredTable" style="width: 100%">
            ...
            <tr>
              <td class="LabelCell">
                Guía aérea:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox6" runat="server" Width="99px" /><asp:Label ID="lbl12" runat="server"
                  Font-Bold="True" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
              ...
              <td class="DataCell">
                <asp:TextBox ID="TextBox7" runat="server" Width="99px" /><asp:Label ID="lbl13" runat="server"
                  Font-Bold="True" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                Pago de análisis:</td>
              <td class="DataCell">
                <asp:TextBox ID="TextBox8" runat="server" Width="99px" /><asp:Label ID="lbl14" runat="server"
                  Font-Bold="True" /></td>
            </tr>
            <tr>
              <td colspan="2">
            ...
            <tr>
              <td colspan="2">
                <asp:Panel ID="Panel10" runat="server" GroupingText="Certificación de Informes" Width="100%">
                  <table class="CenteredTable" style="width: 100%">
                    <tr>
                      <td class="LabelCell">
                        Criterio:</td>
                    ...
                    <tr>
                      <td class="LabelCell">
                        Observaciones:</td>
                      <td class="DataCell">
                        <asp:TextBox ID="TextBox15" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" /></td>
                    </tr>
                    <tr>
                      <td class="LabelCell">
                        Fecha de certificación:</td>
                      <td class="DataCell">
