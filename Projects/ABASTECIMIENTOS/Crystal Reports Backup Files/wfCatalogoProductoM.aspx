      ...
      <td colspan="2">
        <asp:Panel ID="Panel1" runat="server" CssClass="ScrollPanel" Height="300px">
          <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <asp:ImageButton ID="ImgBtnRpt" runat="server" Height="40px" ImageUrl="~/Imagenes/imprimir.png"
                Width="48px" /></asp:Panel>
      </td>
    </tr>
    <tr>
      <td colspan="2">
        ...
        <asp:Panel ID="plDatos" runat="server" Width="100%">
          <table class="CenteredTable" style="width: 100%;">
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="txtCONCENTRACION" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" />
              </td>
            </tr>
            <tr>
              <td class="LabelCell">
            ...
            <tr>
              ...
              <td class="DataCell">
                <asp:TextBox ID="txtPRESENTACION" runat="server" CssClass="TextBoxMultiLine" TextMode="MultiLine" />
              </td>
            </tr>
            <tr>
              <td class="LabelCell">
