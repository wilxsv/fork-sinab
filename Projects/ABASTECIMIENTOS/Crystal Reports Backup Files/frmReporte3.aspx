<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmReporte3.aspx.vb" Inherits="UACI_CERTIFICACION_frmReporte3" title="Untitled Page" %>
...
<table class="CenteredTable" style="width: 100%" cellpadding="0">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Certificación de Productos &gt; Reportes &gt; Constancia de Productos No Certificados</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>Constancia de Productos No Certificados</strong></td>
    </tr>
  <tr>
    <td colspan="2">
    </td>
          ...
          <tr>
            ...
            <td align="left">
              <asp:RadioButtonList ID="RadioButtonList3" runat="server" RepeatDirection="Horizontal" Visible="False">
                ...
                <asp:ListItem Value="2" Selected="True">No Certificado</asp:ListItem>
