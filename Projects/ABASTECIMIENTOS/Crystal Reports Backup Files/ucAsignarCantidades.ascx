...
<table class="CenteredTable" style="width: 100%">
  <tr>
    <td class="TituloCell" colspan="2">
      <asp:Label ID="Label8" runat="server" Text="Oferta del proveedor" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2">
      ...
      <asp:ImageButton ID="btnEliminar" runat="server" CausesValidation="False" ImageUrl="~/Imagenes/botones/delete.jpg"
        Enabled="False" Visible="False" />
      <asp:ImageButton ID="btnCancelar" runat="server" CausesValidation="False" ImageUrl="~/Imagenes/botones/cancel.jpg" /></td>
  </tr>
</table>
