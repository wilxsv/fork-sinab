...
Partial Class wfDetaMantSUBGRUPOS
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantSUBGRUPOS.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetalleSUBGRUPOS1.Enabled = bPermiteEditar

            Dim lId As Int32 = Request.QueryString("id")
            Me.ucVistaDetalleSUBGRUPOS1.IDSUBGRUPO = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleSUBGRUPOS1.Actualizar()
    ...
    Private Sub ucVistaDetalleSUBGRUPOS1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetalleSUBGRUPOS1.ErrorEvent
