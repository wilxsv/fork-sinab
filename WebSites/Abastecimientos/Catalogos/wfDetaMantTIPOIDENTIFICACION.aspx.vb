...
Partial Class wfDetaMantTIPOIDENTIFICACION
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantTIPOIDENTIFICACION.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetalleTIPOIDENTIFICACION1.Enabled = bPermiteEditar

            Dim lId As Int16 = Request.QueryString("id")
            Me.ucVistaDetalleTIPOIDENTIFICACION1.IDTIPOIDENTIFICACION = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleTIPOIDENTIFICACION1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub ucVistaDetalleTIPOIDENTIFICACION1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetalleTIPOIDENTIFICACION1.ErrorEvent
