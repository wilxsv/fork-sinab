...
Partial Class wfDetaMantUNIDADMEDIDAS
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantUNIDADMEDIDAS.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetalleUNIDADMEDIDAS1.Enabled = bPermiteEditar

            Dim lId As String = Request.QueryString("id")
            Me.ucVistaDetalleUNIDADMEDIDAS1.IDUNIDADMEDIDA = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleUNIDADMEDIDAS1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub ucVistaDetalleUNIDADMEDIDAS1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetalleUNIDADMEDIDAS1.ErrorEvent
