...
Partial Class wfDetaMantESPECIFICOSGASTO
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantESPECIFICOSGASTO.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.UcVistaDetalleESPECIFICOSGASTO1.Enabled = bPermiteEditar

            Dim lId As Int16 = Request.QueryString("id")
            Me.UcVistaDetalleESPECIFICOSGASTO1.IDESPECIFICOGASTO = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.UcVistaDetalleESPECIFICOSGASTO1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub UcVistaDetalleESPECIFICOSGASTO1_ErrorEvent(ByVal errorMessage As String) Handles UcVistaDetalleESPECIFICOSGASTO1.ErrorEvent
