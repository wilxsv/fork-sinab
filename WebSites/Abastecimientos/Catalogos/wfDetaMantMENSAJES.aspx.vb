...
Partial Class wfDetaMantMENSAJES
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantMENSAJES.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetalleMENSAJES1.Enabled = bPermiteEditar

            Dim lId As Int32 = Request.QueryString("id")
            Me.ucVistaDetalleMENSAJES1.IDMENSAJE = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleMENSAJES1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub ucVistaDetalleMENSAJES1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetalleMENSAJES1.ErrorEvent
