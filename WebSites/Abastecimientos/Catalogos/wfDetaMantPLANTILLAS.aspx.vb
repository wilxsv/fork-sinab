...
Partial Class wfDetaMantPLANTILLAS
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantPLANTILLAS.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetallePLANTILLAS1.Enabled = bPermiteEditar

            Dim lId As Int16 = Request.QueryString("id")
            Me.ucVistaDetallePLANTILLAS1.IDPLANTILLA = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetallePLANTILLAS1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub ucVistaDetallePLANTILLAS1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetallePLANTILLAS1.ErrorEvent
