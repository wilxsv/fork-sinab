...
Partial Class ucListaGRUPOSFUENTEFINANCIAMIENTO
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDGRUPO As Integer = Me.gvLista.DataKeys(e.RowIndex).Values(0)

        If Me.mComponente.EliminarGRUPOSFUENTEFINANCIAMIENTO(IDGRUPO) <> 1 Then
