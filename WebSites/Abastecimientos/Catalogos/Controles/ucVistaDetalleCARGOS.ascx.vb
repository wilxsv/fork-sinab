...
Partial Class ucVistaDetalleCARGOS
...
#Region " Propiedades "
    ...
    Public Property IDCARGO() As Int32
        ...
        Set(ByVal value As Int32)
            Me._IDCARGO = value
            If Me._IDCARGO > 0 Then
                Me.CargarDatos()
            Else
                Me.Nuevo()
            End If
            If Not Me.ViewState("IDCARGO") Is Nothing Then Me.ViewState.Remove("IDCARGO")
            Me.ViewState.Add("IDCARGO", value)
        End Set
    End Property
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Not Me.ViewState("IDCARGO") Is Nothing Then Me._IDCARGO = Me.ViewState("IDCARGO")
    ...
    Private Sub CargarDatos()
        ...
        If mComponente.ObtenerCARGOS(mEntidad) <> 1 Then
    ...
    Public Function Actualizar() As String
        ...
        If mComponente.ActualizarCARGOS(mEntidad) = 1 Then
            Return ""
        Else
