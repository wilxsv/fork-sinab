...
Partial Class ucListaDEPENDENCIAS
    ...
    Public Function CargarDatos() As Integer
        ...
        ds = Me.mComponente.ObtenerdsDependencia()
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDDEPENDENCIA As Integer = Me.gvLista.DataKeys(e.RowIndex).Values(0)

        Dim result As Integer = Me.mComponente.EliminarDependenciasSQLException(IDDEPENDENCIA)
