...
Partial Class ucListaUNIDADMEDIDAS
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDUNIDADMEDIDA As Integer = Me.gvLista.DataKeys(e.RowIndex).Values(0)

        If Me.mComponente.EliminarUNIDADMEDIDAS(IDUNIDADMEDIDA) <> 1 Then
