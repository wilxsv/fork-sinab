...
Partial Class ucListaPLANTILLAS
    ...
    Public Function CargarDatos() As Integer
        ...
        ds = Me.mComponente.ObtenerDataSetPorId()
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDPLANTILLA As Integer = Me.gvLista.DataKeys(e.RowIndex).Values(0)

        If Me.mComponente.EliminarPLANTILLAS(IDPLANTILLA) <> 1 Then
