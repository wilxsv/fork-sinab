...
Partial Class ucListaFUENTEFINANCIAMIENTOS
    ...
    Public Function CargarDatos() As Integer
        ...
        Me.gvLista.DataSource = Me.mComponente.RecuperarPorGrupo()
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDFUENTEFINANCIAMIENTO As Integer = Me.gvLista.Rows(e.RowIndex).Cells(1).Text

        If Me.mComponente.EliminarFUENTEFINANCIAMIENTOS(IDFUENTEFINANCIAMIENTO) <> 1 Then
