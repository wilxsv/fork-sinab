...
Partial Class ucVistaDetalleDEPENDENCIAS
    ...
    Private mComponente As New cDEPENDENCIAS
    Private mEntidad As DEPENDENCIAS
...
#End Region
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New DEPENDENCIAS

        mEntidad.IDDEPENDENCIA = IDDEPENDENCIA

        If mComponente.ObtenerDEPENDENCIAS(mEntidad) <> 1 Then
    ...
    Public Function Actualizar() As String
        ...
        If Me.mComponente.ValidarNombre(Me.txtNOMBRE.Text, Me.IDDEPENDENCIA) = 1 Then
        ...
        If Me._nuevo Then
            mEntidad.IDDEPENDENCIA = 0
            mEntidad.AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
            mEntidad.AUFECHACREACION = Now()
        Else
            mEntidad.IDDEPENDENCIA = Me.IDDEPENDENCIA
        ...
        If mComponente.ActualizarDEPENDENCIAS(mEntidad) = 1 Then
            Return ""
        Else
