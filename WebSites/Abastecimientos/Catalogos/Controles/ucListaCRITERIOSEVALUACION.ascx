<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaCRITERIOSEVALUACION.ascx.vb"
    Inherits="ucListaCRITERIOSEVALUACION" %>
...
<asp:GridView ID="gvLista" CssClass="Grid" AutoGenerateColumns="False" runat="server"
    ...
    <Columns>
        <asp:HyperLinkField HeaderText="Editar / Consultar" Target="_self" DataNavigateUrlFormatString="~/Catalogos/wfDetaMantCRITERIOSEVALUACION.aspx?id={0}"
            DataNavigateUrlFields="IDCRITERIOEVALUACION" Text="Seleccionar" />
        <asp:BoundField DataField="TIPOCRITERIO" HeaderText="Tipo Criterio" HeaderStyle-HorizontalAlign="Left"
            ItemStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="DESCRIPCION" HeaderText="Descripci&#243;n" HeaderStyle-HorizontalAlign="Left"
            ItemStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="PORCENTAJE" HeaderText="Porcentaje" HeaderStyle-HorizontalAlign="Right"
