...
Partial Class ucVistaDetallePROGRAMAS
...
#End Region
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New PROGRAMAS

        mEntidad.IDPROGRAMA = IDPROGRAMA

        If mComponente.ObtenerPROGRAMAS(mEntidad) <> 1 Then
    ...
    Public Function Actualizar() As String
        ...
        If mComponente.Buscarcodigo(Me.txtCODIGO.Text, Me.IDPROGRAMA) = 0 Then
        ...
        Else
            mEntidad.IDPROGRAMA = Me.IDPROGRAMA
        ...
        If mComponente.ActualizarPROGRAMAS(mEntidad) = 1 Then
            Return ""
        Else
