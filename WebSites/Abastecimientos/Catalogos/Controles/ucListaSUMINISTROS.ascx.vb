...
Partial Class ucListaSUMINISTROS
    ...
    Public Function CargarDatos() As Integer
        ...
        ds = Me.mComponente.RecuperarOrdenada
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDSUMINISTRO As Integer = Me.gvLista.Rows(e.RowIndex).Cells(1).Text

        If Me.mComponente.EliminarSUMINISTROS(IDSUMINISTRO) <> 1 Then
