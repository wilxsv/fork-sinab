...
Partial Class ucListaTIPODOCUMENTOBASE
    ...
    Public Function CargarDatos() As Integer
        ...
        Dim lTIPODOCUMENTOBASE As listaTIPODOCUMENTOBASE

        lTIPODOCUMENTOBASE = Me.mComponente.ObtenerLista()

        Me.gvLista.DataSource = lTIPODOCUMENTOBASE
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim XIDTIPODOCUMENTOBASE As Integer = Me.gvLista.Rows(e.RowIndex).Cells(1).Text

        If Me.mComponente.EliminarTIPODOCUMENTOBASE(XIDTIPODOCUMENTOBASE) <> 1 Then
