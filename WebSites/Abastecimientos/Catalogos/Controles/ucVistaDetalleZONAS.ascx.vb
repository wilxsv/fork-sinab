...
Partial Class ucVistaDetalleZONAS
...
#Region " Propiedades "
    ...
    Public Property IDZONA() As Int32
        ...
        Set(ByVal value As Int32)
            Me._IDZONA = value
            If Me._IDZONA > 0 Then
                Me.CargarDatos()
            Else
                Me.Nuevo()
            End If
            If Not Me.ViewState("IDZONA") Is Nothing Then Me.ViewState.Remove("IDZONA")
            Me.ViewState.Add("IDZONA", value)
        End Set
    End Property
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Not Me.ViewState("IDZONA") Is Nothing Then Me._IDZONA = Me.ViewState("IDZONA")
