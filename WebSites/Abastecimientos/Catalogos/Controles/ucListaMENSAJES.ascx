<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucListaMENSAJES.ascx.vb"
  Inherits="ucListaMENSAJES" %>
...
<asp:GridView ID="gvLista" CssClass="Grid" AutoGenerateColumns="False" runat="server"
  AllowPaging="True" CellPadding="4" GridLines="None" DataKeyNames="IDMENSAJE">
  ...
  <Columns>
    <asp:HyperLinkField HeaderText="Editar / Consultar" Target="_self" DataNavigateUrlFormatString="~/Catalogos/wfDetaMantMENSAJES.aspx?id={0}"
      DataNavigateUrlFields="IDMENSAJE" Text="Seleccionar" />
