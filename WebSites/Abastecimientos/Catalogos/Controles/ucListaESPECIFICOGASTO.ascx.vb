...
Partial Class ucListaESPECIFICOGASTO
    ...
    Public Function CargarDatos() As Integer
        ...
        ds = Me.mComponente.RecuperarEspecificos()
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        Dim IDESPECIFICOGASTO As Integer = Me.gvLista.DataKeys(e.RowIndex).Values(0)

        If Me.mComponente.EliminarESPECIFICOGASTO(IDESPECIFICOGASTO) <> 1 Then
