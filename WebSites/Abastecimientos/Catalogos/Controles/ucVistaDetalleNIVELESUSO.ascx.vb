...
Partial Class ucVistaDetalleNIVELESUSO
    ...
    Private mEntidad As NIVELESUSO
...
#End Region
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New NIVELESUSO

        mEntidad.IDNIVELUSO = IDNIVELUSO

        If mComponente.ObtenerNIVELESUSO(mEntidad) <> 1 Then
    ...
    Public Function Actualizar() As String
        ...
        If mComponente.BuscarNOMBRE(Me.txtNOMBRECORTO.Text, Me.IDNIVELUSO) = 0 Then
        ...
        If Me._nuevo Then
            mEntidad.IDNIVELUSO = 0
            mEntidad.AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
            mEntidad.AUFECHACREACION = Now()
        Else
            mEntidad.IDNIVELUSO = Me.IDNIVELUSO
        ...
        If mComponente.ActualizarNIVELESUSO(mEntidad) = 1 Then
            Return ""
        Else
