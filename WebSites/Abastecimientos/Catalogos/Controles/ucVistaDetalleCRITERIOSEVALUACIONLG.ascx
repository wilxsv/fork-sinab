<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucVistaDetalleCRITERIOSEVALUACIONLG.ascx.vb"
  Inherits="ucVistaDetalleCRITERIOSEVALUACIONLG" %>
...
<table class="CenteredTable" style="width: 100%;">
  <tr>
    ...
    <td class="DataCell">
      <cc1:ddlTIPOCRITERIO ID="ddlTIPOCRITERIO1" runat="server" AutoPostBack="true" Width="208px"
        Enabled="False" /></td>
  </tr>
  <tr>
    <td class="LabelCell">
