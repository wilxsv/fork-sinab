...
Partial Class ucVistaDetalleTIPOINFORMES
    ...
    Private mEntidad As TIPOINFORMES
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Not Me.ViewState("IDTIPOINFORME") Is Nothing Then Me.IDTIPOINFORME = Me.ViewState("IDTIPOINFORME")
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New TIPOINFORMES

        mEntidad.IDTIPOINFORME = IDTIPOINFORME

        If mComponente.ObtenerTIPOINFORMES(mEntidad) <> 1 Then
    ...
    Public Function Actualizar() As String
        ...
        If Me._nuevo Then
            mEntidad.IDTIPOINFORME = 0
            mEntidad.AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
            mEntidad.AUFECHACREACION = Now()
        Else
            mEntidad.IDTIPOINFORME = Me.IDTIPOINFORME
        ...
        If mComponente.ActualizarTIPOINFORMES(mEntidad) = 1 Then
            Return ""
        Else
