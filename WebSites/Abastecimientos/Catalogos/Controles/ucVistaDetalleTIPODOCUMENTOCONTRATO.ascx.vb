...
Partial Class ucVistaDetalleTIPODOCUMENTOCONTRATO
    Inherits System.Web.UI.UserControl

    Private _IDTIPODOCUMENTOCONTRATO As Int16
    ...
    Private mEntidad As TIPODOCUMENTOCONTRATO
...
#Region " Propiedades "
    ...
    Public Property IDTIPODOCUMENTOCONTRATO() As Int16
        Get
            Return _IDTIPODOCUMENTOCONTRATO
        End Get
        Set(ByVal value As Int16)
            Me._IDTIPODOCUMENTOCONTRATO = value
            If Me._IDTIPODOCUMENTOCONTRATO > 0 Then
                Me.CargarDatos()
            Else
                Me.Nuevo()
            End If
            If Not Me.ViewState("IDTIPODOCUMENTOCONTRATO") Is Nothing Then Me.ViewState.Remove("IDTIPODOCUMENTOCONTRATO")
            Me.ViewState.Add("IDTIPODOCUMENTOCONTRATO", value)
        End Set
    End Property
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If Not Me.ViewState("IDTIPODOCUMENTOCONTRATO") Is Nothing Then Me._IDTIPODOCUMENTOCONTRATO = Me.ViewState("IDTIPODOCUMENTOCONTRATO")
    ...
    Private Sub CargarDatos()
        ...
        mEntidad = New TIPODOCUMENTOCONTRATO

        mEntidad.IDTIPODOCUMENTO = IDTIPODOCUMENTOCONTRATO

        If mComponente.ObtenerTIPODOCUMENTOCONTRATO(mEntidad) <> 1 Then
            RaiseEvent ErrorEvent("Error al obtener el registro.")
            Return
        End If

        Me.txtDESCRIPCION.Text = mEntidad.DESCRIPCION
        Me.cbAPLICASOLOALMACEN.Checked = IIf(mEntidad.APLICASOLOALMACEN = 1, True, False)
    ...
    Private Sub HabilitarEdicion(ByVal edicion As Boolean)
        ...
        Me.cbAPLICASOLOALMACEN.Enabled = edicion
    End Sub
    ...
    Public Function Actualizar() As String
        ...
        If Me._nuevo Then
            mEntidad.IDTIPODOCUMENTO = 0
            mEntidad.AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
            mEntidad.AUFECHACREACION = Now()
        Else
            mEntidad.IDTIPODOCUMENTO = Me.IDTIPODOCUMENTOCONTRATO
        ...
        mEntidad.APLICASOLOALMACEN = IIf(Me.cbAPLICASOLOALMACEN.Checked, 1, 0)
        mEntidad.ESTASINCRONIZADA = 0

        If mComponente.ActualizarTIPODOCUMENTOCONTRATO(mEntidad) = 1 Then
            Return ""
        Else
