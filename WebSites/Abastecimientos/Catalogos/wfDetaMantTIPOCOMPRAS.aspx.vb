...
Partial Class wfDetaMantTIPOCOMPRAS
    Inherits System.Web.UI.Page

    Private URLwfMant As String = "~/Catalogos/wfMantTIPOCOMPRAS.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Me.ucVistaDetalleTIPOCOMPRAS1.Enabled = bPermiteEditar

            Dim lId As Int32 = Request.QueryString("id")
            Me.ucVistaDetalleTIPOCOMPRAS1.IDTIPOCOMPRA = lId
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        sError = Me.ucVistaDetalleTIPOCOMPRAS1.Actualizar()
        If sError <> "" Then
    ...
    Private Sub ucVistaDetalleTIPOCOMPRAS1_ErrorEvent(ByVal errorMessage As String) Handles ucVistaDetalleTIPOCOMPRAS1.ErrorEvent
