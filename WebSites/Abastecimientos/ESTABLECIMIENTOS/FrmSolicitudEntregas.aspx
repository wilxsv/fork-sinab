<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="True"
  AutoEventWireup="false" CodeFile="FrmSolicitudEntregas.aspx.vb" Inherits="FrmSolicitudEntregas" %>
    ...
    <tr>
      <td class="LinkMenuRuta">
        &nbsp;<asp:LinkButton ID="lnkMenu" runat="server" CausesValidation="False" Text="Menú" />&nbsp;&nbsp;<asp:Label
          ID="lblRuta" runat="server" Text="Establecimientos -> Modificacion entregas solicitudes" /></td>
    </tr>
    <tr>
      <td valign="top">
        &nbsp;</td>
        ...
        <asp:DataGrid ID="dgLista" runat="server" AutoGenerateColumns="False" CellPadding="4"
          ...
          <Columns>
            <asp:TemplateColumn HeaderText="Editar">
              <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.IDSOLICITUD", "frmEntregaSolicitud.aspx?id={0}") + DataBinder.Eval(Container, "DataItem.IDESTADO", "&estado={0}") + DataBinder.Eval(Container, "DataItem.COMPRACONJUNTA", "&conjunta={0}") + DataBinder.Eval(Container, "DataItem.IDCLASESUMINISTRO", "&suministro={0}") + DataBinder.Eval(Container, "DataItem.IDDEPENDENCIASOLICITANTE", "&dependencia={0}") %>'
                  Text="Modificar entregas" Font-Size="Smaller" />
