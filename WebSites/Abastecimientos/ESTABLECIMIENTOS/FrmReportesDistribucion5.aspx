<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="FrmReportesDistribucion5.aspx.vb" Inherits="FrmReportesDistribucion5" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
  <table class="CenteredTable" style="width: 100%;">
    ...
    <tr>
      <td>
        <asp:Panel ID="plListaReportes" runat="server" Font-Bold="True" GroupingText="Distribuciones - Detalle de vales asociados"
          Width="100%">
