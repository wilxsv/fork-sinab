<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="frmMantDistribucionDetalle2_old.aspx.vb" Inherits="ESTABLECIMIENTOS_frmMantDistribucionDetalle2_old" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" style="margin: 10px 0">
          ...
          <asp:GridView ID="gvLista" runat="server" CssClass="Grid" AutoGenerateColumns="False"
            ...
            BorderColor="Silver" BorderStyle="Solid" AllowPaging="True" PageSize="15">
            ...
            <Columns>
              ...
              <asp:BoundField DataField="EXISTENCIAF" HeaderText="Existencia Farmacia">
                <HeaderStyle HorizontalAlign="Right" />
                <ItemStyle HorizontalAlign="Right" Width="9%" />
              </asp:BoundField>
                <asp:BoundField DataField="existenciaA" HeaderText="Existencia Almacén" />
      ...
      <div style="text-align: right; margin:10px 0;">
        Cantidad a Distribuir: <asp:label runat="server" ID="lblCantDist" Font-Bold="true" Text = "" />
      </div>
    
      <div style="text-align: right; margin:10px 0;">
        Cantidad en Almacén: <asp:label runat="server" ID="lblCantAlm" Font-Bold="true" Text = "" />
      </div>
