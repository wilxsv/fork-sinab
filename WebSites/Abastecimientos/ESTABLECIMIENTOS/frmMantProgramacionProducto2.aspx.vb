...
Partial Class ESTABLECIMIENTOS_frmMantProgramacionProducto2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then 'al cargar por primera vez la página
            ...
            Dim cEnt As New cPROGRAMACIONPRODUCTO
            'verificar si hay datos en programacionproductoestablecimiento
            If cEnt.VerificarProgramacionProductoEstablecimiento(Request.QueryString("id")) = 0 Then
                ...
                'obtener establecimientos y barrerlos automaticamente
                Dim ds As New DataSet
                ds = cEnt.ObtenerEstablecimientosProgramacion(Request.QueryString("id"))

                For Each dr As DataRow In ds.Tables(0).Rows
                    'Creamos nuestro universo de datos para el establecimiento 
                    cEnt.agregarProgramacionProductoRegion(Request.QueryString("id"), dr(0), 3, HttpContext.Current.User.Identity.Name, eEntidadProg)
                Next
    ...
    Private Sub CargarDatos() 'carga los datos y los muestra en el gridview
        ...
        ds = mComponente.obtenerProgramacionProductosDetalle3(Me.IDPROGRAMACION, 0)
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            ''CANTIDADACOMPRARAJUSTADA
            valor = Me.gvLista.DataKeys(e.Row.RowIndex).Values(2)
    ...
    Protected Sub btnRpt4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRpt4.Click
        ...
        alerta = CType(("/Reportes/frmRptProgramacion2.aspx?idProceso=" & IDPROGRAMACION & "&idEstablecimiento=" & Session.Item("idEstablecimiento") & "&m=" & M), String)
    ...
    Private Sub generarReporte(ByVal tipo As Integer)
        ...
        alerta = CType(("/Reportes/frmRptProgramacion.aspx?idProceso=" & IDPROGRAMACION & "&idEstablecimiento=" & Session.Item("idEstablecimiento") & "&m=" & M & "&n=" & N & "&tipo=" & tipo), String)
    ...
    Protected Sub gvLista_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        alerta = CType(("/Reportes/frmRptProgramacionObservacion.aspx?idProceso=" & IDPROGRAMACION & "&idProducto=" & IDPRODUCTO & "&idEstablecimiento=" & Me.ViewState("IDESTABLECIMIENTO") & "&tipo=1"), String)
        SINAB_Utils.Utils.MostrarVentana(alerta)
    End Sub
    ...
    Protected Sub btnRpt6_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRpt6.Click
        ...
        alerta = "/Reportes/frmRptProgramacionObservacion.aspx?idProceso=" & IDPROGRAMACION & "&idProducto=" & IDPRODUCTO & "&idEstablecimiento=" & IDESTABLECIMIENTO & "&tipo=1"
        SINAB_Utils.Utils.MostrarVentana(alerta)
    End Sub

    Protected Sub btnFinalizar0_Click(sender As Object, e As EventArgs) Handles btnFinalizar0.Click
        Dim mdb As New cPROGRAMACIONPRODUCTO
        Dim eEntidad As New PROGRAMACIONPRODUCTO
