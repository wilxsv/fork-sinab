...
Partial Class ESTABLECIMIENTOS_frmMantDistribucionDetalle
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        If vals.Count >= 0 Then 'Hacemos el update de las cantidades
            ...
            If res = -1 Then
                ...
                Alert("Error al almacenar los registros.", "Error") ', Cooperator.Framework.Web.Controls.AlertOption.NoAction)
                Exit Sub

            ElseIf res = -2 Then

                Alert("La cantidad a distribuir no debe ser mayor a la cantidad en almacén.", "Error") ', Cooperator.Framework.Web.Controls.AlertOption.NoAction)
                Exit Sub
