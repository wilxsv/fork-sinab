...
<%@ Register Src="~/Controles/BuscarProductosLight.ascx" TagPrefix="uc1" TagName="BuscarProductosLight" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
          ...
          <asp:GridView ID="gvLista" runat="server" CssClass="Grid" AutoGenerateColumns="False"
            ...
            <Columns>
              <asp:TemplateField HeaderText="Lotes">
                <ItemTemplate>
                  <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" Text="Seleccionar"></asp:LinkButton>
                </ItemTemplate>
  ...
  <asp:Panel ID="PnlAgregarProducto" runat="server" Width="100%" Font-Bold="True" GroupingText="Adición de productos">
      <uc1:BuscarProductosLight runat="server" ID="buscador" />
    <%--<table width="100%">--%>
      <%--<tr>
     ...
     <%-- <tr>
      ...
      <%--<tr>
        ...
        <div style="margin-top:10px ">
          <asp:Button ID="BtnGuardar" runat="server" Text="Agregar" Width="80px"  ToolTip="Agrega el producto seleccionado al detalle de la requisición" />
          <asp:Button ID="BtnCancelar" runat="server" Text="Cancelar" Width="80px"  ToolTip="Cancela la adición del producto a la requisición" />
        </div>
      <%--</tr>
    </table>--%>
        </asp:Panel>
  ...
  <asp:Panel ID="PnlSeleccionLotes" Visible="false" runat="server" Width="100%" Font-Bold="True" GroupingText="Selección de Lotes">
    <table width="100%">
      <tr>
        ...
        <tr>  
        <td align="right">
         <asp:Button runat="server" ID="btnGL" Text = "Guardar" /> &nbsp;<asp:Button runat="server" ID="btnCL" Text = "Cancelar" />
        </td>  
