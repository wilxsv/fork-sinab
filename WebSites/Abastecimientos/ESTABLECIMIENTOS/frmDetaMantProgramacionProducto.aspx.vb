...
Partial Class ESTABLECIMIENTOS_frmDetaMantProgramacionProducto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then 'al cargar por primera vez la página
            ...
            If cEntidad.numeroRegistrosEstablecimiento(Request.QueryString("id"), Session.Item("idEstablecimiento")) = 0 Then
