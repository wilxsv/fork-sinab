<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="frmMantConsumo2.aspx.vb" Inherits="ESTABLECIMIENTOS_frmMantConsumo2"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
                            ...
                            <asp:TemplateField HeaderText="Consumo Real">
                                ...
                                <ItemTemplate>
                                     <ew:NumericBox ID="txtConsumo"  runat="server" Columns="9" TextAlign="Right" Font-Size="Small"
                                        DecimalPlaces="2" CssClass="txtConsumoClass"   MaxLength="7" PositiveNumber="true"  CausesValidation="true" TabIndex="1" ></ew:NumericBox>
    ...
    <script type="text/javascript">
        ...
        function validaTxt(object) {
            
            if (parseFloat($(object).val()) > parseFloat($(object).attr("data-valMax"))) {
                alert("El consumo no puede ser mayor a la existencia.");
                $(object).focus();
                $(object).css({ "border-color": "#a94442" });
            } else {
