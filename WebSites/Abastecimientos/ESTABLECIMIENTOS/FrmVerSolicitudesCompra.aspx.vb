...
Partial Class FrmVerSolicitudesCompra
    ...
    Private Sub CargarDatos(ByVal filtro1 As String, ByVal filtro2 As Integer, Optional ByVal iddependencia As Integer = 0)
        ...
        Me.dgLista.DataSource = x.ObtenerSolicitudesEstablecimientos(filtro1, filtro2, iddependencia)
        Try
            Me.dgLista.DataBind()
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        'Mostrar el reporte
        Dim alerta As String = CType(("/Reportes/FrmRptSolicitudCompra.aspx?id=" & Me.dgLista.DataKeys(row.RowIndex).Values(0)), String)
    ...
    Protected Sub ImageButton3_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        'Mostrar el reporte
        Dim alerta As String = CType(("/Reportes/FrmRptConsolidadoDistribucion0.aspx?id=" & Me.dgLista.DataKeys(row.RowIndex).Values(0)), String)
        SINAB_Utils.Utils.MostrarVentana(alerta)
    End Sub
