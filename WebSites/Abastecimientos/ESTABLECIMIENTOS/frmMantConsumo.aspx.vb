...
Partial Class ESTABLECIMIENTOS_frmMantConsumo
    ...
    Private Function actualizar() As String
        ...
        For Each row As GridViewRow In gvLista.Rows
            ...
            If Me.ViewState("FARMACIA") = 1 And Not (txtAd.Text = "" And txtAd2.Text = "") Then

                If (txtAd.Text = "" Or txtAd2.Text = "") Then
                    Return "Debe especificar tanto el consumo como la existencia"
                Else
    ...
    Private Sub CargarDatos() 'carga los datos y los muestra en el gridview
        ...
        If Me.ViewState("FARMACIA") = -1 Then
            ds = mComponente.obtenerConsumoTotalFecha(Session.Item("IdEstablecimiento"), fecha)
        Else
            ds = mComponente.obtenerExistenciaEstablecimientoFecha(Session.Item("IdEstablecimiento"), Me.cboAlmacen.SelectedItem.Value, fecha, IIf(Me.cboAlmacen.SelectedItem.Text.ToUpper.Contains("FARMACIA"), 0, 1)) ' IIf(Me.cboAlmacen.SelectedItem.Text.ToUpper.Contains("FARMACIA"), 0, 1))
        End If
    ...
    Protected Sub btnReporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReporte.Click
        Dim alerta As String = CType(("/Reportes/frmRptConsumo.aspx?mes=" & Me.cboMes.SelectedIndex & "&anio=" & Me.cboAnio.SelectedItem.Text & "&tipo=" & Me.ViewState("FARMACIA") & "&est=" & Me.cboAlmacen.SelectedItem.Value), String)
    ...
    Protected Sub btnCobertura_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCobertura.Click
        Dim alerta As String = CType(("/Reportes/frmRptConsumo.aspx?mes=" & Me.cboMes.SelectedIndex & "&anio=" & Me.cboAnio.SelectedItem.Text & "&tipo=" & Me.ViewState("FARMACIA") & "&est=" & Me.cboAlmacen.SelectedItem.Value & "&c=1"), String)
