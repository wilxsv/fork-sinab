<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="FrmReportesDistribucion2.aspx.vb" Inherits="FrmReportesDistribucion2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <tr>
      <td>
        <asp:Panel ID="plListaReportes" runat="server" Font-Bold="True" GroupingText="Distribuciones por establecimiento/productos"
          Width="100%">
