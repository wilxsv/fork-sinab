<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="frmMantConsumoConsulta.aspx.vb" Inherits="ESTABLECIMIENTOS_frmMantConsumoConsulta"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <%--<uc1:ucBarraNavegacion ID="ucBarraNavegacion1" runat="server" />--%>
     <div>
        Programa:
        <asp:DropDownList runat="server" ID="DropDownList3" Width="376px" 
    ...
    <div>
        ...
        <asp:DropDownList runat="server" ID="cboAlmacen" Width="376px" 
            AppendDataBoundItems="True" Visible="False" />
        <asp:Button runat="server" ID="btnConsA" Text="Seleccionar" Enabled="False" Width="80px" Visible="False" />
        <asp:Button runat="server" ID="btnCancA" Text="Cancelar" Enabled="false" Width="80px" Visible="False" />
    </div>
    <div>
        <br />
        Fecha:
        ...
        <asp:Button runat="server" ID="b1" Text="Consultar" />
        &nbsp;
        <asp:Button runat="server" ID="b2" Text="Cancelar" Enabled="false" Visible="False" />
        <br />
        <br />
        ...
        <asp:Panel ID="Panel12" runat="server" HorizontalAlign="Right">
            <asp:Label ID="Label83" runat="server" Font-Bold="True" Font-Size="Smaller" 
                Text="Cálculo de Existencias(Farmacia):" Visible="False"></asp:Label>
            <asp:Label ID="Label84" runat="server" Font-Size="Smaller" 
                Text="( Existencia Mes Anterior + Ingresos en Farmacia Mes actual +(-) Ajustes a Existencia ) - Consumo Real Mes Actual" 
                Visible="False"></asp:Label>
        </asp:Panel>
        <br />
    </div>
    ...
    <asp:Panel ID="Panel11" runat="server" Width="500px" Height="225px" Style="display: none"
        BackColor="white">
        <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div align="center">
                    ...
                    <asp:ListItem Value="Devolución por transferencias a farmacias externas">Devolución por transferencias a farmacias externas</asp:ListItem>
                    <asp:ListItem Value="Ajuste/Devolución por avería / deterioro">Ajuste/Devolución por avería / deterioro</asp:ListItem>
                    <asp:ListItem Value="Devolución por vencimiento">Devolución por vencimiento</asp:ListItem>
                    <asp:ListItem Value="Ingresos por devolución de medicamento">Ingresos por devolución de medicamento</asp:ListItem>
                    </asp:DropDownList>
