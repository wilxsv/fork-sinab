...
Partial Class ESTABLECIMIENTOS_frmMantConsumoConsulta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then 'al cargar por primera vez la página
            ...
            Me.DropDownList3.Items.Insert(0, "(Seleccione un programa)")
    ...
    Private Sub CargarDatos() 'carga los datos y los muestra en el gridview
        ...
        Else
            If Me.ViewState("FARMACIA") = 0 Then
                'almacen
                ds = mComponente.obtenerExistenciaEstablecimientoFecha2(Session.Item("IdEstablecimiento"), Me.cboAlmacen.SelectedItem.Value, fecha, IIf(Me.cboAlmacen.SelectedItem.Text.ToUpper.Contains("FARMACIA"), 0, 1), Session("IdEmpleado"))
            Else
                'farmacia
    ...
    Protected Sub b1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles b1.Click
        If Me.DropDownList3.SelectedValue = 0 Then
            Me.Label1.Text = " Seleccione un programa antes de realizar la consulta"
        ...
        alerta = CType(("/Reportes/frmRptConsumoConsulta.aspx?idprod=" & Me.DropDownList4.SelectedValue & " &mes=" & Me.cboMes.SelectedIndex & "&anio=" & Me.cboAnio.SelectedItem.Text & "&tipo=" & Me.ViewState("FARMACIA") & "&est=" & Me.cboAlmacen.SelectedItem.Value & "&idprog=" & Me.DropDownList3.SelectedValue.ToString), String)
    ...
    Protected Sub DropDownList3_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles DropDownList3.SelectedIndexChanged
        Dim ccc As New ABASTECIMIENTOS.NEGOCIO.cPRODUCTOSPROGRAMAS
        Me.DropDownList4.DataSource = ccc.ObtenerProductoxPrograma(Me.DropDownList3.SelectedValue)
        Me.DropDownList4.DataValueField = "IDPRODUCTO"
        Me.DropDownList4.DataTextField = "DESCLARGO"
