...
Partial Class FrmSolicitudEntregas
    ...
    Private Sub CargarDatos()
        ...
        textoBusqueda = "1" 'grabadas
        criterioBusqueda = "IDESTADO"
        operadorBusqueda = ">="

        lSOLICITUDES = Me.mComponente.FiltrarSolicitudesNoAsociadasProcesoCompra(textoBusqueda, criterioBusqueda, operadorBusqueda, Session.Item("IdEstablecimiento"))
    ...
    Protected Sub BttBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BttFiltrar.Click
        ...
        If Me.DdlCriterio.SelectedItem.Value = "CORRELATIVO" Then
            ...
            Me.dgLista.DataSource = mControl.FiltrarSolicitudesNoAsociadasProcesoCompra(textoBusqueda, criterioBusqueda, operadorBusqueda, Session.Item("IdEstablecimiento"))
        ...
        If Me.DdlCriterio.SelectedItem.Value = "FECHASOLICITUD" Then
            ...
            criterioBusqueda = Me.DdlCriterio.SelectedItem.Value
            Me.dgLista.DataSource = mControl.FiltrarRangoFechaSolicitudesSinProceso(FechaInicio, FechaFin, criterioBusqueda, Session.Item("IdEstablecimiento"))
            Try
                Me.dgLista.DataBind()
            Catch ex As Exception
                Me.dgLista.CurrentPageIndex = 0
