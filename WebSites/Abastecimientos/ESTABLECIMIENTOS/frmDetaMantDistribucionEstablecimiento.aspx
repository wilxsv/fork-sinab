...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <asp:CheckBox runat="server" CssClass="chkAll" ID="chkAll" Text="Seleccionar todos/Quitar selección: "
                                         OnCheckedChanged="chkAll_Check" AutoPostBack="True" Checked="True" />
        </div>
    <asp:Panel ID="Panel1" runat="server" Height="400px" ScrollBars="Vertical">
        <asp:GridView ID="gvLista" runat="server" CssClass="Grid" AutoGenerateColumns="False"  GridLines="None"
          CellPadding="4"  Width="100%" DataKeyNames="IDDISTRIBUCION,IDESTABLECIMIENTO" PageSize="15">
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="Reporte" >
                <ItemTemplate>
                  <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" CssClass="GridOrden" ToolTip="Ver"></asp:LinkButton>
                </ItemTemplate>
            ...
            <asp:TemplateField  >
              <ItemTemplate>
                <asp:LInkButton ID="ImageButton1" runat="server" CssClass="GridBorrar"
                  ToolTip="Eliminar" AlternateText="Eliminar el registro" CommandName="Delete"
