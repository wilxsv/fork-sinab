...
Partial Class ESTABLECIMIENTOS_frmMantDistribucionDetalle2_old
    ...
    Private Sub ucBarraNavegacion1_Guardar(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucBarraNavegacion1.Guardar
        ...
        If vals.Count >= 0 Then 'Hacemos el update de las cantidades
            ...
            If res = -1 Then
                ...
                Me.MsgBox1.ShowAlert("Error al almacenar los registros.", "Error", Cooperator.Framework.Web.Controls.AlertOption.NoAction)
                Exit Sub

            ElseIf res = -2 Then

                Me.MsgBox1.ShowAlert("La cantidad a distribuir no debe ser mayor a la cantidad en almacén.", "Error", Cooperator.Framework.Web.Controls.AlertOption.NoAction)
                Exit Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then 'al cargar por primera vez la página
            ...
            Me.lblProducto.Text = dsCatalogoProductos.Tables(0).Rows(0).Item("CORRPRODUCTO") & " - " & dsCatalogoProductos.Tables(0).Rows(0).Item("DESCLARGO")
    ...
    Private Sub CargarDatos()
        ...
        Dim mc As New cDistribucion
        Dim meses As Integer = mc.ObtenerMesesCalculo(Me.IDDISTRIBUCION, Session.Item("IdEstablecimiento"))
        Dim fechaconsumo As Date = mc.Obtenerfechaconsumo(Me.IDDISTRIBUCION, Session.Item("IdEstablecimiento"))


        Dim mComponente As New cDISTRIBUCIONDETALLE
        Dim ds As Data.DataSet = mComponente.obtenerDistribucionDetalle2(Me.IDDISTRIBUCION, Session.Item("IdEstablecimiento"), Me.IDPRODUCTO, fechaconsumo, meses)
