                        ...
                        <asp:MultiView ID="mvDistribucion" runat="server">
                                ...
                                <table class="form" cellpadding="5px" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="DataCell">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvDESCRIPCION0" runat="server" ControlToValidate="cboAlmacen" Display="Dynamic" ErrorMessage="*" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="LabelCell">
                                        ...
                                        <td class="DataCell">
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                                                <asp:ListItem Selected="True" Value="1">Por Tipo de Suministro</asp:ListItem>
                                                <asp:ListItem Value="2">Por Programa</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="DataCell">
                                            <asp:DropDownList ID="cboTipoSuministro" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cboTipoSuministro_SelectedIndexChanged" />
                                        </td>
                                    </tr>
                                    <tr runat="server" id="trGrupoMed" visible="false">
                                        <td class="LabelCell">
                                            <asp:Label runat="server" ID="Label41" Text="Grupos de Productos:" AssociatedControlID="ddlGRUPOS1" />
                                        </td>
                                        <td class="DataCell">
                                    ...
                                    <tr>
                                        <td class="LabelCell">
                                            <asp:Label runat="server" AssociatedControlID="ddlSUBGRUPOS2" ID="Label42" Text="Subgrupo de Productos:" Visible="False" />
                                        </td>
                                        <td class="DataCell">
                                            <cc1:ddlSUBGRUPOS ID="ddlSUBGRUPOS2" runat="server" AutoPostBack="False" Visible="False" />
                                        </td>
                                    </tr>
                                    <tr runat="server" id="trSubgrupoMed" >
                                        <td class="LabelCell">
                                            <asp:Label runat="server"  ID="Label2" Text="Programa:" Visible="False" />
                                        </td>
                                        <td class="DataCell">
                                    ...
                                    <td colspan="2" align="right">
                                        <asp:Label ID="Label43" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                            ...
                            <asp:View ID="vSelect" runat="server">
                                <div style="padding: 10px; text-align: right">
                                    <asp:CheckBox runat="server" CssClass="chkAll" ID="chkAll" Text="Seleccionar todos/Quitar selección: "
