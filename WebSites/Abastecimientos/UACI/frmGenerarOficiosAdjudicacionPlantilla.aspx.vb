...
Partial Class FrmGenerarOficiosAdjudicacionPlantilla
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If Not Me.ViewState("IDPROVEEDOR") Is Nothing Then
                Dim cad = "/Reportes/FrmRptAnexo1.aspx?id=" & Request.QueryString("IdProc") & "&Pr=" & Me.ViewState("IDPROVEEDOR").ToString
                btnAnexo1.OnClientClick = SINAB_Utils.Utils.ReferirVentana(cad)
                '"window.open('" + Request.ApplicationPath + "/Reportes/FrmRptAnexo1.aspx?id=" & Request.QueryString("IdProc") & "&Pr=" & Me.ViewState("IDPROVEEDOR").ToString & "');return;"
            End If
        End If
    ...
    Private Sub cargarProveedores()
        Me.dgProveedor.DataSource = cPC.obtenerProveedoresOficioAdj(Session("IdEstablecimiento"), Request.QueryString("IdProc"))
    ...
    Private Sub obtenerPlantillasContrato(ByVal IDTIPOCOMPRA As Integer, ByVal IDSUMINISTRO As Integer)
        ...
        ds = mComponente.ObtenerPLANTILLASCONTRATO(Session("IDESTABLECIMIENTO"), 3, 1, tipo)
    ...
    Protected Sub LinkButton2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton2.Click
        Response.Redirect("~/UACI/frmGenerarOficiosAdjudicacion.aspx", False)
    End Sub
    ...
    '    ds = mComFFC.obtenerFuenteFinanciamientoSolcitud(Session("IdEstablecimiento"), IDPROVEEDOR, IDCONTRATO, Request.QueryString("IdProc"))
    ...
    '            lEntidad.AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
    '            lEntidad.ESTASINCRONIZADA = 0
    '            lEntidad.AUFECHAMODIFICACION = CDate("1/1/1900")
    '            lEntidad.IDCONTRATO = IDCONTRATO
    '            lEntidad.IDESTABLECIMIENTO = Session("IdEstablecimiento")
    '            lEntidad.IDPROVEEDOR = IDPROVEEDOR
    ...
    '            End If
    '            .FECHAAPROBACION = CDate("1/1/1900")
    '            .FECHADISTRIBUCION = CDate("1/1/1900")
    '            .FECHAGENERACION = CDate("1/1/1900")
    '            .FECHAINICIOENTREGA = CDate("1/1/1900")
    ...
    Protected Sub btnGenerarContrato_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerarContrato.Click
        ...
        'Response.Write("window.open('" + Request.ApplicationPath + "/Reportes/frmRptOficiosAdjudicacion.aspx?id=" & Request.QueryString("IdProc") & "&Pr=" & IDPROVEEDOR & "');")
        'Response.Write("</script>")

        SINAB_Utils.Utils.MostrarVentana("/Reportes/frmRptOficiosAdjudicacion.aspx?id=" & Request.QueryString("IdProc") & "&Pr=" & IDPROVEEDOR)
    End Sub
    ...
    Private Function ElaborarContrato() As StringBuilder
        ...
        ds = cC.ElaboraOficioAdj(IDPLANTILLA)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            With ds.Tables(0)
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    textoContrato.Append("<b>" & Server.HtmlDecode(.Rows(i).Item("CONTENIDO")))
                Next
    ...
    Private Sub reemplazarEtiquetas(ByVal textoContrato As StringBuilder)
        ...
        dsAdjudicacion = mComAdjudicacion.ObtenerRenglonesAdjudicados(Session("IdEstablecimiento"), Request.QueryString("IdProc"), IDPROVEEDOR, 1)
        ...
        textoReemplazado = Replace(textoContrato.ToString, "$PLAZOS_ENTREGAS$", " ")
        ...
        tablaProductos.Append("<td><b>" & FormatCurrency(total) & "</b></td></tr>")
        ...
        textoReemplazado = Replace(textoReemplazado.ToString, "$CODIGO_LICITACION$", Server.HtmlEncode(ds.Tables(0).Rows(0).Item("CODIGOLICITACION")))
        ...
        contrato = "oficioPROV" & IDPROVEEDOR & ".htm"
        ...
        Else
            ...
            Else
                ...
                'Me.fuContrato.Visible = True
                'Me.MsgBox2.ShowAlert("El oficio de adjudicación se generó satisfactoriamente", "", Cooperator.Framework.Web.Controls.AlertOption.NoAction, Cooperator.Framework.Web.Controls.AlertType.Information)
    ...
    '    Try
    '        Me.lblMontoTotalCalc.Text = "Monto de referencia: " & FormatCurrency(cC.obtenerMontoContrato(Session("IdEstablecimiento"), Request.QueryString("IdProc"), IDPROVEEDOR, IDCONTRATO).Tables(0).Rows(0).Item("MONTOCONTRATO"))
    '    Catch ex As Exception
    '        Me.lblMontoTotalCalc.Text = "Monto de referencia: $0.0"
    '    End Try
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        SINAB_Utils.Utils.MostrarVentana("/Reportes/frmRptDistribucionAdjudicadoXProveedor2.aspx?id=" & Request.QueryString("IdProc") & "&Pr=" & IDPROVEEDOR)
    End Sub
