...
Partial Class frmCatTipoSancion
    ...
    Public Sub cargarDatos()
        ...
        Me.GridView1.DataSource = cx.ObtenerTiposSanciones()
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            Dim cx As New cRegistroProveedores
            Dim x As New TIPOSANCIONRP
            x.IDTIPOSANCION = ide
            x.NOMBRE = Me.TextBox1.Text
            cx.ActualizarTipoSancion(x)
            ide = 0
    ...
    Protected Sub BtnViewDetails_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        ds = cx.ObtenerDataSetPorID2TIPOSANCION(Me.GridView1.DataKeys(row.RowIndex).Values(0).ToString)
