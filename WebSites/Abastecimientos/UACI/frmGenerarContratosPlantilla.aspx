<%@ Page Language="VB" ValidateRequest="false" MasterPageFile="~/MasterPage.master"
  AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="FrmGenerarContratosPlantilla.aspx.vb"
  Inherits="FrmGenerarContratosPlantilla" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -> Generación de contratos</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <asp:Label ID="Label6" runat="server" Text="Pasos a seguir para la generación de contratos" /></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
          ...
          <table class="CenteredTable" style="width: 100%;">
            ...
            <tr>
              <td colspan="2">
                <asp:DataGrid ID="dgPlantillaContrato" runat="server" AutoGenerateColumns="False"
                  CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" PageSize="1000">
            ...
            <tr>
              <td colspan="2" style="text-align: right;">
                <asp:LinkButton ID="LinkButton2" runat="server" Text="Anterior" Visible="False" />
                <asp:LinkButton ID="LinkButton3" runat="server" Text="Siguiente" Enabled="False" /></td>
            </tr>
          </table>
        </asp:Panel>
      </td>
          ...
          <table class="CenteredTable" style="width: 100%;">
              ...
              <td>
                <asp:Panel ID="Panel6" runat="server" Visible="False" Width="100%">
                  <table class="CenteredTable" style="width: 100%;">
                    <tr>
                      <td class="LabelCell">
                        <asp:Label ID="Label10" runat="server" Text="Tipo de documento:" /></td>
                      <td class="DataCell">
                        <cc1:ddlTIPODOCUMENTOCONTRATO ID="ddlTIPODOCUMENTOCONTRATO1" runat="server" /></td>
                    </tr>
                    <tr>
                      <td class="LabelCell">
                    ...
                    <tr>
                      <td class="LabelCell">
                        <asp:Label ID="Label15" runat="server" Text="Representante Legal:" /></td>
                      <td class="DataCell">
                        <asp:Label ID="lblRepresentanteLegal" runat="server" /></td>
                    </tr>
                  </table>
                </asp:Panel>
              </td>
            ...
            <tr>
              <td style="text-align: right;">
                <asp:LinkButton ID="LinkButton4" runat="server" Text="Anterior" CausesValidation="False" Visible="False" />
                <asp:LinkButton ID="LinkButton5" runat="server" Enabled="False" Text="Siguiente" OnClientClick="test()" /></td>
            </tr>
            <tr>
              <td>
              </td>
            ...
            <tr>
              <td>
                <asp:Label ID="Label19" runat="server" Text="El contrato esta disponible para ser descargado:"
                  Visible="False" />
                <asp:LinkButton ID="lbDescargarArchivo" runat="server" Visible="False" Text="Descargar Contrato" /></td>
            </tr>
          </table>
        </asp:Panel>
      </td>
      ...
      <td colspan="2">
        <asp:Panel ID="Panel1" runat="server" Visible="False" Width="100%">
          <table class="CenteredTable" style="width: 100%;">
            ...
            <tr>
              <td colspan="2">
                <asp:TextBox ID="txtACTANOTARIAL" runat="server" Rows="10" TextMode="MultiLine" Width="100%" Visible="False" />
              </td>
            </tr>
            <tr>
              <td colspan="2">
            ...
            <tr>
              <td colspan="2" style="text-align: right; height: 18px;">
                <asp:LinkButton ID="LinkButton6" runat="server" Text="Anterior" Visible="False" />
      ...
      <td colspan="2">
        <asp:Panel ID="Panel4" runat="server" Visible="False" Width="100%">
          <table class="CenteredTable" style="width: 100%;">
            ...
            <tr>
              <td colspan="2" style="text-align: right;">
                <asp:LinkButton ID="LinkButton1" runat="server" Text="Anterior" Visible="False" /></td>
            </tr>
          </table>
        </asp:Panel>
      </td>
      ...
      <td colspan="2">
        <asp:Panel ID="Panel7" runat="server" Visible="False" Width="100%">
          <table class="CenteredTable" style="width: 100%">
            ...
            <tr>
              <td colspan="2" style="text-align: right">
                <asp:LinkButton ID="LinkButton10" runat="server" Text="Anterior" Visible="False" />
      ...
      <td colspan="2">
        <asp:Panel ID="Panel5" runat="server" Visible="False" Width="100%">
          <table class="CenteredTable" style="width: 100%;">
            <tr>
              <td colspan="2">
                <asp:Image ID="Image5" runat="server" ImageUrl="~/Imagenes/Generar Contrato paso 6.jpg" /></td>
            </tr>
            <tr>
              <td colspan="2" style="text-align: right;">
                <asp:Button ID="btnLiberaContrato" runat="server" Text="Liberar Contrato/Orden de compra"
                  Visible="False" Width="230px" /></td>
            </tr>
            <tr>
              <td class="LabelCell">
                <asp:Label ID="Label20" runat="server" Text="Fecha de firma del contrato/orden de compra:" /></td>
              <td class="DataCell">
            ...
            <tr>
              <td colspan="2">
                <asp:LinkButton ID="lbContrato" runat="server" Text="Descargar Contrato/Orden de compra" /></td>
            </tr>
            <tr>
              <td colspan="2">
              </td>
            ...
            <tr>
              <td colspan="2">
                <asp:Button ID="btnGenerarContrato" runat="server" Text="Generar Contrato/Orden de compra"
                  Width="224px" />
              </td>
            </tr>
            <tr>
              <td colspan="2">
                ...
                <asp:LinkButton ID="lbVerContrato" runat="server" Visible="False" Text="Ver contrato/Orden de compra" />
            ...
            <tr>
              <td colspan="2" style="text-align: right">
                <asp:LinkButton ID="LinkButton8" runat="server" Text="Anterior" Visible="False" /></td>
            </tr>
          </table>
        </asp:Panel>
      </td>
