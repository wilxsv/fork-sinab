<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="FrmMantIniciaProcesoCompraLG.aspx.vb" Inherits="FrmMantIniciaProcesoCompraLG" %>

<%@ MasterType VirtualPath="~/MasterPage.master" %>
<%@ Register TagPrefix="uc1" TagName="ucVistaListadoSolicitudCompra" Src="~/Controles/ucVistaListadoSolicitudCompraLG.ascx" %>
