...
Partial Class FrmGenerarMultas
    ...
    Protected Sub DataGrid1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.SelectedIndexChanged
        ...
        Me.gvInformes.DataSource = mMulta.obtenerInformesIncumplimiento(Me.Session("IdEstablecimiento"), Me.Session("idproveedor"), Me.Session("idcontrato"))
    ...
    Protected Sub btnPlantilla_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPlantilla.Click
        ...
        idmulta = mMultas.encabezadoAudiencia_Multa(Me.Session("IdEstablecimiento"), Me.Session("idproveedor"), Me.Session("idcontrato"), Me.Session("idNota"), 1, 0)
        ...
        If Me.RichTextEditor1.Text = "" Then
            Me.RichTextEditor1.Text = mMultas.obtenerPlantilla(Session("IdEstablecimiento"), 1, 0).ToString
        End If
    End Sub
    ...
    Protected Sub btnGuardarPlantilla_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardarPlantilla.Click
        ...
        C.guardarPlantilla(Me.Session("IdEstablecimiento"), 1, "Audiencia", Me.RichTextEditor1.Text, 0)
    ...
    Private Function GenerarDocumento(ByVal texto As StringBuilder, ByVal ds As DataSet) As StringBuilder
        ...
        If File.Exists(Server.MapPath(directorio & "\Audiencias\Audiencia_" & Me.txtNumero.Text & "_" & contrato & ".htm")) Then
            File.Delete(Server.MapPath(directorio & "\Audiencias\Audiencia_" & Me.txtNumero.Text & "_" & contrato & ".htm"))
            File.AppendAllText(Server.MapPath(directorio & "\Audiencias\Audiencia_" & Me.txtNumero.Text & "_" & contrato & ".htm"), "<html><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>" & texto.ToString & "</html>")
        Else
            File.AppendAllText(Server.MapPath(directorio & "\Audiencias\Audiencia_" & Me.txtNumero.Text & "_" & contrato & ".htm"), "<html><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>" & texto.ToString & "</html>")
        End If
    ...
    Protected Sub gvInformes_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvInformes.SelectedIndexChanged
        ...
        Me.Session("numeroinforme") = Me.gvInformes.DataKeys(Me.gvInformes.SelectedIndex).Values("NUMEROINFORME")
        Me.gvAtrasos.DataSource = mMultas.ObtenerIncumplimientosAtraso(Me.Session("IDESTABLECIMIENTO"), Me.Session("IdProveedor"), Me.Session("idcontrato"), Me.Session("Idnota"))
        Me.gvAtrasos.DataBind()
        Me.gvNoEntregados.DataSource = mMultas.ObtenerIncumplimientosNoEntregado(Me.Session("IDESTABLECIMIENTO"), Me.Session("IdProveedor"), Me.Session("idcontrato"), Me.Session("Idnota"))
    ...
    Private Sub GenerarDocumento()
        ...
        ds = mMulta.calcularMulta(Me.Session("idestablecimiento"), Me.Session("idproveedor"), Me.Session("idcontrato"), Me.Session("idnota"))
    ...
    Private Sub CargarDocumento()
        ...
        openWindow = "<script type=text/javascript> window.open(' " & directorio & "/Audiencias/Audiencia_" & Me.Session("Ndoc") & "_" & archivo & ".htm',  '_blank') </script>"
