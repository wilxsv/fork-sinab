...
Partial Class UACI_CERTIFICACION_Reportes_FrmReporteComision
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("~/UACI/CERTIFICACION/Reportes/Fuentes/reporte1y7.rpt")
        Reporte.Load(reportPath)

        Dim ds = ProductosProveedores.ObtenerReporteDetalle(idProceso, idTipoProducto, idProveedor, idpp)
        Dim ds2 = EstadoProductos.ObtenerSubReporte(idpp)
