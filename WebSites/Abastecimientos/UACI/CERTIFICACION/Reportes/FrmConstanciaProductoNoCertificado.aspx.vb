...
Partial Class UACI_CERTIFICACION_Reportes_FrmConstanciaProductoNoCertificado
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim ds = ProductosProveedores.ObtenerReporte(idProceso, idTipoProducto, nitProveedor, codigoProducto, 1)
        ...
        param.Value = "Constancia de Productos No Calificados"
