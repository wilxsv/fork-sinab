...
Partial Class UACI_CERTIFICACION_Reportes_FrmConstanciaProductoCertificado
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim codigoProducto As String = Request.QueryString("codigo")

        Dim reportPath As String = Server.MapPath("~/UACI/CERTIFICACION/Reportes/Fuentes/reporte2.rpt")
        Reporte.Load(reportPath)

        Dim ds = ProductosProveedores.ObtenerReporte(idProceso, idTipoProducto, nitProveedor, codigoProducto, 0)

       Reporte.SetDataSource(ds)

        Dim paramTitle = New ParameterDiscreteValue()
        paramTitle.Value = "Constancia de Productos Calificados"
