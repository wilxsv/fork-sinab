...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <tr>
      ...
      <td class="DataCell">
       <%-- <ew:CalendarPopup ID="CPFechaEnvioNota" runat="server" DisableTextBoxEntry="False"
          ...
          <asp:TextBox runat="server" ID="CPFechaEnvioNota" CssClass="datefield"/>
        &nbsp;(dd/mm/yyyy)</td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      ...
      <td class="DataCell">
       <%-- <ew:CalendarPopup ID="CPFechaPublicacion" runat="server" DisableTextBoxEntry="False"
          Culture="Spanish (El Salvador)" />--%>
          <asp:TextBox runat="server" ID="CPFechaPublicacion" CssClass="datefield"/>
        &nbsp;(dd/mm/yyyy)
    ...
    <tr>
      ...
      <td class="DataCell">
          <asp:TextBox runat="server" CssClass="double" ID="NBCostoBases"/>
       <%-- <ew:NumericBox ID="NBCostoBases" runat="server" AutoFormatCurrency="True" DecimalPlaces="2"
          Width="92px" MaxLength="12" TextAlign="Right" />--%>($US)
      </td>
    </tr>
    <tr>
      <td colspan="2">
