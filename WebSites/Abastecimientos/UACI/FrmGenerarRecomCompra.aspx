...
<asp:Content runat="server" ContentPlaceHolderID="MenuContent" ID="cmenu">
    ...
    UACI » Evaluación y recomendación de compra
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    <div>
        ...
        <asp:Button ID="btnInformeEvaluacion" runat="server" Text="4. Informe de evaluación" />
    </div>
    ...
    <div style="margin: 4px 0">
        <asp:Button ID="btnFinalizarRecomendacion" runat="server" Text="Finalizar Recomendación de Compra"
            Width="233px" />
        <asp:Button ID="btnResumenProceso" runat="server" Text="Resumen Proceso" Width="128px" />
    </div>
    ...
    <div style="margin: 10px 0">
        ...
        <asp:Button ID="btnPreciosHistoricos" runat="server" Text="Precios Historicos" Visible="False"
            Width="117px" EnableTheming="False" />
    </div>
    <asp:Panel ID="pnLicitacion" runat="server" Visible="False" Width="100%">
        <h3>
            <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="CRITERIOS DE EVALUACION" />
        </h3>
        <div>
            <asp:Label ID="Label18" runat="server" Font-Bold="True" ForeColor="Red" Text="Licitación Pública"
                Visible="False" />
        </div>
        <asp:GridView ID="gvCriterios" runat="server" CellPadding="4" CssClass="Grid" GridLines="None"
            AutoGenerateColumns="False" Width="100%" DataKeyNames="IDCRITERIOEVALUACION">
                ...
                <asp:TemplateField ItemStyle-Wrap="False">
                    <ItemTemplate>
                        <ew:NumericBox ID="NumericBox4" runat="server" MaxLength="5" PositiveNumber="True"
                            Width="50px" Text='<%# DataBinder.Eval(Container, "DataItem.PORCENTAJE2") %>'
                            Enabled='<%# Iif(Eval("IDCRITERIOEVALUACION") = 99, False, True) %>' />
        ...
        <div class="Grid" style="text-align: left; border-top: 0px; padding: 4px;">
            <asp:Button ID="btnObtenerCalificacionLP" runat="server" Text="Obtener calificación >>" />
            <div style="float: right; margin-right: 30px">
                <asp:Label ID="lblCalificacionLP" runat="server" Font-Bold="True" ForeColor="Red" />
            </div>
            <div style="margin: 5px 0">
                ...
                <asp:TextBox ID="txtObservacion" runat="server" Width="100%" TextMode="MultiLine"
                    Visible="False" />
            </div>
        </div>
        <div style="margin: 10px 0">
    ...
    <asp:Panel ID="pnInformeEvaluacion" runat="server" Visible="False" Width="100%" HorizontalAlign="Center">
        ...
        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid" BorderWidth="1px" Height="50px"
            ...
            <asp:Button ID="Button4" runat="server" Text="Informe de Evaluación por Renglones" /></asp:Panel>
        <br />
        <asp:Panel ID="Panel4" runat="server" BorderStyle="Solid" BorderWidth="1px" Height="50px"
            ...
            <asp:Button ID="Button5" runat="server" Text="Informe de Evaluación por Ofertas"
