...
Partial Class frmCatModalidadCompra
    ...
    Public Sub cargarDatos()
        Dim cx As New cMODALIDADCOMPRACG
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            Dim cx As New cMODALIDADCOMPRACG
            Dim x As New MODALIDADCOMPRACG
            x.IDMODALIDAD = ide
            x.NOMBRE = Me.TextBox1.Text
            cx.ActualizarMODALIDADCOMPRA(x)
            ide = 0
        End If
        cargarDatos()
        Me.mdlPopup.Hide()
    ...
    Protected Sub BtnSave2_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim cx As New cMODALIDADCOMPRACG
        cx.EliminarMODALIDADCOMPRA(ide)
        ide = 0
        cargarDatos()
