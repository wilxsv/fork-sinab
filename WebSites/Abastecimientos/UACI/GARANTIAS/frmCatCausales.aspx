<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmCatCausales.aspx.vb" Inherits="frmCatCausales" title="Untitled Page" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Control de Garantías&gt; Catálogo de Causas por Tipo de Garantía</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>CATALOGO DE CAUSAS POR TIPO DE GARANTÍA</strong></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
          BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="idcausal,idtipogarantia"
          ForeColor="Black" GridLines="Vertical">
          <Columns>
            <asp:BoundField DataField="tipogarantia" HeaderText="Tipo de Garant&#237;a">
              <ItemStyle HorizontalAlign="Left" />
            </asp:BoundField>
            <asp:BoundField DataField="idcausal" HeaderText="Correlativo" />
            <asp:BoundField DataField="nombre" HeaderText="Causa" >
              <ItemStyle HorizontalAlign="Left" />
            </asp:BoundField>
            <asp:TemplateField>
              <ItemTemplate>
            ...
            <ContentTemplate>
              <div align="center">
                <asp:Label ID="lblCustomerDetail" runat="server" BackColor="Black" Font-Bold="True"
                  ForeColor="White" Text="Nueva Causa:" Width="100%"></asp:Label>
                &nbsp;&nbsp;<table>
                  <tr>
