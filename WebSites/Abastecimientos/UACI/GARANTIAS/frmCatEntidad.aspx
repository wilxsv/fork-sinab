<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmCatEntidad.aspx.vb" Inherits="frmCatEntidad" title="Untitled Page" %>
  ...
  <table class="CenteredTable" style="width: 100%">
    <tr>
      <td class="LinkMenuRuta" colspan="2">
        ...
        UACI -Control de Garantías&gt; Catálogo de Entidades</td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <strong>CATALOGO DE ENTIDADES QUE OTORGAN GARANTÍAS</strong></td>
    </tr>
    <tr>
      <td colspan="2">
      </td>
    ...
    <tr>
      <td colspan="2">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
          BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="identidad"
          ForeColor="Black" GridLines="Vertical">
          <Columns>
            <asp:BoundField DataField="identidad" HeaderText="Correlativo" />
            ...
            <ContentTemplate>
              <div align="center">
                <asp:Label ID="lblCustomerDetail" runat="server" BackColor="Black" Font-Bold="True"
                  ForeColor="White" Text="Nueva entidad:" Width="100%"></asp:Label>
                &nbsp;&nbsp;<table>
                  <tr>
