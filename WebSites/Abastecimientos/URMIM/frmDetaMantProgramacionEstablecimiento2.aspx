<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="frmDetaMantProgramacionEstablecimiento2.aspx.vb" Inherits="URMIM_frmDetaMantProgramacionEstablecimiento2"
    ...
    <tr>
      <td>
        ...
        <asp:GridView ID="gvLista" runat="server" CssClass="Grid" AutoGenerateColumns="False"
          CellPadding="2" Width="100%" DataKeyNames="IDPROGRAMACION,IDESTABLECIMIENTO,ESTADO,PRESUPUESTOASIGNADO">
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="Techo Presup." Visible="False">
              <ItemTemplate>
