<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="frmDetaMantProgramacionProducto.aspx.vb" Inherits="URMIM_frmDetaMantProgramacionProducto"
  ...
  <table width="100%">
    <tr>
      <td align="left" style="width: 87%">
        ...
        &nbsp;
        <asp:Button runat="server" ID="btnRpt2" Text="Reporte Precios Cero" Width="136px" />
        &nbsp;
        <asp:Button runat="server" ID="ButtonEst" Text="Def. Establecimientos" Width="170px" />
      </td>
