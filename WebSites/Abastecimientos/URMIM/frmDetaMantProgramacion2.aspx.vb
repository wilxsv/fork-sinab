...
Partial Class URMIM_frmDetaMantProgramacion2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            cboTipoSuministro.SelectedIndex = 1
    ...
    Public Function Actualizar() As String
        ...
        Return CType(mComponente.Actualizar(mEntidad), String)
    ...
    Protected Sub cboTipoSuministro_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboTipoSuministro.SelectedIndexChanged
