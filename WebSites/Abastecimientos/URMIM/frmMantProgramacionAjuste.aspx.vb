...
Partial Class URMIM_frmMantProgramacionAjuste
    ...
    Private Sub CargarDatos() 'carga los datos y los muestra en el gridview
        ...
        ds = mComponente.obtenerProgramacionProductosDetalle(Me.IDPROGRAMACION, Me.cboEstablecimientos.SelectedItem.Value, M, N)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            total2 = ds.Tables(0).Compute("SUM(MONTOTOTAL)", "")
        Else
            total = 0
            total2 = 0
        End If

        'Me.lblMTA.Text = Math.Round(total, 2)
        Me.lblMTA.Text = Math.Round(total, 4)

        ' Dim total2 As Decimal = ds.Tables(0).Compute("SUM(MONTOTOTAL)", "")

        Me.lblMT.Text = Math.Round(total2, 2)

        'Me.lblMT.Text = total2

        Dim dif As Decimal = Math.Round(total, 2) - Math.Round(total2, 2)
    ...
    Protected Sub btnRpt1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRpt1.Click
        ...
        alerta ="/Reportes/frmRptProgramacion.aspx?idProceso=" & IDPROGRAMACION & "&idEstablecimiento=" & Me.cboEstablecimientos.SelectedItem.Value & "&m=" & M & "&n=" & N & "&tipo=4"
    ...
    Protected Sub btnRpt2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRpt2.Click
        ...
        alerta = "/Reportes/frmRptProgramacion.aspx?idProceso=" & IDPROGRAMACION & "&idEstablecimiento=" & Me.cboEstablecimientos.SelectedItem.Value & "&m=" & M & "&n=" & N & "&tipo=5"
        SINAB_Utils.Utils.MostrarVentana(alerta)
    ...
    Protected Sub gvLista_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        alerta = "/Reportes/frmRptProgramacionObservacion.aspx?idProceso=" & IDPROGRAMACION & "&idProducto=" & IDPRODUCTO & "&idEstablecimiento=" & IDESTABLECIMIENTO & "&tipo=2"
        SINAB_Utils.Utils.MostrarVentana(alerta)
    End Sub
