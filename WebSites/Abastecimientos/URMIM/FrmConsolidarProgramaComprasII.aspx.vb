...
Partial Class FrmConsolidarProgramaComprasII
    ...
    Protected Sub BtnVerifica_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnVerifica.Click
        ...
        mEntSolicitudes.OBSERVACION = "Este solicitud fue elaborado para la compra del programa: " + Me.DdlPROGRAMAS1.SelectedItem.Text
        ...
        If mCompSolicitudes.ActualizarSOLICITUDES(mEntSolicitudes) <> 1 Then
            MsgBox1.ShowAlert("El proceso no puede ser completado favor reinicie el proceso de consolidación del programa de compras", "A", Cooperator.Framework.Web.Controls.AlertOption.NoAction, Cooperator.Framework.Web.Controls.AlertType.Information)
        End If
    ...
    Private Sub CargarConsolidado()
        'Se utiliza para generar el consolidado de los programas de compra
        ...
        If mCompDetalleEstimacionNecesidades.ConsolidarEstimacionesConProgramas(Me.TxtAnio.Text, Me.DdlPROPUESTASDISPONIBLES1.SelectedValue, Me.LblDocumento.Text, Session.Item("idestablecimiento"), Me.DdlPROGRAMAS1.SelectedValue) = 1 Then
            MsgBox1.ShowAlert("La transacción no pudo ser realizada favor consulte con el departamente de soporte técnico", "A", Cooperator.Framework.Web.Controls.AlertOption.NoAction, Cooperator.Framework.Web.Controls.AlertType.Information)
        Else
            ...
            End If
            'Se modifico el metodo "FILTRARESTIMACIONNECESIDADES" del componente para incluir el programa
            dsNecesidadesXsolicitud = mComponente.FiltrarEstimacionNecesidadesConProgramas(Me.TxtAnio.Text, Me.DdlPROPUESTASDISPONIBLES1.SelectedValue, Me.DdlPROGRAMAS1.SelectedValue)
    ...
    Private Sub ActualizarNecesidadesSolicitudes()
        ...
        dsNecesidades = mCompEstimacionNecesidades.FiltrarEstimacionNecesidadesConProgramas(Me.TxtAnio.Text, Me.DdlPROPUESTASDISPONIBLES1.SelectedValue, Me.DdlPROGRAMAS1.SelectedValue)
    ...
    Protected Sub BtnValidar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnValidar.Click
        ...
        Else
            ...
            Else
                ...
                Me.DdlPROGRAMAS1.Enabled = False
    ...
    Protected Sub dgConsolidado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgConsolidado.SelectedIndexChanged
