...
Partial Class FrmDetMantRecepcionTransferencia
...
#Region "Propiedades"
    ...
    Public Property IDMOVIMIENTO() As Integer
        ...
        Set(ByVal value As Integer)
            ...
            Dim cad = String.Format("/Reportes/FrmRptReciboRecepcion.aspx?IdEMov={0}&IdTT={1}&IdMov={2}", Session.Item("IdEstablecimiento"), eTIPOTRANSACCION.RecepcionPorTransferencia.ToString("d"), Me.IDMOVIMIENTO)
            Me.btnImprimir.OnClientClick = SINAB_Utils.Utils.ReferirVentana(cad)
            '"window.open('" + Request.ApplicationPath + "/Reportes/FrmRptReciboRecepcion.aspx?IdEMov=" + Session.Item("IdEstablecimiento").ToString + "&IdTT=" + eTIPOTRANSACCION.RecepcionPorTransferencia.ToString("d") + "&IdMov=" + Me.IDMOVIMIENTO.ToString + "', 'popup', 'scrollbars=1, resizable=1, width=800, height=600'); return;"
        End Set
    End Property
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If MessageBox.ConfirmTarget = "Crear Nuevo" Then
                Response.Redirect("~/ALMACEN/FrmDetMantRecepcionTransferencia.aspx?IdM=0" + "&IdA=" + Me.IDALMACEN.ToString, False)
            End If
    ...
    Private Sub CargarDatos()
        ...
        Me.ddlALMACENES1.SelectedValue = eRR.IDALMACENVALE
    ...
    Private Sub CargarDetalleRecepcion()
        ...
        Dim ds As Data.DataSet
        ds = cRR.RecuperarDetalleRecepcion(Me.IDALMACEN, Me.ANIO, Me.IDRECIBO, eTIPOTRANSACCION.RecepcionPorTransferencia)
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If GuardarMovimiento() = 1 Then
            ...
            MessageBox.Confirm("El recibo " + Me.txtNroRecibo.Text + " se ha guardado satisfactoriamente. ¿Desea crear uno nuevo?", "Crear Nuevo", MessageBox.OptionPostBack.YesPostBack)
    ...
    Private Function GuardarMovimiento() As Integer
        ...
        Try
            ...
            If Me.IDMOVIMIENTO = 0 Then
                ...
                eRR.IDALMACENVALE = Me.ddlALMACENES1.SelectedValue
    ...
    Protected Sub gvLista_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        ...
        cDM.EliminarDETALLEMOVIMIENTOS(Session.Item("IdEstablecimiento"), eTIPOTRANSACCION.RecepcionPorTransferencia, Me.IDMOVIMIENTO, IDDETALLEMOVIMIENTO)
    ...
    Private Sub Cerrar()
        ...
        MessageBox.Confirm("El recibo ha sido cerrado satisfactoriamente. ¿Desea crear uno nuevo?", "Nuevo", OptionPostBack.YesPostBack)
