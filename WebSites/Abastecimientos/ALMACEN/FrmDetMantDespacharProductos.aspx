<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="FrmDetMantDespacharProductos.aspx.vb" Inherits="ALMACEN_FrmDetMantDespacharProductos" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="cc1" Namespace="ABASTECIMIENTOS.WUC" Assembly="ABASTECIMIENTOS_WUC" %>
<%@ MasterType VirtualPath="~/MasterPage.master" %>

<%@ Register src="../Controles/BuscarProductosLight.ascx" tagname="BuscarProductosLight" tagprefix="uc1" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="Server">
    <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
            ...
            <div class="CenteredTable" style="margin-bottom: 20px;">
                <asp:Panel ID="plEncabezado" runat="server" Visible="false">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="DataCell">
                                <asp:DropDownList ID="ddlSUMINISTROS1" runat="server" AutoPostBack="true" Width="300" />
                               <%-- <cc1:ddlSUMINISTROS ID="ddlSUMINISTROS1" runat="server" AutoPostBack="True" Width="300" />--%>
                            </td>
                        </tr>
                        <tr>
                            <td class="LabelCell">
                        ...
                        <tr>
                            ...
                            <td class="DataCell">
                                <asp:DropDownList ID="ddlESTABLECIMIENTOS1" CssClass="filterlist" runat="server" Width="400" AutoPostBack="True"/>
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="Productos">
                            ...
                            <asp:Panel ID="plFiltroSeleccion" runat="server" Width="100%" Visible="False">
                                <table style="width: 100%;">
                                   ...
                                   <%-- <asp:TextBox ID="txtProducto" runat="server" MaxLength="8" Width="88px" />--%>
                                    ...
                                    <uc1:BuscarProductosLight ID="BuscarProducto" runat="server" />
                            
                        <div style="margin:10px 0 ">
                                    <asp:Button ID="btnBuscar" runat="server" Text="Agregar" Width="79px" ValidationGroup="Buscar" />
                               </div>
                    </asp:Panel>
                    ...
                    <asp:GridView ID="gvLista" CssClass="Grid" runat="server" AutoGenerateColumns="False"
                        CellPadding="4" GridLines="None" Width="100%" DataKeyNames="IDESTABLECIMIENTO, IDTIPOTRANSACCION,IDLOTE,IDPRODUCTO,CANTIDAD, IDESTADO"
                        ShowFooter="true">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CodigoDetalleFecha" HeaderText="Lote - Fecha vto.">
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" ToolTip="Eliminar registro" runat="server" AlternateText="Elimina el registro"
                                        ...
                                        Text="Eliminar" OnClientClick="if(!window.confirm('¿Confirma que desea eliminar el registro? Este cambio afecta el vale de salida, será permanete y no puede revertirse')){return false;}"
                                        Visible='<%# Eval("IDESTADO")  %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
                    ...
                    <asp:Panel ID="plDatosProducto" runat="server" CssClass="pupform">
                        ...
                        <asp:GridView ID="gvLotes" runat="server" AutoGenerateColumns="false" CellPadding="4"
                            GridLines="None" CssClass="Grid" DataKeyNames="IDLOTE,CODIGO,IDPRODUCTO,CORRPRODUCTO,PRECIOLOTE"
                            Width="100%">
                            <HeaderStyle CssClass="GridListHeaderSmaller" />
                            <FooterStyle CssClass="GridListFooter" />
                            <PagerStyle CssClass="GridListPager" />
                                ...
                                <asp:TemplateField HeaderText="Cantidad a despachar">
                                    <ItemTemplate>
                                        ...
                                        <asp:RangeValidator ID="cvCantidad" runat="server" ControlToValidate="nbCantidad"
                                            ValidationGroup="GuardarLote" Display="Dynamic" ForeColor="#B20000" MaximumValue='<%# Eval("CANTIDAD") %>'
                ...
                <asp:Panel ID="plGenerales" runat="server" Width="100%" Visible="false">
                    ...
                    <div>
                        ...
                        <%--<asp:Button ID="btnProcesar" runat="server" Enabled="False" Text="Procesar despacho"
                            ValidationGroup="Cerrar" />--%>
