<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  MaintainScrollPositionOnPostback="true" CodeFile="FrmDetMantRecepcionTransferenciaValeSalida.aspx.vb"
  Inherits="FrmDetMantRecepcionTransferenciaValeSalida" %>
            ...
            <tr>
              <td colspan="2">
                <asp:CompareValidator ID="cvFechaRecepcion" runat="server" ControlToValidate="cpFechaRecepcion"
                  ...
                  Type="Date" ValidationGroup="Cerrar" />
              </td>
            </tr>
            <tr>
              <td class="LabelCell">
            ...
            <tr>
              <td colspan="2">
                <asp:Button ID="btnGuardar" runat="server" Text="Guardar recepción" ValidationGroup="Guardar"
                  Enabled="False" />
                <nds:Button ID="btnCerrar" runat="server" Text="Cerrar recepción" Enabled="False"
                  Message="Si cierra el documento, este ya no podrá ser modificado, ¿desea continuar?"
                  ShowConfirmDialog="true" ValidationGroup="Cerrar" />
