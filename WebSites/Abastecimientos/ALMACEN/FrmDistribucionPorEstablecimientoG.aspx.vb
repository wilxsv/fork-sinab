...
Partial Class ALMACEN_FrmDistribucionPorEstablecimientoG
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.DropDownList2.DataSource = dba.ListaDistribucionesCerradas(Me.ddlAnioAbas.SelectedValue, 620, 1, Session("IdEstablecimiento"))
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        'Mostrar el reporte
        Dim alerta As String = "/Reportes/frmRptDistribucion.aspx?id=" & IDDISTRIBUCION & "&tipo=" & TIPO & "&est=" & IDESTABLECIMIENTO & "&prod=0&guarda=1"
    ...
    Protected Sub ddlAnioAbas_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlAnioAbas.SelectedIndexChanged
        Dim dba As New ABASTECIMIENTOS.NEGOCIO.cDistribucion
        Me.DropDownList2.DataSource = dba.ListaDistribucionesCerradas(Me.ddlAnioAbas.SelectedValue, 620)
        Me.DropDownList2.DataTextField = "DESCRIPCION"
        Me.DropDownList2.DataValueField = "IDDISTRIBUCION"
        Me.DropDownList2.DataBind()
    End Sub
