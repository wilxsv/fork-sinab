<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="FrmReporteDistribucion3.aspx.vb" Inherits="ALMACEN_FrmReporteDistribucion3" title="" %>
    ...
    <tr>
      <td class="LinkMenuRuta">
        &nbsp;<asp:LinkButton ID="lnkMenu" runat="server" Text="Menú" CausesValidation="False" />
          Almacén -&gt; Distribuciones por establecimiento&nbsp;</td>
    </tr>
 </table>
  <table align="center">
    <tr>
    ...
    <tr>
      ...
      <td align="left" style="width: 100px">
          <asp:DropDownList ID="ddlAnioAbas" runat="server">
          </asp:DropDownList>
