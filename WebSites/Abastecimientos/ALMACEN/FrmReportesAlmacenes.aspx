...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
        <asp:Panel ID="plListaReportes" runat="server" CssClass="listLinks"  GroupingText="Seleccione un reporte"
          Width="100%">
            ...
            <asp:LinkButton ID="LinkButton24" runat="server" Text="25 - Resumen de Actas de Recepción por Almacenes"
                  PostBackUrl="~/Reportes/FrmActasRecepcionAlmacenes.aspx" Visible="false" />
        </asp:Panel>
