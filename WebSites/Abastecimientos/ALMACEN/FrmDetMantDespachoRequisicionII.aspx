<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"  MaintainScrollPositionOnPostback="true" CodeFile="FrmDetMantDespachoRequisicionII.aspx.vb" Inherits="FrmDetMantDespachoRequisicionII" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="server">
    <table style="width: 100%">
        <tr>
            <td style="text-align: left; width:5%; background-color:#b5c7de; height: 18px;">
                &nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Almacén -> Despachar productos a partir de una requisición" /></td>
        </tr>
        <tr>
    ...
    <asp:Panel ID="PnlEncabezado" runat="server" Width="100%" >
        <table width="100%">
            ...
            <tr>
                <td class="LabelCell">
			        <asp:Label id="lblIdUnidadSolicita" runat="server" Width="191px">Establecimiento que solicita:</asp:Label>
			    </td>
                <td class="DataCell">
                    <cc1:ddlESTABLECIMIENTOS ID="DdlESTABLECIMIENTOS1" runat="server" Width="328px">
                    </cc1:ddlESTABLECIMIENTOS>
                    <asp:TextBox ID="TxtAlmacenSolicita" runat="server" Visible="False" Width="47px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="LabelCell">
    ...
    <asp:Panel ID="PnlDetalle" runat="server" Width="100%" GroupingText="Productos solicitados" Visible="False" Font-Bold="True" >
        <asp:GridView ID="gvProductosRequisicion" runat="server" Width="100%" EmptyDataText="No hay registros de datos para mostrar." AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Font-Bold="False" Font-Size="8pt">
            <Columns>
