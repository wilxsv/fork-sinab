...
Public Class html_msj
    ...
    Public Shared Function HTML_CSS_Error(ByVal objError As Exception, ByVal PageUrl As String, ByVal ipAdd As String, ByVal host As String, ByVal usuario As String) As String
        ...
        tablaHTML.Append(" <span><H1>Error de servidor (" & My.Computer.Name & ")  en la aplicación '" & System.Web.HttpContext.Current.Request.ApplicationPath & "'.<hr width=100% size=1 color=silver></H1>")
        ...
        If Not HttpContext.Current.Request.QueryString.Count = 0 Then
            tablaHTML.Append("<br>QueryString :  " & HttpContext.Current.Request.Url.Query)
        End If
        ...
        tablaHTML.Append(" <br> ")
        tablaHTML.Append(" <b> Archivo de origen: </b> " & HttpContext.Current.Request.PhysicalPath & "<b>  ")
        tablaHTML.Append(" <br><br> ")
        ...
        tablaHTML.Append(" <b>Información de browser:</b>&nbsp;" & HttpContext.Current.Request.Browser.Browser & "; Versión:" & HttpContext.Current.Request.Browser.Id & "<br> ")
        tablaHTML.Append(" <b>Agente Browser:</b>&nbsp;" & HttpContext.Current.Request.UserAgent.ToString & "")
