...
Partial Class Reportes_FrmRptExamenTodosRenglon
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptExamenRenglonGeneral.rpt")
        ...
        ds = mComponente.obtenerExamenRenglonGeneral(Session.Item("IdEstablecimiento"), lId)
