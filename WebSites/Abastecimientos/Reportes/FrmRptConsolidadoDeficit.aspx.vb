...
Partial Class Reportes_FrmRptConsolidadoDeficit
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If lTipo = 1 Then
            reportPath = Server.MapPath("RptConsolidadoDeficit.rpt")
        ElseIf lTipo = 2 Then
            reportPath = Server.MapPath("RptConsolidadoDeficitEstablecimiento.rpt")
        Else
            reportPath = Server.MapPath("RptConsolidadoDeficitNacional.rpt")
        End If
