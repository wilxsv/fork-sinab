...
Partial Class Reportes_frmRptProximoAVencer
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptProximoAVencer.rpt")
        ...
        Dim cDC As New cLOTES

        Dim ds As Data.DataSet
        ds = cDC.RptProximosAVencer(FechaI, IdEstablecimiento, idRegion, IdSuministro, idGrupo, idSubGrupo, idProducto)

        Reporte.SetDataSource(ds.Tables(0))

        Reporte.DataDefinition.FormulaFields(0).Text = "'" & FechaI & "'"
        Reporte.DataDefinition.FormulaFields(1).Text = "'" & TipoInsumo & "'"
        Reporte.DataDefinition.FormulaFields(2).Text = "'" & FGeo & "'"
