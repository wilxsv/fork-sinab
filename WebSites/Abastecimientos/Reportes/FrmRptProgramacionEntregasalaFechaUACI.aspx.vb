...
Partial Class FrmRptProgramacionEntregasalaFecha
    ...
    Private Sub ConfigureCrystalReports()
        ...
        dt1 = cC.ObtenerDatasetRenglonesContratoOtrosDoc3(IDESTABLECIMIENTO, IDPROVEEDOR, IDCONTRATO).Tables(0).Copy
        dt1.TableName = "Renglones"
        ds.Tables.Add(dt1)

        Dim dsr As Data.DataSet
        dsr = cC.ObtenerEntregasProgramadas(IDESTABLECIMIENTO, IDPROVEEDOR, IDCONTRATO)
        ...
        'pField1.ParameterFieldName = "Dependencia"
        'pDiscreteValue1.Value = Session.Item("UsuarioDependencia").ToString.ToUpper
