...
Partial Class Reportes_frmRptConsumoInventario
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptConsumoInventario.rpt")
        ...
        ds = cDC.RptConsumoInventario(FechaI, FechaF, IdEstablecimiento, idRegion, IdSuministro, idGrupo, idSubGrupo, idProducto)
