...
Partial Class FrmRptDespachoXTipoProducto
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptDespachoXTipoProducto.rpt")
        Reporte.Load(reportPath)

        Dim IDALMACEN, ANIO, IDSUMINISTRO, IDESTABLECIMIENTODESTINO As Integer
        ...
        ds = cDM.RptDespachosMensualesXTipoProducto(IDALMACEN, ANIO, IDSUMINISTRO, IDESTABLECIMIENTODESTINO)
