...
Partial Class Reportes_FrmRptActaRecepcion
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim IDMOVIMIENTO, IDALMACEN, ANIO As Integer
        IDMOVIMIENTO = Request.QueryString("IdMov")
        IDALMACEN = Request.QueryString("IdAlm")
        ANIO = Request.QueryString("IdAnio")
        ...
        reportPath = Server.MapPath("RptActaRecepcion2.rpt")
        ...
        'dsReciboRecepcion = mCompMovimientos.ObtenerReciboRecepcionDS2(IDMOVIMIENTO, IDALMACEN, ANIO)
