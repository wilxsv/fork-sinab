...
Partial Class Reportes_FrmRptProveedoresAfectados
    ...
    Private Sub ConfiguracionReporte()
        ...
        Dim reportPath As String = Server.MapPath("RptProveedoresAfectados.rpt")
        Reporte.Load(reportPath)

        Dim IDPROCESOCOMPRA As Int64
        IDPROCESOCOMPRA = Request.QueryString("id")

        Dim IDRENGLON As Int64
        IDRENGLON = Request.QueryString("renglon")

        Dim cDO As New cDETALLEOFERTA
        Dim dsDO As New Data.DataSet
        cDO.ObtenerProveedoresAdjudXRenglon(Session("IdEstablecimiento"), IDPROCESOCOMPRA, IDRENGLON, dsDO)
        ...
        Reporte.DataDefinition.FormulaFields(0).Text = "'" & dsPC.Tables(0).Rows(0).Item(3) & "'"
