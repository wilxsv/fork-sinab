...
Partial Class FrmReporteInformesMuestras
    ...
    Private Sub CargarDatos()
        ...
        ds = cIM.ObtenerListaInformes(Session("IdEstablecimiento"), 0, Nothing, Session("IdEmpleado"))
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim cad = String.Format("/Reportes/FrmRptInformeMuestras.aspx?idE={0}&idI={1}&idTI={1}", Me.gvLista.DataKeys(e.Row.RowIndex).Values(0), Me.gvLista.DataKeys(e.Row.RowIndex).Values(1), Me.gvLista.DataKeys(e.Row.RowIndex).Values(2))
