...
Partial Class Reportes_FrmRptCriterioSinCumplirProveedor
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptCriterioEvaluacionSinCumplirProveedor.rpt") 'nombre reporte
