<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="True" CodeFile="FrmReporteProveedoresEntreganOferta.aspx.vb"
    Inherits="FrmReporteProveedoresEntreganOferta" %>
        ...
        <tr>
            <td class="LinkMenuRuta">
                &nbsp;<asp:LinkButton ID="lnkMenu" runat="server" Text="Menú" CausesValidation="False" />&nbsp;&nbsp;<asp:Label
                    ID="lblRuta" runat="server" Text="UACI -> Reportes -> Presentación de ofertas" />
            </td>
        </tr>
        <tr>
            <td>
