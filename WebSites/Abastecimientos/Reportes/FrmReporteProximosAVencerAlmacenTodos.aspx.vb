...
Partial Class FrmReporteProximosAVencerAlmacenTodos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.ucFiltrosReportesAlmacen2.VerAlmacen = True
            Me.ucFiltrosReportesAlmacen2.VerEstablecimientoTodos = True
    ...
    Protected Sub ucFiltrosReportesAlmacen1_Consultar() Handles ucFiltrosReportesAlmacen2.Consultar
        With ucFiltrosReportesAlmacen2
            Dim cad = String.Format("/Reportes/FrmRptProximosAVencerAlmacenTodos.aspx?idA={0}&idS={1}&idG={2}&idFF={3}&idGF={4}&idRD={5}&FH={6}&idPR={7}", .IDALMACEN, .IDSUMINISTRO, .IDGRUPO, .IDFUENTEFINANCIAMIENTO, .IDGRUPOFUENTEFINANCIAMIENTO, .IDRESPONSABLEDISTRIBUCION, .FECHAHASTA, .IDPROGRAMA)
