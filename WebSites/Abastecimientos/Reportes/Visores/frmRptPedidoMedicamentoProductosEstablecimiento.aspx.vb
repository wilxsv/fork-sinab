...
Partial Class Reportes_VisorReporte
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("~/Reportes/rpt/rptIndicador3PedidoMedicamentoProductosEstablecimientoAnioMes.rpt")
        Reporte.Load(reportPath)

        Dim IDESTABLECIMIENTO, prmAnio, prmMes As Integer
        ...
        prmAnio = Request.QueryString("a")
        prmMes = Request.QueryString("m")
        ...
        paramField = New ParameterField()
        paramField.ParameterFieldName = "prmAnio"
        discreteVal = New ParameterDiscreteValue()
        discreteVal.Value = prmAnio
        paramField.CurrentValues.Add(discreteVal)
        paramFields.Add(paramField)

        paramField = New ParameterField()
        paramField.ParameterFieldName = "prmMes"
        discreteVal = New ParameterDiscreteValue()
        discreteVal.Value = prmMes
        paramField.CurrentValues.Add(discreteVal)
        paramFields.Add(paramField)
        ...
        oConInfo.ServerName = ValStr(conStr, "server")
        oConInfo.UserID = ValStr(conStr, "user id")
        oConInfo.Password = ValStr(conStr, "password")
