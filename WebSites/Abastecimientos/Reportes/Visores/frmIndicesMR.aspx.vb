...
Partial Class Reportes_VisorReporte
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("~/Reportes/rpt/M_INDICES_MR.rpt")
        ...
        ds = cDM.ObtenerDataSetPorId(IDESTABLECIMIENTO, IDPROCESOCOMPRA, IDPROVEEDOR, IDALMACEN, IDCONTRATO)
        '' ROBINSON RUIZ
