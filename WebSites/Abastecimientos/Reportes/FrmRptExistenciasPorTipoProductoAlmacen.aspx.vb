...
Partial Class FrmRptExistenciasPorTipoProductoAlmacen
    ...
    Private Sub ConfigureCrystalReports()
        ...
        pDiscreteValue1.Value = "Existencia Actual " + Now.Date.ToShortDateString
        ...
        ds = cL.ExistenciaPorTipoProductosActual(IDALMACEN, IDSUMINISTRO, IDGRUPO, IDFUENTEFINANCIAMIENTO, IDRESPONSABLEDISTRIBUCION, IDGRUPOFUENTEFINANCIAMIENTO, IDESPECIFICOGASTO)
