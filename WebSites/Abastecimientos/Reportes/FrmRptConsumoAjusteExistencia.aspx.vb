...
Partial Class Reportes_FrmRptConsumoAjusteExistencia
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If idAlmacen <> 0 Then
            ...
            If ds2 Is Nothing Then
                Response.Write("No tiene permisos para ver el reporte")
                Exit Sub
            End If
        ...
        '    End If
        'Else
        reportPath = Server.MapPath("rptAjusteExistenciaFarmacia.rpt")
        ' End If
        ...
        'Arreglar despues
        '  If tipo <> -1 Then
        ds = cEntidad.obtenerAjusteExistenciaFarmacia(Session.Item("idEstablecimiento"), idAlmacen, fecha, idAlmacen, "inner", idprograma)
        'Else
