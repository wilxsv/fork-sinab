...
Partial Class Reportes_RptProveedoresRetiroBases
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptProveedoresRetiroBases.rpt") 'nombre de reporte
        ...
        'llena dataset
        DstRpt = mComponente.ObtenerDataSetPorIDwPROVEEDORRpt(id_procesoCompra, id_establecimiento)
