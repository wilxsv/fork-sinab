...
Partial Class FrmRptVencidosAlmacenTodos
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptExistenciasActualesPorTipoProductoTodosAlmacen.rpt")
        Reporte.Load(reportPath)

        Dim IDALMACEN, IDSUMINISTRO, IDGRUPO, IDFUENTEFINANCIAMIENTO, IDGRUPOFUENTEFINANCIAMIENTO, IDRESPONSABLEDISTRIBUCION As Integer
        ...
        pDiscreteValue1.Value = "Productos vencidos al " + Now.Date.ToShortDateString
        pField1.CurrentValues.Add(pDiscreteValue1)
        pFields.Add(pField1)

        Dim cL As New cLOTES
        Dim ds As Data.DataSet
        ds = cL.RptVencidosAlmacen(IDALMACEN, IDSUMINISTRO, IDGRUPO, IDFUENTEFINANCIAMIENTO, IDRESPONSABLEDISTRIBUCION, IDGRUPOFUENTEFINANCIAMIENTO)
