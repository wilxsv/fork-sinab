...
'Reporte con la documentacion no presentada por renglon
...
Partial Class Reportes_FrmRptCriterioSinCumplirRenglon
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptCriterioEvaluacionSinCumplirRenglon.rpt") 'nombre reporte
        ...
        'carga dataset
        DstrptDocumentacionFaltanteRenglon = mComponente.DataSetDocumentacionFaltanteRenglon(Session.Item("IdEstablecimiento"), lId, lIdProv)
