...
Partial Class Reportes_FrmRptGarantias
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim mComponente As New cGARANTIASCONTRATOS
        Dim ds As Data.DataSet

        Select Case Me.Request.QueryString("Tipo")
            Case 1
                reportPath = Server.MapPath("RptGarantiaProveedor.rpt")
                ds = mComponente.obtenerDsRptProveedor(Session("idEstablecimiento"), Me.Session("IdProv"))
            Case 2
                reportPath = Server.MapPath("RptGarantiaFechaVenc.rpt")
                ds = mComponente.obtenerDsRptFechaVencimiento(Session("idEstablecimiento"), Me.Session("FechaV"))
            Case 3
                reportPath = Server.MapPath("RptGarantiaTipo.rpt")
                ds = mComponente.obtenerDsRptTipoGarantia(Session("idEstablecimiento"), Me.Session("TipoG"))
        End Select
