...
Partial Class FrmRptUsuariosSistema
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptUsuariosSistema.rpt") 'nombre de reporte
        ...
        ds = mComponente.ObtenerDsUsuariosEmpleados
