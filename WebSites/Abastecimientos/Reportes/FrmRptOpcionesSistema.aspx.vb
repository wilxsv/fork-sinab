...
Partial Class FrmRptOpcionesSistema
    ...
    Private Sub ConfigureCrystalReports()
        ...
        Dim reportPath As String = Server.MapPath("RptOpcionesSistema.rpt") 'nombre de reporte
        ...
        Dim mComponente As New cOPCIONESSISTEMA
        Dim ds As Data.DataSet
        ds = mComponente.ObtenerListaOpcionesReporte("Descripcion")
