<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
  CodeFile="ingreso_grupo.aspx.vb" Inherits="FrmPricipal" %>

<%-- Agregue aquí los controles de contenido --%>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageContent">
  <h1>Informe de Ingresos por Grupo de Productos VIH</h1>
    <br>
    <table>
        <tbody><tr><td>Fecha de ingresos: </td><td>[DESDE]: <input type="text" id="desde" class="hasDatepicker"><br>[HASTA]: <input type="text" id="hasta" class="hasDatepicker"></td></tr>
        <tr>
        ...
        <input type="hidden" id="unit" value="pvih_ingresos"> 
        <input type="hidden" id="titulo" value="Ingresos por Grupo de Productos VIH"> 
