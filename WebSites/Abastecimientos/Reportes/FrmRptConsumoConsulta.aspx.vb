...
Partial Class Reportes_FrmRptConsumoConsulta
    ...
    Private Sub ConfigureCrystalReports()
        ...
        If Request.QueryString("mes") Is Nothing Or Request.QueryString("anio") Is Nothing Then
        ...
        Dim idproducto As Integer = Request.QueryString("idprod")
        ...
        '    End If
        'Else
        reportPath = Server.MapPath("rptConsumosConsulta.rpt")
        ' End If
        ...
        'Else
        ds = cEntidad.obtenerConsumoTotalxEstablecimientoMensual(idproducto, fecha, idprograma) 'Session.Item("idEstablecimiento"), fecha, "inner", idprograma)
        ' End If
        ...
        pField.ParameterFieldName = "producto"
        Dim x As New cCATALOGOPRODUCTOS
        disVal.Value = x.DevolverNombreProducto(idproducto)         'Set the discrete Value
