...
Partial Class GERENCIA_frmConsumoRegionDigitacion
    ...
    Protected Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Dim alerta As String = "/Reportes/frmRptCapturaCERegion.aspx?fecha=" & Me.cboMes.SelectedItem.Value & "/" & Me.cboAnio.SelectedItem.Text
