<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="frmConsumoEstadoDigitacion.aspx.vb" Inherits="GERENCIA_frmConsumoEstadoDigitacion" title="" %>
...
<table class="CenteredTable" style="width: 100%;">
    <tr>
      <td class="LinkMenuRuta">
        <asp:HyperLink runat="server" id="lnkSalir">Gerencia</asp:HyperLink>  -> Estado de digitación por Hospital (Consumos y Existencias)</td>
    </tr>
    <tr>
      <td>
