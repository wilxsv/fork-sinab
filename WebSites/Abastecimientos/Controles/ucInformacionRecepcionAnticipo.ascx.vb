Partial Class Controles_ucInformacionRecepcionAnticipo
    ...
    Public Sub Cargar()
        ...
        eEntidad = cEntidad.obtenerDatosAnticipo(idEstablecimiento, idProveedor, idContrato)
        ...
        If Not eEntidad Is Nothing Then
            ...
            Me.gvRenglones.DataSource = cEntidad.obtenerRenglonesAdjudicacion(idEstablecimiento, idProveedor, idContrato, idAlmacen)
