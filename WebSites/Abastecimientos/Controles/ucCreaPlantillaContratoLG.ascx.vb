...
Partial Class Controles_ucCreaPlantillaContratoLG
    ...
    Protected Sub UcBarraNavegacion1_Agregar(ByVal sender As Object, ByVal e As System.EventArgs) Handles UcBarraNavegacion1.Agregar
        Response.Redirect("~/UACI/FrmDetCreaPlantillaContratosLG.aspx?mod=NEW&tipoMod=" & tipoPlantilla)
    End Sub
    ...
    Protected Sub dgPlantilla_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgPlantilla.SelectedIndexChanged
        Response.Redirect("~/UACI/FrmDetCreaPlantillaContratosLG.aspx?mod=EDIT&id=" & Me.dgPlantilla.SelectedItem.Cells(1).Text & "&tipoMod=" & tipoPlantilla)
    End Sub
