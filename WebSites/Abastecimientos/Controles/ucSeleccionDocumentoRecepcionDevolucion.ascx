<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucSeleccionDocumentoRecepcionDevolucion.ascx.vb"
  Inherits="ucSeleccionDocumentoRecepcionDevolucion" %>
    ...
    <td>
      <asp:Panel ID="plSeleccionarDocumento" runat="server" GroupingText="Documentos pendientes:"
        ...
        <asp:GridView ID="gvDocumentos" runat="server" AutoGenerateColumns="False" CellPadding="4"
          ...
          <Columns>
            <asp:HyperLinkField HeaderText="No. Documento" DataNavigateUrlFormatString="~/ALMACEN/FrmDetMantRecepcionDevolucion.aspx?IdM={0}&IdA={1}"
