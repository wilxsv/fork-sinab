...
Partial Class Controles_ucGenerarBasesLibreGestion
    ...
    Private Sub obtenerCriterios()
        Dim mComponente As New cCRITERIOSEVALUACION
        Dim ds As Data.DataSet
        If modo = "EDIT" Then
            Dim mComponentePlantilla As New cCRITERIOSPLANTILLAS
            ds = mComponentePlantilla.ObtenerDataSetCriteroPlanilla(idPlantillaSel, 3, Session("IdEstablecimiento"), IDPROCESOCOMPRA)

        Else
            ds = mComponente.ObtenerDataSetPorTipoCriterio(3) 'Criterio para Libre Gestión
        End If

        Me.txtCumplimientoEspecificaciones.Text = ds.Tables(0).Rows(0).Item("PORCENTAJE")
        Me.txtPlazoEntrega.Text = ds.Tables(0).Rows(1).Item("PORCENTAJE")
        Me.txtPrecio.Text = ds.Tables(0).Rows(2).Item("PORCENTAJE")
    End Sub
    ...
    Private Sub ObtenerDatos()
        ...
        With ds.Tables(0).Rows(0)
            ...
            'End Try
            'Try
            '    Me.DdlMUNICIPIOS1.SelectedValue = .Item("IDMUNICIPIORECEPCION")
            'Catch ex As Exception
            ...
            End Try
            'Try
            '    Me.txtLUGARAPERTURABASE.Text = .Item("LUGARAPERTURABASE")
            'Catch ex As Exception
            '    Me.txtLUGARAPERTURABASE.Text = ""
            'End Try
            'Try
            '    Me.txtDIRECCIONAPERTURABASE.Text = .Item("DIRECCIONAPERTURABASE")
            'Catch ex As Exception
            '    Me.txtDIRECCIONAPERTURABASE.Text = ""
            'End Try
            'Try
            '    Me.DdlMUNICIPIOS2.SelectedValue = .Item("IDMUNICIPIOAPERTURA")
            'Catch ex As Exception
            ...
            'End Try
            'Try
            '    txtGARANTIAMTTOENTREGA.Text = .Item("GARANTIAMTTOENTREGA")
            'Catch ex As Exception
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        guardarCriterios()
        'actualizaDocumentoJuridico()
        'actualizaDocumentoNatural()
        'actualizaDocumentoAspectotecnico()
        'guardarPorcentajeEvaluacion()
        'guardarGarantiasProducto()
        'guardarPlantillaProcesoCompra()
        'Me.btnGeneraDocumento.Visible = True
        'guardarBase()
        ''guardarGarantiaProducto()
    ...
    Private Sub guardarProcesoCompra()
        ...
        With lEntidad
            ...
            .GARANTIACALIDADVALOR = garantiaCalidadV 'IIf(Me.txtGARANTIACALIDADVALOR.Text = "", 0, CDec(Me.txtGARANTIACALIDADVALOR.Text))
            .IDPROCESOCOMPRA = IDPROCESOCOMPRA
            .IDESTABLECIMIENTO = Session("IdEstablecimiento")
            .ESTASINCRONIZADA = 0
    ...
    Private Sub guardarCriterios()
        ...
        With lEntidad
            ...
            .IDESTABLECIMIENTO = Session("IdEstablecimiento")
            .IDPROCESOCOMPRA = IDPROCESOCOMPRA
            .PORCENTAJE = Me.txtCumplimientoEspecificaciones.Text
        End With
        mComponente.AgregarCRITERIOPROCESOCOMPRA(lEntidad)

        'Ingreso de Plazo de entrega
        With lEntidad
            .AUFECHACREACION = Date.Now
            .AUFECHAMODIFICACION = Date.Now
            .AUUSUARIOCREACION = HttpContext.Current.User.Identity.Name
            ...
            .IDESTABLECIMIENTO = Session("IdEstablecimiento")
            .IDPROCESOCOMPRA = IDPROCESOCOMPRA
            .PORCENTAJE = Me.txtPlazoEntrega.Text
        End With
        mComponente.AgregarCRITERIOPROCESOCOMPRA(lEntidad)
    ...
    Private Sub generarDocumento()
        ...
        codigoFuentePlantilla.Append(Session("CODIGOFUENTE"))
        ...
        dsEtiqueta = mComponenteEtiqueta.ObtenerDataSetPorTABLA("PROCESOCOMPRAS_LG")
        ...
        For i = 0 To dsEtiqueta.Tables(0).Rows.Count - 1
            If mDocumento.ToString.IndexOf(dsEtiqueta.Tables(0).Rows(i).Item("ETIQUETA")) > 0 Then
                If dsEtiqueta.Tables(0).Rows(i).Item("ETIQUETA") = "$NOMBRELIBREGESTION$" Then
                    TituloLibreGestion = ds.Tables(0).Rows(0).Item(dsEtiqueta.Tables(0).Rows(i).Item("CAMPO"))
                End If
                If dsEtiqueta.Tables(0).Rows(i).Item("ETIQUETA") = "$SOLICITUDCOTIZACION$" Then
        ...
        'For i = 0 To dsCriterio.Tables(0).Rows.Count - 1
        '    Etiqueta = mComponenteCriterio.EtiquetaCriterioTecnico("CRITERIO_TEC", dsCriterio.Tables(0).Rows(i).Item("DESCRIPCION")).Tables(0).Rows(0).Item("ETIQUETA")
        ...
        dsPD = mComponentePC.obtenerProgramaDistribucion(Session("IdEstablecimiento"), IDPROCESOCOMPRA, 1)
        ...
        If codigoLibreGestion = "" Then
            codigoLibreGestion = 1
        End If
    ...
    Private Function validarExistenciaCodigoLicitacion() As Boolean

        Dim cProcesoCompra As New cPROCESOCOMPRAS

        Return cProcesoCompra.validarExistenciaCodigoLicitacion(Session("IdEstablecimiento"), IDPROCESOCOMPRA)
    ...
    Protected Sub txtCODIGOLICITACION_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCODIGOLICITACION.TextChanged
        ...
        If Me.txtCODIGOLICITACION.Text <> "" Then
            ...
            If validarExistenciaCodigoLicitacion() = True Then
        ...
        Else
            RequiredFieldValidator1.ErrorMessage = "Debe ingresar el código de libre gestión"
            RequiredFieldValidator1.IsValid = False
        End If
