...
<table class="CenteredTable" style="width: 100%">
  ...
  <tr>
    <td>
      <asp:GridView ID="gvRenglones" runat="server" CssClass="Grid" AllowPaging="False" CellPadding="4" GridLines="None" AutoGenerateColumns="False" DataKeyNames="IDPRODUCTO,IDDETALLE">
