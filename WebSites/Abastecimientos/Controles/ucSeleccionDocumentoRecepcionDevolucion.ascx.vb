...
Partial Class ucSeleccionDocumentoRecepcionDevolucion
...
#End Region
    ...
    Public Sub CargarDatos()
        ...
        Me.gvDocumentos.DataSource = cRR.ObtenerRecepciones(Me.IDALMACEN, TiposTransaccion.RecepcionPorDevolucion, eESTADOSMOVIMIENTOS.Grabado)
