...
#Region " Propiedades "
    ...
    Public Property DsProcesoCompra() As List(Of SAB_UACI_PROCESOCOMPRAS)
        Get
            If ViewState("DS_ProcesoCompra") Is Nothing Then Return Nothing
...
#End Region
    ...
    Private Sub CargarDatos()
        ...
        If DsProcesoCompra Is Nothing Then DsProcesoCompra = ProcesoCompras.Obtener(lENTIDAD, _EVAL_FEC_RET, _EVAL_FEC_REC, ESTADOS, USUARIOCOMISION, IDENCARGADO)
