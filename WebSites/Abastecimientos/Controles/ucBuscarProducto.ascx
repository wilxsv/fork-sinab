<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucBuscarProducto.ascx.vb"
  Inherits="ucBuscarProducto" %>
...
<table class="CenteredTable" style="width: 100%;">
  ...
  <tr>
    <td colspan="2" style="text-align: left;">
      ...
      <asp:Label ID="lblDESCLARGO" runat="server" Visible="False" /></td>
  </tr>
</table>
