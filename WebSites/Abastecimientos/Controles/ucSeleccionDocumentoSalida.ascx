...
<%@ Register src="ctrValesRechazo.ascx" tagname="ctrValesRechazo" tagprefix="uc1" %>
      ...
      <asp:Panel ID="plSeleccionarDocumento" runat="server" 
       ...
       <fieldset >
        ...
        <asp:GridView ID="gvDocumentos" runat="server" AutoGenerateColumns="False" CellPadding="4"
          GridLines="None" CssClass="Grid" DataKeyNames="IdEstablecimiento,IdMovimiento,IdEstado,establecimientodestino,numerovale" Width="100%" >
...
<uc1:ctrValesRechazo ID="ctrVlRechazo" runat="server" />
