        ...
        init: function (options)
        {
            ...
            return this.each(function ()
            {
                ...
                if (!data)
                {
                    ...
                    if (options.dismiss) {
                        messageHtml += "<div class='message-dismiss ui-corner-all'><span class='ui-icon ui-icon-circle-close'></span></div>";
                    }
                    messageHtml += "<div class='ui-icon " + iconClass + "' style='float:left;'></div><p>";
